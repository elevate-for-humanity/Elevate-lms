...
<div className="bg-gray-900 text-white py-12">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-brand-red-50 border border-brand-red-200 rounded-lg p-4 mb-8 flex items-center justify-between">
          <div>
            <p className="font-medium text-brand-red-900">Official Store Operations Document</p>
            <p className="text-sm text-brand-red-700">Authoritative reference for e-commerce, payments, and licensing.</p>
          </div>
          <a href="/docs/Store_Payments_Licensing_Framework.pdf" download className="flex items-center gap-2 px-4 py-2 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700">
        ...
        <nav className="bg-gray-50 rounded-lg p-6 mb-10">
          ...
          <ol className="space-y-2 text-sm">
            ...
            <li><a href="#products" className="text-brand-red-600 hover:underline">2. Product Types & Catalog</a></li>
            <li><a href="#payments" className="text-brand-red-600 hover:underline">3. Payment Processing</a></li>
            <li><a href="#licensing" className="text-brand-red-600 hover:underline">4. Digital Licensing</a></li>
            <li><a href="#pricing" className="text-brand-red-600 hover:underline">5. Pricing & Promotions</a></li>
            <li><a href="#refunds" className="text-brand-red-600 hover:underline">6. Refunds & Disputes</a></li>
            <li><a href="#seller" className="text-brand-red-600 hover:underline">7. Seller/Creator Policies</a></li>
        ...
        <section id="purpose" className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
            <ShoppingCart className="w-6 h-6 text-brand-red-600" />
            1. Purpose & Scope
          </h2>
        ...
        <section id="products" className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
            <FileCheck className="w-6 h-6 text-brand-red-600" />
        ...
        <section id="payments" className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
            <CreditCard className="w-6 h-6 text-brand-red-600" />
        ...
        <section id="refunds" className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
            <RefreshCw className="w-6 h-6 text-brand-red-600" />
            6. Refunds & Disputes
          </h2>
