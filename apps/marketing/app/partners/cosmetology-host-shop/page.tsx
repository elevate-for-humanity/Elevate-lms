...
export const metadata: Metadata = {
  ...
  description: 'Host a cosmetology apprenticeship. Partner with us to train the next generation of cosmetology professionals while growing your business.',
};
...
const REQUIREMENTS = [
  'Licensed salon in good standing with Indiana State Board of Cosmetology',
...
const APPRENTICE_INFO = [
  ...
  'Passion for the beauty industry and customer service',
];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative flex items-end overflow-hidden bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900" style={{ minHeight: 'clamp(260px, 45vw, 520px)' }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 pb-8 sm:pb-12 w-full text-white">
          ...
          <p className="text-lg text-white/70 max-w-2xl">
            Partner with us to train the next generation of cosmetology professionals while building your team and growing your business.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">What Host Salons Can Expect</h2>
        ...
        <section className="bg-slate-50 rounded-2xl p-8 sm:p-12 border border-slate-200 text-center">
          ...
          <p className="text-slate-600 mb-8 max-w-xl mx-auto">
            Apply to become a host salon partner. We&apos;ll review your application and contact you within 2-3 business days.
          </p>
