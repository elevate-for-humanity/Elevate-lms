          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <div className="space-y-4">
              <Link
                ...
                className="block w-full bg-brand-red-600 text-white py-4 rounded-xl font-bold hover:bg-brand-red-700 transition-colors"
              >
                Return to Homepage
              </Link>
              <Link
...
<div className="max-w-3xl mx-auto px-4">
        ...
        <Link
          href="/supersonic-fast-cash/multi-site"
          className="inline-flex items-center gap-2 text-brand-red-600 hover:text-brand-red-700 mb-8"
        >
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-brand-red-100 text-brand-red-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-500 focus:border-transparent bg-white"
                >
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-brand-red-600 text-white py-4 rounded-xl font-bold text-lg hover:bg-brand-red-700 transition-colors disabled:bg-brand-red-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {submitting ? (
              <>
