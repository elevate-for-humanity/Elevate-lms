      ...
      <div className="bg-white border-b border-slate-100 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/testing/book?provider=workkeys"
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-4">
                Prove Your Workplace Skills
              </h2>
              <p className="text-black text-sm leading-relaxed mb-4">
                ACT WorkKeys is a job skills assessment system that measures real-world skills
                employers need. When you pass, you earn the National Career Readiness Certificate
                (NCRC) — a credential recognized by thousands of employers and required by many
                Indiana workforce programs.
              </p>
              <p className="text-black text-sm leading-relaxed">
                The NCRC is also required for some WIOA-funded training programs and is accepted by
                WorkOne as evidence of career readiness.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-4">
                Take WorkKeys at Elevate
              </h2>
              <p className="text-black text-sm leading-relaxed mb-4">
                We proctor ACT WorkKeys on-site at our Indianapolis testing center. Individual and
                group sessions available. By appointment only — contact us to schedule.
              </p>
