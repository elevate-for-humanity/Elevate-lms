      ...
      <section className="relative min-h-[500px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              href="/donate"
              className="inline-flex items-center justify-center gap-2 bg-white text-brand-red-700 px-8 py-4 rounded-xl font-bold hover:bg-gray-100"
            >
      ...
      <section className="py-12 bg-white border-b">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-4xl font-bold text-brand-red-600">{peopleHelped || 500}+</div>
              <div className="text-gray-600">People Helped</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-brand-red-600">4</div>
              <div className="text-gray-600">Core Programs</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-brand-red-600">24/7</div>
              <div className="text-gray-600">Crisis Support</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-brand-red-600">100%</div>
            ...
            {displayPrograms.map((program: any) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <span className="inline-flex items-center gap-1 text-brand-red-600 font-medium group-hover:underline">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {events.map((event: any) => (
                <div key={event.id} className="bg-white rounded-xl shadow-sm border p-6">
                  <div className="flex items-center gap-2 text-brand-red-600 text-sm mb-2">
      ...
      <section className="py-16 bg-slate-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link
              href="/rise-foundation/get-involved"
              className="inline-flex items-center justify-center gap-2 bg-white text-brand-red-600 px-8 py-4 rounded-xl font-bold hover:bg-gray-100"
            >
              Get Started
            </Link>
            <a
              href="/contact"
              className="inline-flex items-center justify-center gap-2 bg-brand-red-500 text-white px-8 py-4 rounded-xl font-bold hover:bg-brand-red-400 border-2 border-white"
            >
