...
const colorClasses: Record<string, { bg: string; light: string; text: string }> = {
  ...
  brand-red: { bg: 'bg-brand-red-600', light: 'bg-brand-red-50', text: 'text-brand-red-600' },
      ...
      <section className="relative py-20 min-h-[400px] flex items-center">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center text-white">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-white text-brand-red-700 font-bold rounded-lg hover:bg-pink-50 transition"
          >
            ...
            {packages.map((pkg) => (
              <div
                ...
                className={`bg-white rounded-2xl p-6 ${
                  pkg.popular ? 'ring-2 ring-brand-red-600 shadow-xl' : 'border'
                }`}
              >
                {pkg.popular && (
