...
<div className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link href="/employer-portal/company" className="flex items-center gap-2 text-gray-600 hover:text-brand-red-600 mb-4">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm font-bold text-brand-red-600">75%</span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div className="bg-brand-red-600 h-2 rounded-full" style={{ width: '75%' }} />
          </div>
        </div>
        ...
        <form className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-brand-red-400 transition cursor-pointer">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              type="submit"
              className="px-8 py-3 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700 transition font-semibold flex items-center gap-2"
            >
