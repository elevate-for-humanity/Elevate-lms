 ...
 */
const PROGRAM_ONBOARDING_TASKS: Record<
  string,
...
> = {
  default: [
    {
      ...
      description: 'Fill out your student profile with contact information',
      day: 1,
    },
    {
      title: 'Upload required documents',
      description: 'Submit all required enrollment documents',
      day: 1,
    },
    {
      title: 'Review student handbook',
      description: 'Read and acknowledge the student handbook',
      day: 2,
    },
    {
      title: 'Complete orientation module',
      description: 'Watch the program orientation video',
      day: 3,
    },
    {
      title: 'Meet your cohort',
      description: 'Introduce yourself in the cohort discussion forum',
      day: 5,
    },
  ],
  'barber-apprenticeship': [
    ...
    {
      title: 'Upload required documents',
      description: 'Submit all required enrollment documents including background check',
      day: 1,
    },
    {
      title: 'Review student handbook',
      description: 'Read and acknowledge the student handbook and safety guidelines',
      day: 2,
    },
    {
      title: 'Complete orientation module',
      description: 'Watch the barber apprenticeship orientation video',
      day: 3,
    },
    { title: 'Kit ordering', description: 'Order your barber kit and supplies', day: 5 },
    {
      title: 'Meet your mentor',
      description: 'Introduction session with your assigned mentor',
      day: 7,
    },
    {
      title: 'Review licensing requirements',
      description: 'Understand state barber licensing exam requirements',
      day: 10,
    },
  ],
  'cdl-training': [
    ...
    {
      title: 'Upload required documents',
      description: 'Submit driving record, DOT physical, drug screening results',
      day: 1,
    },
    {
      title: 'Review student handbook',
      description: 'Read and acknowledge the CDL program handbook',
      day: 2,
    },
    {
      title: 'Complete orientation module',
      description: 'Watch the CDL training orientation video',
      day: 3,
    },
    { title: 'Schedule permit test', description: 'Schedule your written CDL permit exam', day: 5 },
    {
      title: 'Meet your instructor',
      description: 'Introduction session with your driving instructor',
      day: 7,
    },
    {
      title: 'Pre-trip inspection study',
      description: 'Begin studying pre-trip inspection procedures',
      day: 10,
    },
  ],
  hvac: [
    ...
    {
      title: 'Review student handbook',
      description: 'Read and acknowledge the HVAC program handbook',
      day: 2,
    },
    {
      title: 'Complete orientation module',
      description: 'Watch the HVAC technology orientation video',
      day: 3,
    },
    { title: 'Tool kit ordering', description: 'Order your HVAC tool kit', day: 5 },
    {
      title: 'EPA 608 exam registration',
      description: 'Register for EPA 608 certification exam',
      day: 7,
    },
  ...
  'medical-assistant': [
    ...
    {
      title: 'Upload required documents',
      description: 'Submit immunization records and background check authorization',
      day: 1,
    },
    {
      title: 'Review student handbook',
      description: 'Read and acknowledge the medical assistant handbook including HIPAA guidelines',
      day: 2,
    },
    {
      title: 'Complete orientation module',
      description: 'Watch the medical assistant program orientation',
      day: 3,
    },
    {
      title: 'Clinical skills assessment',
      description: 'Complete the pre-program clinical skills assessment',
      day: 5,
    },
    { title: 'CPR certification', description: 'Complete or upload CPR certification', day: 7 },
    {
      title: 'Clinical site orientation',
      description: 'Review clinical rotation site information',
      day: 10,
    },
  ],
  cosmetology: [
    ...
    {
      title: 'Review student handbook',
      description: 'Read and acknowledge the cosmetology student handbook',
      day: 2,
    },
    {
      title: 'Complete orientation module',
      description: 'Watch the cosmetology program orientation',
      day: 3,
    },
    ...
    {
      title: 'Review state licensing requirements',
      description: 'Understand state cosmetology board requirements',
      day: 10,
    },
  ],
  phlebotomy: [
    ...
    {
      title: 'Review student handbook',
      description: 'Read and acknowledge the phlebotomy program handbook',
      day: 2,
    },
    {
      title: 'Complete orientation module',
      description: 'Watch the phlebotomy program orientation',
      day: 3,
    },
...
async function createDigitalBinder(
  ...
  const requiredDocuments =
    PROGRAM_DOCUMENT_REQUIREMENTS[programSlug] || PROGRAM_DOCUMENT_REQUIREMENTS.default;
...
export async function provisionStudentFromInterview(
  ...
  try {
    ...
    await setAuditContext(supabase, {
      systemActor: 'paris_interview_provisioning',
      requestId: session.applicationRef,
    });
    ...
    // Create onboarding plan with tasks
    onboardingPlanId = await createOnboardingPlan(
      supabase,
      studentId,
      enrollmentId,
      session.programSlug,
 ...
 */
export async function checkProvisioningStatus(applicationRef: string): Promise<{
  provisioned: boolean;
  studentId?: string;
  enrollmentId?: string;
  binderId?: string;
