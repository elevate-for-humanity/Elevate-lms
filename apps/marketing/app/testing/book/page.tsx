...
function BookingForm() {
  ...
  // Payment confirmed — the selected slot can now be added to Google Calendar.
  if (paid) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="max-w-lg w-full">
          ...
          {/* Payment-gated Google Calendar CTA */}
          <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-2xl p-6 mb-6 text-center">
            ...
            <p className="text-brand-blue-700 text-sm mb-5">
              Add your paid appointment to Google Calendar, then call the Testing Center to confirm.
              Appointments must be reserved at least 24 hours in advance.
            </p>
            {calendarLoading ? (
              ...
              >
                ...
                <p className="rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm font-semibold text-amber-900">
                  Your payment is confirmed, but no eligible appointment slot is attached. Call{' '}
                  <a href={`tel:${TESTING_CENTER.phoneTel}`} className="underline">{TESTING_CENTER.phone}</a>{' '}
                  so the Testing Center can assign your time.
                </p>
              )
            )}
          </div>
