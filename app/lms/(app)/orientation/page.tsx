  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-black mb-2">Program Orientation</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span className="text-black">Job placement assistance and career services</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-slate-400 flex-shrink-0">•</span>
                  <span className="text-black">How to succeed in your training program</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-black">Watch Orientation</p>
                    <p className="text-sm text-black">Complete the video above</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-black">Begin your career journey</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-black">Browse Programs</span>
                </Link>
                <Link
                  href="/how-it-works"
                  className="flex items-center gap-3 p-3 rounded-lg hover:bg-white transition"
                ...
                >
                  ...
                  <span className="text-sm font-medium text-black">Career Services</span>
                </Link>
              </div>
            </div>
            ...
            <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-xl p-6">
              <h3 className="text-lg font-bold text-brand-blue-900 mb-2">Need Help?</h3>
        ...
        {isCompleted && (
          <div className="mt-8 bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div>
                <h3 className="text-lg font-bold text-black mb-1">Ready for the Next Step?</h3>
                <p className="text-black">Verify your eligibility to unlock program enrollment.</p>
              </div>
              <Link
                href="/start"
