...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: 'Business Operations', href: '/programs/business-operations' },
      { name: 'Business Startup', href: '/programs/business-startup' },
      { name: 'Project Management', href: '/programs/project-management' },
      { name: 'Entrepreneurship', href: '/programs/entrepreneurship' },
      { name: 'Administrative Assistant', href: '/programs/administrative-assistant' },
      { name: 'Office Administration', href: '/programs/office-administration' },
      { name: 'Customer Service Pro', href: '/programs/customer-service-pro' },
      { name: 'Customer Service Representative', href: '/programs/customer-service-representative' },
      { name: 'Insurance Agent', href: '/programs/insurance-agent' },
      { name: 'Real Estate Agent', href: '/programs/real-estate-agent' },
      ...
      { name: '— Hospitality & Food Service —', href: '/programs/hospitality', isHeader: true },
      { name: 'Hospitality', href: '/programs/hospitality' },
      { name: 'Start Hospitality', href: '/programs/start-hospitality' },
      { name: 'Guest Service Gold', href: '/programs/guest-service-gold' },
      { name: 'Culinary Apprenticeship', href: '/programs/culinary-apprenticeship' },
      { name: 'Youth Culinary Apprenticeship', href: '/programs/youth-culinary-apprenticeship' },
      { name: 'ServSuccess', href: '/programs/servsuccess' },
      { name: 'ServSafe Food Handler', href: '/programs/servsafe-food-handler' },
      { name: 'ServSafe Manager', href: '/programs/servsafe-manager' },
      { name: 'NRF RiseUp', href: '/programs/nrf-riseup' },

      { name: '— Healthcare (NHA) —', href: '/programs/healthcare', isHeader: true },
      { name: 'NHA Medical Assistant', href: '/programs/nha-medical-assistant' },
      { name: 'NHA Phlebotomy', href: '/programs/nha-phlebotomy' },
      { name: 'NHA EKG Technician', href: '/programs/nha-ekg-technician' },
      { name: 'NHA Billing & Coding', href: '/programs/nha-billing-coding' },
      { name: 'NHA Patient Care Tech', href: '/programs/nha-patient-care-technician' },
      { name: 'NHA Medical Admin Assistant', href: '/programs/nha-medical-admin-assistant' },
      { name: 'NHA EHR', href: '/programs/nha-ehr' },
      { name: 'CHW Certificate', href: '/programs/chw-cert' },
      { name: 'Emergency Health & Safety', href: '/programs/emergency-health-safety' },
      { name: 'Dental Assistant', href: '/programs/dental-assistant' },

      { name: '— Trades & Construction —', href: '/programs/skilled-trades', isHeader: true },
      { name: 'HVAC Technician', href: '/programs/hvac-technician' },
      { name: 'Building Maintenance', href: '/programs/building-maintenance-wrg' },
      { name: 'Automotive Technician', href: '/programs/automotive-technician' },
      { name: 'Solar Panel Installation', href: '/programs/solar-panel-installation' },
      { name: 'Forklift', href: '/programs/forklift' },
      { name: 'Manufacturing Technician', href: '/programs/manufacturing-technician' },
      ...
      { name: 'EMT Apprenticeship', href: '/programs/emt-apprenticeship' },
      { name: 'Life Coach Certification', href: '/programs/life-coach-certification-wioa' },
      { name: 'Reentry Specialist', href: '/programs/reentry-specialist' },
      { name: 'JRI Introduction', href: '/programs/jri-introduction' },
