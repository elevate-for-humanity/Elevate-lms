    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-2xl px-4 py-16">
        <div className="rounded-2xl border bg-white p-8 shadow-sm text-center">
          ...
          <h1 className="text-3xl font-bold text-black mb-4">Application Received</h1>
          <p className="text-lg text-black mb-4">
            Your application is received and time-stamped. You'll receive an email update. From
            here, your application moves into review.
          </p>
          <p className="text-base text-slate-700 mb-8">
            One of two things happens: you'll be approved and receive your next step to enroll, or
            we'll send you a request for any missing items and your application pauses until it's
            provided.
          </p>
          ...
          <div className="rounded-xl border bg-white p-6 text-left mb-8">
            ...
            <ol className="space-y-3 text-black">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>Once scheduled, contact us back so we can track your progress</span>
              </li>
            </ol>
          </div>
