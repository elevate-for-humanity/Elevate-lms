...
<div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <button className="px-4 py-2 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700 transition flex items-center gap-2">
            ...
            <div className="w-80 border-r flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto">
                {conversations.map((conv, index) => (
                  <div
                    key={conv.id}
                    className={`p-4 border-b hover:bg-gray-50 cursor-pointer ${index === 0 ? 'bg-brand-red-50' : ''}`}
                  >
              ...
              <div className="p-4 border-t">
                <div className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-2 border rounded-full focus:ring-2 focus:ring-brand-red-500 focus:border-transparent"
                  />
                  <button className="p-3 bg-brand-red-600 text-white rounded-full hover:bg-brand-red-700 transition">
