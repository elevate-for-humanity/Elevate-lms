      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        {bundle && (
          <section className="mb-16">
            <div className="bg-brand-red-600 rounded-2xl overflow-hidden shadow-xl">
              <div className="grid lg:grid-cols-2">
                <div className="p-8 lg:p-12 text-white">
                  ...
                  <p className="text-brand-red-100 mb-6">{bundle.description}</p>
                  
                  <div className="mb-6">
                    <p className="text-sm text-brand-red-200 mb-2">What&apos;s Included:</p>
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-xl text-brand-red-300 line-through">${Number(bundle.original_price).toFixed(0)}</span>
                  </div>

                  <button
                    onClick={() => addToCart(bundle.id)}
                    disabled={cart.includes(bundle.id)}
                    className="w-full sm:w-auto bg-white text-brand-red-600 px-8 py-4 rounded-lg font-bold hover:bg-brand-red-50 transition disabled:bg-green-100 disabled:text-green-600 flex items-center justify-center gap-2"
                  >
              ...
              {courses.map((course) => (
                <div key={course.id} className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 flex flex-col">
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <p className="text-sm text-brand-red-600 font-medium mb-3">{course.subtitle}</p>
