...
const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    image: '/images/pages/admin-employers-onboarding-hero.webp',
  ...
  },
  {
    ...
    icon: Calendar,
    image: '/images/pages/suboffice-onboarding-page-1.webp',
  ...
  },
  {
    ...
    icon: ClipboardCheck,
    image: '/images/pages/career-services-page-11.webp',
...
export default async function LearnerOnboardingPage({
  ...
  // Barber student who hasn't paid yet — send to the payment/apply page
  if (
    enrollment?.program_slug === 'barber-apprenticeship' &&
    enrollment?.payment_status === 'pending'
  ) {
