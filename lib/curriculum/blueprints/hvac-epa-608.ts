...
const HVAC_VIDEO_CONFIG: BlueprintVideoConfig = {
  ...
  surfaceMode: 'bright',
  colorGrade: 'eq=brightness=0.08:contrast=1.03:saturation=1.08:gamma=1.04',
  ttsVoice: 'onyx',
  ttsSpeed: 0.85,
  slideCount: 5,
  ...
  modules: [
    {
      ...
      lessons: [
        ...
        {
          slug: 'hvac-lesson-2',
          title: 'WIOA Funding, Attendance & Support Services',
          order: 2,
          domainKey: 'hvac_foundations',
        },
        {
        ...
        {
          slug: 'hvac-lesson-9',
          title: 'HVAC Fundamentals Quiz',
          order: 9,
          domainKey: 'hvac_foundations',
        },
        {
          slug: 'hvac-lesson-10',
          title: 'Voltage, Current, Resistance & Ohms Law',
          order: 10,
          domainKey: 'hvac_foundations',
        },
      ],
...

    {
      ...
      lessons: [
        ...
        {
          slug: 'hvac-lesson-13',
          title: 'Capacitors, Contactors & Relays',
          order: 3,
          domainKey: 'hvac_electrical',
        },
        {
        ...
        {
          slug: 'hvac-lesson-16',
          title: 'Electric Heat & Heat Strips',
          order: 6,
          domainKey: 'hvac_electrical',
        },
        {
...

    {
      ...
      competencies: [
        ...
        {
          competencyKey: 'refrigerant_environmental_impact',
          isCritical: true,
      ...
      lessons: [
        ...
        {
          slug: 'hvac-lesson-26',
          title: 'Cooling Systems Quiz + Cumulative Mastery (Modules 1-5)',
          order: 6,
          domainKey: 'refrigeration_cycle',
        },
        {
        ...
        {
          slug: 'hvac-lesson-30',
          title: 'Refrigerant Types & Classifications',
          order: 10,
          domainKey: 'refrigerant_handling',
        },
      ],
...

    {
      ...
      competencies: [
        {
          competencyKey: 'recovery_recycling_reclamation',
          isCritical: true,
          minimumTouchpoints: 2,
        },
      ...
      lessons: [
        {
          slug: 'hvac-lesson-31',
          title: 'Pressure-Temperature Fundamentals',
          order: 1,
          domainKey: 'refrigerant_handling',
        },
        {
        ...
        {
          slug: 'hvac-lesson-33',
          title: 'Refrigerant Sales Restrictions',
          order: 3,
          domainKey: 'epa608_regulations',
        },
        {
          slug: 'hvac-lesson-34',
          title: 'EPA 608 Core Practice Exam',
          order: 4,
          domainKey: 'epa608_regulations',
        },
        {
          slug: 'hvac-lesson-35',
          title: 'Small Appliance Systems',
          order: 5,
        ...
        {
          slug: 'hvac-lesson-37',
          title: 'Self-Contained Recovery Equipment',
          order: 7,
          domainKey: 'epa608_type1',
        },
        {
          slug: 'hvac-lesson-38',
          title: 'Leak Repair Exemptions',
          order: 8,
          domainKey: 'epa608_type1',
        },
        {
          slug: 'hvac-lesson-39',
          title: 'EPA 608 Type I Practice Exam',
          order: 9,
          domainKey: 'epa608_type1',
        },
        {
          slug: 'hvac-lesson-40',
          title: 'High-Pressure System Overview',
          order: 10,
...

    {
      ...
      lessons: [
        ...
        {
          slug: 'hvac-lesson-46',
          title: 'EPA 608 Type II Practice Exam',
          order: 6,
          domainKey: 'epa608_type2',
        },
        {
          slug: 'hvac-lesson-47',
          title: 'Low-Pressure System Overview',
          order: 7,
        ...
        {
          slug: 'hvac-lesson-49',
          title: 'Purge Units & Air Removal',
          order: 9,
          domainKey: 'epa608_type3',
        },
        {
          slug: 'hvac-lesson-50',
          title: 'Water in Low-Pressure Systems',
          order: 10,
          domainKey: 'epa608_type3',
        },
      ],
...

    {
      ...
      competencies: [
        ...
        {
          competencyKey: 'universal_cross_domain_integration',
          isCritical: true,
          minimumTouchpoints: 2,
        },
        { competencyKey: 'epa608_regulatory_framework', isCritical: true, minimumTouchpoints: 2 },
      ...
      lessons: [
        {
          slug: 'hvac-lesson-51',
          title: 'Rupture Disc & Pressure Relief',
          order: 1,
          domainKey: 'epa608_type3',
        },
        {
          slug: 'hvac-lesson-52',
          title: 'EPA 608 Type III Practice Exam',
          order: 2,
          domainKey: 'epa608_type3',
        },
        {
        ...
        {
          slug: 'hvac-lesson-55',
          title: 'Full-Length Practice Exam Core',
          order: 5,
          domainKey: 'epa608_universal',
        },
        {
          slug: 'hvac-lesson-56',
          title: 'Full-Length Practice Exam Type I',
          order: 6,
          domainKey: 'epa608_universal',
        },
        {
          slug: 'hvac-lesson-57',
          title: 'Full-Length Practice Exam Type II',
          order: 7,
          domainKey: 'epa608_universal',
        },
        {
          slug: 'hvac-lesson-58',
          title: 'Full-Length Practice Exam Type III',
          order: 8,
          domainKey: 'epa608_universal',
        },
        {
          slug: 'hvac-lesson-59',
          title: 'EPA 608 Universal Full Practice Exam',
          order: 9,
          domainKey: 'epa608_universal',
        },
        {
          slug: 'hvac-lesson-60',
          title: 'Refrigerant Charging Methods',
          order: 10,
          domainKey: 'refrigerant_handling',
        },
      ],
...

    {
      ...
      competencies: [
        {
          competencyKey: 'refrigeration_symptom_diagnosis',
          isCritical: true,
          minimumTouchpoints: 2,
        },
      ...
      lessons: [
        {
          slug: 'hvac-lesson-61',
          title: 'System Diagnostics with Gauges',
          order: 1,
          domainKey: 'hvac_diagnostics',
        },
        {
        ...
        {
          slug: 'hvac-lesson-64',
          title: 'Refrigeration Diagnostics Quiz',
          order: 4,
          domainKey: 'hvac_diagnostics',
        },
        {
          ...
          order: 5,
          domainKey: 'hvac_installation',
        },
        {
          slug: 'hvac-lesson-66',
          title: 'Equipment Sizing Manual J Basics',
          order: 6,
          domainKey: 'hvac_installation',
        },
        {
...

    {
      ...
      lessons: [
        ...
        {
          slug: 'hvac-lesson-76',
          title: 'Troubleshooting Quiz + Cumulative Mastery (Modules 1-13)',
          order: 6,
          domainKey: 'hvac_troubleshooting',
        },
        {
          slug: 'hvac-lesson-77',
          title: 'OSHA 30-Hour Construction — CareerSafe',
          order: 7,
...

    {
      ...
      lessons: [
        ...
        {
          slug: 'hvac-lesson-82',
          title: 'Confined Spaces & Excavations',
          order: 2,
          domainKey: 'hvac_safety',
        },
        {
          slug: 'hvac-lesson-83',
          title: 'Fire Prevention & Welding Safety',
          order: 3,
          domainKey: 'hvac_safety',
        },
        ...
        {
          slug: 'hvac-lesson-85',
          title: 'CPR/First Aid/AED Certification — CareerSafe',
          order: 5,
          domainKey: 'hvac_safety',
        },
        ...
        {
          slug: 'hvac-lesson-88',
          title: 'Rise Up Customer Service & Sales',
          order: 8,
...

    {
      ...
      lessons: [
        {
          slug: 'hvac-lesson-91',
          title: 'Interview Skills for Trades',
          order: 1,
          domainKey: 'hvac_career',
        },
        {
        ...
        {
          slug: 'hvac-lesson-93',
          title: 'OJT Internship Orientation',
          order: 3,
          domainKey: 'hvac_career',
        },
        {
  ...
  assessmentRules: [
    ...
    },
    {
      ...
      distributionConstraints: {
        ...
        type1_appliance_scope: 0.1,
        type2_appliance_scope: 0.15,
        type3_appliance_scope: 0.1,
        refrigeration_cycle_overview: 0.15,
        hvac_safety_procedures: 0.1,
      },
    },
  ],
