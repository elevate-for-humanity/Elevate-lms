    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-2"><Target className="w-8 h-8 text-brand-red-600" /></div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-brand-red-50 rounded-lg">
              <p className="text-2xl font-bold text-brand-red-600">{activeEnrollments}</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Link href="/workforce-board/employment" className="flex flex-col items-center p-6 bg-white rounded-xl shadow-sm border border-gray-200 hover:border-blue-300 hover:shadow-md transition">
            <Briefcase className="w-8 h-8 text-brand-red-600 mb-2" />
