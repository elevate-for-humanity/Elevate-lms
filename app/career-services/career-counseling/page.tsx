    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {counselingAreas.map((area, index) => (
              <div key={index} className="bg-brand-red-50 rounded-xl p-6 text-center hover:shadow-lg transition">
                <area.icon className="w-12 h-12 text-brand-red-600 mx-auto mb-4" />
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {assessments.map((assessment, index) => (
              <div key={index} className="bg-gray-50 rounded-xl p-6 flex items-start">
                <Circle className="w-6 h-6 text-brand-red-600 mr-4 flex-shrink-0 mt-1" />
                <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200">
              <div className="flex items-center mb-4">
                <Users className="w-8 h-8 text-brand-red-600 mr-3" />
            ...
            <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200">
              <div className="flex items-center mb-4">
                <MessageSquare className="w-8 h-8 text-brand-red-600 mr-3" />
      ...
      <section className="py-16 bg-brand-red-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-red-200">— Maria S., Program Graduate</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/apply"
              className="bg-brand-red-600 hover:bg-brand-red-700 text-white px-8 py-4 rounded-lg text-lg font-bold transition-all inline-flex items-center justify-center"
            >
