...
<section className="bg-brand-red-600 text-white py-12">
        <div className="max-w-4xl mx-auto px-4">
          <Link href="/store/demo" className="inline-flex items-center gap-2 text-brand-red-200 hover:text-white mb-4">
            <ArrowLeft className="w-4 h-4" /> Back to Demo Center
          </Link>
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-brand-red-500 rounded-xl flex items-center justify-center">
              <GraduationCap className="w-8 h-8" />
            </div>
            <div>
              <h1 className="text-3xl font-black">Instructor Demo</h1>
              <p className="text-brand-red-200">Explore the instructor experience</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {DEMO_SECTIONS.map((section, idx) => (
            <div key={idx} className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 flex items-start justify-between">
              ...
              <Link href={section.demoUrl} target="_blank" className="inline-flex items-center gap-2 bg-brand-red-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-brand-red-700">
      ...
      <section className="py-12 px-4 bg-white border-t text-center">
        ...
        <Link href="/store/licenses/managed" className="inline-flex items-center gap-2 bg-brand-red-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-brand-red-700">
