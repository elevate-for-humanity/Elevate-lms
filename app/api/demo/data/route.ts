...
export const demoData = {
  ...
  admin: {
    ...
    students: [
      ...
      { id: 's2', name: 'Sarah Mitchell', email: 's.mitchell@email.com', program: 'CNA Training', progress: 95, status: 'active', avatar: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/heroes/student-catalog.webp' },
      ...
      { id: 's4', name: 'Lisa Rodriguez', email: 'l.rodriguez@email.com', program: 'Medical Assistant', progress: 67, status: 'active', avatar: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/heroes/student-catalog.webp' },
      { id: 's5', name: 'James Thompson', email: 'j.thompson@email.com', program: 'CDL Training', progress: 85, status: 'active', avatar: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/heroes/student-catalog.webp' },
    ],
  },
  employer: {
    company: {
    ...
    candidates: [
      { id: 'c1', name: 'Sarah Mitchell', program: 'CNA Training', progress: 95, status: 'Interview Scheduled', match: 95, avatar: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/heroes/student-catalog.webp' },
      ...
      { id: 'c3', name: 'Lisa Rodriguez', program: 'Medical Assistant', progress: 67, status: 'Screening', match: 82, avatar: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/heroes/student-catalog.webp' },
    ...
    apprentices: [
      ...
      { id: 'ap2', name: 'Jennifer Lee', role: 'MA Apprentice', hours: 456, level: 'Entry', wage: '$15.00/hr', avatar: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/heroes/student-catalog.webp' },
