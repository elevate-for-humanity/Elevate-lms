    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-brand-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-base md:text-lg text-slate-300">Last Updated: February 22, 2026</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">What Are Cookies?</h2>
            ...
            <h3 className="text-lg md:text-lg font-bold text-black mb-4 mt-8">Essential Cookies</h3>
            <p className="text-black mb-4">
            ...
            <h3 className="text-lg md:text-lg font-bold text-black mb-4 mt-8">Analytics Cookies</h3>
            <p className="text-black mb-4">
              We use analytics cookies to understand how visitors interact with our website. This
              helps us improve our services. These cookies collect information such as:
            </p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <p className="text-black mb-4">You can control and manage cookies in several ways:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
              ...
              <li>
                <strong>Delete Cookies:</strong> You can delete cookies that have already been set
              </li>
              <li>
                <strong>Opt-Out Tools:</strong> Use browser extensions or opt-out tools provided by
                third parties
              </li>
            </ul>
            <p className="text-black mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-black mb-6 mt-12">Your Consent</h2>
            <p className="text-black mb-6">
              By using our website, you consent to our use of cookies as described in this policy.
              If you do not agree with our use of cookies, you should adjust your browser settings
