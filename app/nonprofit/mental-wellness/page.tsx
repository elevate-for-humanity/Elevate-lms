  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <Link href="/nonprofit" className="text-brand-red-600 hover:text-brand-red-700 mb-8 inline-block">
          ← Back to Selfish Inc.
        </Link>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {displayServices.map((service: any, index: number) => (
              <div key={index} className="bg-brand-red-50 rounded-xl p-6">
                <Circle className="w-6 h-6 text-brand-red-600 mb-3" />
            ...
            <div className="space-y-4">
              {workshops.map((workshop: any) => (
                <div key={workshop.id} className="bg-white border rounded-xl p-6 hover:shadow-md transition">
                  <div className="flex items-center gap-2 text-brand-red-600 mb-2">
        ...
        {/* CTA */}
        <section className="bg-brand-red-50 border border-brand-red-200 rounded-xl p-8 text-center">
          <Heart className="w-12 h-12 text-brand-red-600 mx-auto mb-4" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              ...
              className="bg-brand-red-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-brand-red-700 transition"
            >
              View Workshops
            </Link>
            <Link 
              href="/contact" 
              className="border border-brand-red-600 text-brand-red-600 px-6 py-3 rounded-lg font-semibold hover:bg-brand-red-50 transition"
            >
              Contact Us
            </Link>
          </div>
