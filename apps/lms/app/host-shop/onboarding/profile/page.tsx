...
async function saveHostShopProfile(formData: FormData) {
  ...
  const { error } = await db
    ...
    .update({
      ...
      contact_phone: phone || partner.phone || null,
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <form action={saveHostShopProfile} className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 sm:p-8">
          <div className="grid gap-5 sm:grid-cols-2">
            <label className="font-bold">
              ...
              <input
                name="supervisorName"
                required
                defaultValue={partner.supervisor_name || ''}
            ...
            <label className="font-bold">
              ...
              <input
                ...
                required
                defaultValue={partner.supervisor_license_number || ''}
                className="mt-2 w-full rounded-xl border border-slate-400 px-4 py-3 font-medium outline-none focus:border-blue-700 focus:ring-2 focus:ring-blue-100"
              />
            </label>
            <label className="font-bold">
              ...
              <input
                ...
                min="0"
                required
                defaultValue={partner.supervisor_years_licensed ?? ''}
                className="mt-2 w-full rounded-xl border border-slate-400 px-4 py-3 font-medium outline-none focus:border-blue-700 focus:ring-2 focus:ring-blue-100"
              />
            </label>
            <label className="font-bold">
              ...
              <select
                ...
                required
                defaultValue={partner.compensation_model || ''}
                className="mt-2 w-full rounded-xl border border-slate-400 bg-white px-4 py-3 font-medium outline-none focus:border-blue-700 focus:ring-2 focus:ring-blue-100"
              >
            ...
            <label className="font-bold">
              ...
              <select
                ...
                required
                defaultValue={partner.workers_comp_status || ''}
                className="mt-2 w-full rounded-xl border border-slate-400 bg-white px-4 py-3 font-medium outline-none focus:border-blue-700 focus:ring-2 focus:ring-blue-100"
              >
                <option value="">Select</option>
            ...
            <label className="font-bold sm:col-span-2">
              ...
              <input
                name="website"
                type="url"
                defaultValue={partner.website_url || partner.website || ''}
                className="mt-2 w-full rounded-xl border border-slate-400 px-4 py-3 font-medium outline-none focus:border-blue-700 focus:ring-2 focus:ring-blue-100"
              />
            </label>
          </div>
          ...
          <div className="mt-6 grid gap-3">
            <label className="flex items-start gap-3 rounded-xl border border-slate-300 p-4 text-sm font-semibold leading-6">
              <input
                ...
                value="yes"
                type="checkbox"
                defaultChecked={partner.can_supervise_and_verify === true}
            ...
            <label className="flex items-start gap-3 rounded-xl border border-slate-300 p-4 text-sm font-semibold leading-6">
              <input
                ...
                value="yes"
                type="checkbox"
                defaultChecked={partner.has_general_liability === true}
                className="mt-1 h-5 w-5"
              />
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              type="submit"
              className="rounded-xl bg-blue-700 px-6 py-3 font-black text-white hover:bg-blue-800"
            >
