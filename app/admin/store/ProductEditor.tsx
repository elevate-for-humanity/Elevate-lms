  ...
  return (
    <div className="bg-white p-6 shadow rounded-lg space-y-4">
      ...
      <button
        onClick={publish}
        disabled={loading}
        className="w-full bg-brand-blue-600 text-white p-3 rounded hover:bg-green-700 disabled:bg-green-300 disabled:cursor-not-allowed transition-colors font-medium"
      >
