      ...
      <section className="py-14 sm:py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6">
            {[
              { title: 'Workforce Boards', desc: 'WIOA eligibility determination, ITA management, PIRL reporting, provider network oversight, quarterly performance metrics. Replace your current patchwork of systems with one platform that does it all.', img: '/images/pages/wioa-meeting.webp' },
              { title: 'Training Providers', desc: 'Student enrollment, attendance tracking, course delivery, credential issuance, outcome reporting to funders. Stop emailing spreadsheets to your workforce board.', img: '/images/pages/comp-home-highlight-health.webp' },
              { title: 'Apprenticeship Sponsors', desc: 'DOL-registered program management. Apprentice hour logging, wage progression tracking, OJT reimbursement processing, completion documentation. All in one place.', img: '/images/pages/employer-handshake.webp' },
            ].map((item) => (
          ...
          <Image
            placeholder="blur"
            blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAFUlEQVR42mP8z8BQDwADhQGAWjR9awAAAABJRU5ErkJggg==" src={item.img} alt={item.title} fill quality={85} className="object-cover" sizes="(max-width: 768px) 100vw, 200px" />
                </div>
                <div className="p-6">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="border border-slate-200 rounded-2xl p-8">
              ...
              <Link href="/store/licenses/enterprise-license" className="block text-center border border-slate-300 text-slate-700 font-bold py-3 rounded-lg hover:bg-white transition">
      ...
      <section className="py-10 border-t border-slate-100">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/store" className="px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-700 hover:border-brand-red-300 hover:text-brand-red-700 transition-colors">
              All Products
            </Link>
          </div>
        </div>
      ...
      <section className="py-14 sm:py-20 bg-slate-900">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/store/demos" className="inline-flex items-center justify-center gap-2 bg-white text-slate-900 font-semibold px-8 py-3.5 rounded-lg hover:bg-white transition">
              Try Full Demo First
            </Link>
          </div>
        </div>
