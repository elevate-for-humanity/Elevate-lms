      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="prose prose-slate max-w-none">
          <p className="text-lg text-slate-700 leading-relaxed mb-8">
            ...
            related technical instruction (RTI), and employer-aligned work-based learning through a
            unified and documented governance framework.
          </p>
              ...
              <div className="flex flex-col items-center gap-0">
                ...
                <div className="w-full max-w-md bg-brand-blue-700 text-white rounded-lg px-6 py-4 text-center">
                  ...
                  <p className="text-slate-500 text-xs mt-1">
                    Legal Entity &amp; Registered Apprenticeship Sponsor
                  </p>
                  <p className="text-slate-500 text-[10px] mt-1">
                    EIN 88-2609728 | RAPIDS 2025-IN-132301
                  </p>
                </div>
                ...
                <div className="w-full max-w-md bg-white border-2 border-slate-300 rounded-lg px-6 py-4 text-center">
                  <p className="font-bold text-sm text-slate-900">
                    Licensed Partner Shops &amp; Employers
                  </p>
                  <p className="text-slate-500 text-xs mt-1">
                    Approved Training Sites &amp; Participating Employers
                  </p>
                </div>
                <div className="w-px h-6 bg-slate-400" />
                <div className="text-slate-400 text-xs">↓</div>
                ...
                <div className="w-full max-w-md bg-brand-green-50 border-2 border-brand-green-300 rounded-lg px-6 py-4 text-center">
                  <p className="font-bold text-sm text-brand-green-900">
                    Apprentices &amp; Students
                  </p>
                  <p className="text-brand-green-700 text-xs mt-1">
                    Related Technical Instruction (RTI) + On-the-Job Training (OJT)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-5">
              <dl className="grid sm:grid-cols-2 gap-x-8 gap-y-3 text-sm">
                ...
                <div>
                  ...
                  <dd className="font-semibold text-slate-900 mt-0.5">
                    8888 Keystone Crossing, Suite 1300, Indianapolis, IN 46240 (Marion County)
                  </dd>
                </div>
              </dl>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4 text-sm text-slate-700">
              <div className="bg-white border border-slate-200 rounded-lg p-5">
                ...
                <p>
                  2Exclusive LLC-S serves as the sponsor of record for all Registered Apprenticeship
                  programs. The sponsor oversees apprenticeship standards, curriculum alignment,
                  apprentice registration, hour tracking, and compliance reporting in accordance
                  with U.S. DOL Office of Apprenticeship requirements.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-5">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-5">
                ...
                <p>
                  On-the-job training (OJT) is completed at sponsor-approved licensed employer and
                  partner locations operating under formal training agreements. Each participating
                  employer is documented in RAPIDS with an Employer Acceptance Agreement.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-5">
                <h3 className="font-bold text-slate-900 mb-2">Compliance &amp; Reporting</h3>
                <p>
                  The organization maintains documented compliance with WIOA performance standards,
                  DOL apprenticeship regulations (29 CFR Part 29/30), Indiana Professional Licensing
                  Agency requirements, and applicable state workforce board guidelines. Progress
                  reporting, credential attainment, and employment outcomes are tracked and
                  available to authorized reviewing agencies.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            <h2 className="text-xl font-bold text-slate-900 mb-4">
              Apprenticeship Sponsor Disclosure
            </h2>
            <div className="bg-brand-blue-700 text-white rounded-lg p-6">
              <dl className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <dd className="font-semibold mt-0.5">
                    Sponsor-approved licensed employer and partner locations operating under formal
                    training agreements.
                  </dd>
                </div>
              </dl>
          ...
          <section className="mb-10">
            ...
            <p className="text-sm text-slate-600 mb-4">
              The following RTI providers are registered in RAPIDS under Program 2025-IN-132301.
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border border-slate-200 rounded-lg overflow-hidden">
                ...
                <tbody className="divide-y divide-slate-100">
                  {[
                    {
                      occ: 'Building Services Technician',
          ...
          <section className="mb-10">
            <h2 className="text-xl font-bold text-slate-900 mb-4">
              Funding &amp; Eligibility Disclosure
            </h2>
          ...
          <div className="border-t border-slate-200 pt-8 flex flex-wrap gap-3">
            ...
            <Link
              href="/compliance"
              className="inline-flex items-center gap-2 border border-slate-300 text-slate-700 px-5 py-2.5 rounded-lg font-semibold text-sm hover:border-brand-blue-400 hover:text-brand-blue-600 transition-colors"
            >
              Compliance &amp; Security
            </Link>
            <Link
