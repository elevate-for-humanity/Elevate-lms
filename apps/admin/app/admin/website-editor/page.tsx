...
export default function WebsiteEditorPage() {
  ...
  const save = async (
    ...
    const payload = {
      ...
      primaryCtaHref:
        form.get("primaryCtaHref"),
      secondaryCtaLabel:
        form.get("secondaryCtaLabel"),
      secondaryCtaHref:
        form.get("secondaryCtaHref"),
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-6">
          ...
          <p className="mt-3 text-lg text-slate-600">
            Update page titles, hero banners,
            descriptions, images, and calls to
            action.
          </p>
        </div>
        ...
        >
          ...
          <TextArea
            name="summary"
            label="Hero summary"
            placeholder="Explain the program and the next step in clear student-focused language."
            required
          />
          ...
          {message && (
            <div
              className={
                status === "error"
                  ? "rounded-xl bg-red-100 p-4 text-red-900"
                  : "rounded-xl bg-emerald-100 p-4 text-emerald-900"
              }
            >
              {message}
            </div>
