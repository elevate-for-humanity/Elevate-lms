        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <button
              ...
              className="px-6 py-2 border border-slate-300 rounded-lg text-sm text-slate-900 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {resendSent
                ? 'Email resent ✓'
                : resendLoading
      ...
      <form onSubmit={handleSignup} className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            required
            className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-brand-blue-500 focus:border-transparent bg-white"
          >
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full px-4 py-3 bg-brand-blue-600 text-white rounded-lg hover:bg-brand-blue-700 transition-colors disabled:bg-slate-300 disabled:cursor-not-allowed font-medium"
        >
      ...
      <div className="mt-6">
        ...
        <div className="mt-4 space-y-3">
          <button
            ...
            className="w-full px-4 py-3 border border-slate-300 rounded-lg hover:bg-white transition-colors flex items-center justify-center"
          >
