  ...
  return (
    <div className="min-h-screen bg-white">
      <HeroVideo
        ...
        ctas={[
          heroBanners['apprenticeship-sponsor'].primaryCta,
          heroBanners['apprenticeship-sponsor'].secondaryCta,
        ].filter(Boolean)}
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <section className="mb-14">
          ...
          <p className="text-slate-700 mb-6">
            As the Registered Apprenticeship Sponsor, 2Exclusive LLC-S is responsible for all
            aspects of program governance, compliance, and quality assurance:
          </p>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              {
                title: 'Standards Registration',
                desc: 'Register and maintain apprenticeship standards with USDOL RAPIDS.',
              },
              {
                title: 'Curriculum Development',
                desc: 'Develop and deliver related technical instruction aligned to competency standards.',
              },
              {
                title: 'Partner Site Approval',
                desc: 'Vet, approve, and onboard licensed employer training sites under formal agreements.',
              },
              {
                title: 'Hour Tracking',
                desc: 'Document and verify all OJT and RTI hours through institutional tracking systems.',
              },
              {
                title: 'Competency Verification',
                desc: 'Assess and verify apprentice skill progression through structured evaluations.',
              },
              {
                title: 'Apprentice Registration',
                desc: 'Register apprentices with RAPIDS and manage all enrollment documentation.',
              },
              {
                title: 'Compliance Reporting',
                desc: 'Submit required reports to USDOL, Indiana DWD, and applicable state agencies.',
              },
              {
                title: 'Quality Assurance',
                desc: 'Conduct site visits, monitor training quality, and enforce program standards.',
              },
            ].map((item) => (
        ...
        <section className="mb-14">
          ...
          <p className="text-slate-700 mb-6">
            Apprentices receive structured instruction through the institute while completing
            supervised on-the-job training at sponsor-approved licensed partner locations in
            accordance with state and federal apprenticeship standards.
          </p>
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-brand-red-50 border border-brand-red-200 rounded-xl p-6">
              <h3 className="font-bold text-brand-red-900 text-lg mb-2">
              ...
              <p className="text-brand-red-700 text-xs mt-3 font-medium">
                Provided by: The Institute (Sponsor)
              </p>
            </div>
            <div className="bg-white border border-slate-200 rounded-xl p-6">
              <h3 className="font-bold text-slate-900 text-lg mb-2">On-the-Job Training (OJT)</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Delivered at licensed employer partner locations operating under formal training
                agreements. OJT provides supervised practical experience under the direction of
                licensed professionals at approved training sites.
              </p>
              <p className="text-slate-500 text-xs mt-3 font-medium">
                Provided by: Licensed Partner Training Sites
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-14">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-6">
            <p className="text-amber-900 leading-relaxed">
              Partner barbershops and employer training sites are licensed facilities that provide
              supervised practical training under sponsor-approved standards. Partner locations do
              not function as the apprenticeship sponsor or instructional institution but operate as
              approved training sites within the registered program structure.
            </p>
          </div>
          <p className="text-slate-700 mb-4">
            All partner locations operate under formal training agreements that specify:
          </p>
          ...
          <div className="bg-white border-2 border-brand-red-200 rounded-xl p-6 sm:p-8">
            ...
            <p className="text-slate-600 mb-6">
              Licensed barbershops and employer locations can apply to become an approved partner
              training site. We provide training standards, curriculum support, hour tracking
        ...
        <section className="mb-14">
          ...
          <div className="space-y-3">
            <div className="bg-brand-blue-700 text-white rounded-xl p-5 flex items-center gap-4">
              <span className="bg-brand-red-600 text-white text-xs font-bold px-2.5 py-1 rounded">
                1
              </span>
              <div>
            ...
            <div className="bg-brand-blue-700 text-white rounded-xl p-5 flex items-center gap-4">
              <span className="bg-white text-brand-red-600 text-xs font-bold px-2.5 py-1 rounded">
                2
              </span>
              <div>
