        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {user ? (
            <Link
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-brand-red-600 rounded-lg hover:bg-brand-red-50 font-semibold text-lg"
            >
              Apply to Sell
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid sm:grid-cols-4 gap-6">
            {steps.map((step) => (
              <div key={step.number} className="text-center">
                <div className="w-12 h-12 bg-brand-red-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                  {step.number}
                </div>
        ...
        <div className="text-center">
          ...
          {user ? (
            <Link
              href="/marketplace/apply"
              className="inline-flex items-center gap-2 px-8 py-4 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700 font-semibold text-lg"
            >
