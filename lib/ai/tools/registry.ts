...
export const AI_TOOL_REGISTRY: readonly AIToolDefinition[] = [
  ...
  { name: 'wioa.list', description: 'Read current WIOA/workforce records exposed to Admin.', method: 'GET', path: '/api/admin/wioa', classification: 'read', risk: 'medium', scope: 'platform', allowedAgents: ['ZORA', 'LIZZY'], allowedRoles: ADMIN_ROLES, approvalRequired: false, idempotent: true, timeoutMs: 15_000, retryAttempts: 2, audit: true },
