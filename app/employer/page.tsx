          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-slate-600 text-sm leading-relaxed mb-6">
                Tell us what roles you need to fill. We'll match you to current graduates, walk you
                through available incentives, and set up a hiring pipeline that works for your team.
              </p>
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  href="/apply"
                  className="inline-flex items-center gap-2 bg-brand-blue-600 hover:bg-brand-blue-700 text-white font-bold px-6 py-3 rounded-lg transition-colors text-sm"
                >
                  Apply Now <ChevronRight className="w-4 h-4" />
                </Link>
                <a
                  href="mailto:info@elevateforhumanity.org"
                  className="inline-flex items-center gap-2 border border-slate-300 hover:border-slate-400 text-slate-700 font-semibold px-6 py-3 rounded-lg transition-colors text-sm"
                >
                  Email Us
                </a>
              </div>
