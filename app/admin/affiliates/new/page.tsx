...
<div className="max-w-2xl mx-auto">
        <Link href="/admin/affiliates" className="flex items-center gap-2 text-gray-600 hover:text-brand-red-600 mb-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {['Barber Apprenticeship', 'Medical Assistant Training', 'IT Certifications', 'WOTC Services', 'All Programs'].map((program) => (
                    <label key={program} className="flex items-center gap-2 p-3 border rounded-lg cursor-pointer hover:border-brand-red-300">
