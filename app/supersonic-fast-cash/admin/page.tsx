...
{/* Header */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border">
            <Calendar className="w-8 h-8 text-brand-red-600 mb-2" />
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border">
            ...
            <div className="space-y-3">
              ...
              <Link
                ...
                className="flex items-center justify-between p-4 bg-brand-red-50 rounded-lg hover:bg-brand-red-100 transition"
              >
                <div className="flex items-center gap-3">
        ...
        <div className="mt-8">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Link
              ...
              className="bg-white rounded-xl p-6 shadow-sm border hover:border-orange-300 transition"
            >
              <Users className="w-8 h-8 text-brand-red-600 mb-3" />
