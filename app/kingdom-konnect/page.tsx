    ...
    <div className="bg-white">
      ...
      <section className="relative h-[400px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-brand-red-100">Faith-based partnerships for community transformation</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <Users className="w-12 h-12 text-brand-red-600 mx-auto mb-4" />
      ...
      <section className="py-16 bg-brand-red-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-brand-red-100 mb-8">Join our network of faith-based organizations making a difference.</p>
          <Link href="/partners" className="bg-white hover:bg-gray-100 text-brand-red-900 px-8 py-4 rounded-lg text-lg font-bold transition inline-flex items-center">
