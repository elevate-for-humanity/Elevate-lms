...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      default: 'bg-brand-blue-600 text-white hover:bg-brand-blue-700 focus:ring-blue-500',
      primary: 'bg-brand-blue-600 text-white hover:bg-brand-blue-700 focus:ring-blue-500',
      secondary:
        'bg-white text-black border-2 border-slate-300 hover:bg-slate-50 hover:border-slate-400 focus:ring-slate-500',
      tertiary:
        'bg-transparent text-brand-blue-600 hover:bg-gray-50 focus:ring-blue-500',
      danger: 'bg-brand-blue-600 text-white hover:bg-brand-blue-700 focus:ring-red-500',
      destructive: 'bg-brand-blue-600 text-white hover:bg-brand-blue-700 focus:ring-red-500',
      outline:
        'bg-white text-black border-2 border-slate-300 hover:bg-slate-50 hover:border-slate-400 focus:ring-slate-500',
      ghost:
        'bg-transparent text-black hover:bg-slate-100 focus:ring-slate-500',
      link: 'text-brand-blue-600 underline-offset-4 hover:underline focus:ring-blue-500',
    };
