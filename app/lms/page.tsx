...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.elevateforhumanity.org/lms' },
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 sm:py-24 border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-xs font-bold text-brand-red-600 uppercase tracking-widest mb-4">
            {PLATFORM_DEFAULTS.orgName} · Career Training
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href={buildLoginRedirect('/lms/courses')} className="w-full sm:w-auto flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-700 text-white font-bold px-8 py-4 rounded-xl text-base transition">Enter Student Portal <ChevronRight className="w-4 h-4" /></Link>
            <Link href="/lms/programs" className="w-full sm:w-auto flex items-center justify-center gap-2 border-2 border-slate-200 hover:border-slate-400 text-slate-900 font-bold px-8 py-4 rounded-xl text-base transition">Browse Programs</Link>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center mt-8">
            <Link href="/lms/programs" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-700 border border-slate-200 px-5 py-2.5 rounded-xl hover:bg-slate-50 transition">View All Programs <ChevronRight className="w-4 h-4" /></Link>
          </div>
        </div>
      </section>
