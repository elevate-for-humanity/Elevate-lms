-- Expand the Course Factory atomic package writer to preserve the full
-- canonical course_modules/course_lessons authoring contract used by Studio,
-- compliance curricula, practicals, media, and credential-aligned courses.
  ...
  loop
    ...
    loop
      ...
      insert into public.course_lessons (
        ...
        objective, content, rendered_html, quiz_questions, passing_score,
...
is 'Atomic Course Factory persistence preserving full module/lesson authoring and compliance metadata.';
