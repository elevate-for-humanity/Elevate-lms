...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'Complete your program, earn your certification, and connect with employer partners through our career services team.',
    icon: DollarSign,
  },
];
...
const FUNDING_SOURCES = [
  ...
  },
  {
    ...
    desc: 'Earn while you learn through Department of Labor registered apprenticeship programs. Employer-sponsored with structured on-the-job training.',
    href: '/funding/dol',
  },
  {
  ...
  {
    name: 'Job Ready Indy',
    desc: 'Funding for justice-involved individuals re-entering the workforce. Covers training, certifications, and supportive services.',
    href: '/funding/jri',
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full">
        ...
        {/* IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback) */}
          <Image
            src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/funding-page-3.webp"
        ...
        <div className="bg-white py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-black max-w-3xl mx-auto">
              Many of our training programs may be available at no cost to eligible participants
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-black text-center mb-10 max-w-2xl mx-auto">
            Eligibility varies by program and individual circumstances. Our enrollment team will
            help identify the right funding path for you.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            {FUNDING_SOURCES.map((f) => (
              <Link
                key={f.name}
                href={f.href}
                className="bg-white border border-slate-200 rounded-xl p-6 hover:shadow-md hover:border-brand-blue-300 transition-all group"
              >
                <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-brand-blue-600">
                  {f.name}
                </h3>
