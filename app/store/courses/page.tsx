...
{/* Hero */}
      <section className="relative min-h-[400px] flex items-center overflow-hidden bg-brand-red-900">
        <video
          autoPlay
          muted
          loop
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-black text-white leading-tight mb-6">
              ...
              <span className="block text-brand-red-300">With Exam Vouchers</span>
            </h1>
            ...
            {courses.map((course) => (
              ...
              >
                <div className="relative h-48">
                  ...
                  />
                  <div className="absolute top-4 left-4 px-3 py-1 bg-brand-red-600 text-white text-xs font-bold rounded-full">
                    {course.provider}
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1 text-brand-red-600 font-semibold hover:text-brand-red-700"
                    >
                      View Details
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <Shield className="w-12 h-12 text-brand-red-600 mx-auto mb-4" />
            ...
            <div>
              <BookOpen className="w-12 h-12 text-brand-red-600 mx-auto mb-4" />
      ...
      <section className="py-16 bg-brand-red-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 bg-white text-brand-red-700 px-8 py-4 rounded-lg font-bold text-lg hover:bg-brand-red-50 transition-colors"
          >
            Get Volume Pricing
