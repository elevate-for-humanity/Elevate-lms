    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-brand-red-600 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-brand-red-100 mb-8">A connected network of learners, employers, and partners working together to transform careers</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {partners.map((p, i) => (
              <div key={i} className="bg-white rounded-xl p-6 shadow-sm border text-center">
                <p.icon className="w-12 h-12 text-brand-red-600 mx-auto mb-4" />
