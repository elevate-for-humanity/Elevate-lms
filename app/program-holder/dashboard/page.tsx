        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <LayoutDashboard className="w-8 h-8 text-brand-red-600" />
              <h1 className="text-2xl font-bold text-gray-900">Program Holder Portal</h1>
            </div>
            <div className="flex items-center gap-4">
              <Link href="/program-holder/settings" className="p-2 text-gray-600 hover:text-brand-red-600">
          ...
          {stats.map((stat, index) => (
            <div key={index} className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
                <stat.icon className="w-8 h-8 text-brand-red-600" />
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/program-holder/analytics" className="text-brand-red-600 hover:underline text-sm">View All</Link>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                <Link href="/program-holder/programs/new" className="flex items-center gap-3 p-3 bg-brand-red-50 rounded-lg text-brand-red-700 hover:bg-brand-red-100">
