...
export default function HeroVideo({
  ...
  // Start once when the hero substantially enters view. After playback starts,
  // scrolling away does NOT pause it; it continues to completion as requested.
  useEffect(() => {
  ...
  // Next.js can preserve layouts during client navigation. Stop hero media as
  // soon as the pathname changes so audio/video never leaks into the next page.
  useEffect(() => {
