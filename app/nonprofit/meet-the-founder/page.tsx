    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-brand-red-50 border border-brand-red-200 rounded-lg p-6 mt-8">
            ...
            <Link href="/rise-foundation/get-involved" className="inline-block bg-brand-red-600 text-white px-6 py-3 rounded-lg hover:bg-brand-red-700 transition">
              Learn More
            </Link>
          </div>
        </div>
