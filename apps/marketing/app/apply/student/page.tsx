...
const TRUST = [
  ...
  {
    stat: 'Written approval',
    label: 'Required before third-party funding is treated as confirmed',
  },
...
export default async function StudentApplicationPage({
  ...
  return (
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="border-b border-slate-200 px-4 py-10">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mb-6 max-w-3xl text-base leading-7 text-slate-700 sm:text-lg">
            Submit your application, then complete the admission, funding, payment, document, and
            onboarding steps that apply to your selected program. Third-party funding is never
            guaranteed by submitting this form.
          </p>
      ...
      <section className="border-b border-slate-200 px-4 py-14">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10">
            ...
            <h2 className="mb-2 text-2xl font-extrabold text-slate-950 sm:text-3xl">
              Review Before You Select
            </h2>
            <p className="max-w-3xl text-sm leading-6 text-slate-700">
              Program requirements are not interchangeable. Open the program record to verify its
              current duration, credential objective, tuition, delivery model, and funding
              disclosure.
            </p>
          </div>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="mt-1 text-xs leading-5 text-slate-700">
                    <span className="font-bold text-slate-950">Credential:</span>{' '}
                    {program.credential}
                  </p>
                  <p className="mt-3 text-xs leading-5 text-slate-600">
                    {program.fundingStatement}
                  </p>
                </div>
              </Link>
            ))}
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-2 max-w-2xl text-sm leading-6 text-slate-700">
              The exact sequence can vary by program and funding source. These are the controls
              every applicant should expect to verify.
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-5xl gap-10 sm:grid-cols-2 sm:items-start">
          <div>
            ...
            <h2 className="mb-4 text-2xl font-extrabold text-slate-950">
              Funding must be verified for the participant and program.
            </h2>
            <p className="mb-4 text-sm leading-6 text-slate-700">
              Some applicants may qualify for workforce, vocational-rehabilitation, employer, or
              other third-party assistance. The responsible funder—not Elevate—determines
              eligibility, available funds, covered costs, and the authorized amount.
            </p>
            <p className="mb-6 text-sm leading-6 text-slate-700">
              Do not treat an application, eligibility quiz, provider relationship, or website
              funding label as a voucher or payment authorization.
            </p>
            <Link
              href="/funding"
      ...
      <section
        className="border-b border-emerald-200 bg-emerald-50 px-4 py-14"
        aria-labelledby="foundation-support-title"
      >
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              <p className="mb-2 text-xs font-black uppercase tracking-widest text-emerald-800">
                Support Beyond Tuition
              </p>
              <h2
                id="foundation-support-title"
                className="text-2xl font-extrabold text-slate-950 sm:text-3xl"
              >
                Rise Forward Foundation may help connect eligible participants to additional
                support.
              </h2>
              <p className="mt-4 text-sm leading-6 text-slate-700">
                Selfish Inc. d/b/a Rise Forward Foundation works alongside Elevate as a nonprofit
                community-support partner. Available support is separate from tuition funding and
                depends on the Foundation's programs, resources, and participant eligibility.
              </p>
              <Link
                href="/rise-forward-foundation"
                className="mt-6 inline-flex min-h-11 items-center rounded-xl bg-emerald-800 px-5 py-3 text-sm font-black text-white hover:bg-emerald-900"
              >
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <article className="rounded-2xl border border-emerald-200 bg-white p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-700">
                  Public or third-party funding must be separately approved by the responsible
                  funder for the participant and program.
                </p>
              </article>
              <article className="rounded-2xl border border-emerald-200 bg-white p-5">
                <h3 className="text-sm font-black text-slate-950">Wraparound resources</h3>
                <p className="mt-2 text-sm leading-6 text-slate-700">
                  Eligible participants may be referred for available community resources,
                  financial-capability support, or other barrier-reduction services.
                </p>
              </article>
              <article className="rounded-2xl border border-emerald-200 bg-white p-5">
                <h3 className="text-sm font-black text-slate-950">No automatic benefit</h3>
                <p className="mt-2 text-sm leading-6 text-slate-700">
                  Submitting this application does not guarantee a voucher, reimbursement, books,
                  equipment, counseling, or another specific charitable benefit.
                </p>
              </article>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-8">
            ...
            <p className="max-w-2xl text-sm leading-6 text-slate-700">
              Provide complete and accurate information. Admissions will use the contact information
              you submit to communicate your next required steps. For assistance, call{' '}
              <a
      ...
      <section className="border-t border-slate-200 bg-slate-50 px-4 py-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-3">
            <Link
              href="/apply/employer"
              className="text-sm font-semibold text-brand-blue-800 hover:underline"
            >
