...
export const metadata: Metadata = {
  title: 'Outcomes | Admin Demo | {PLATFORM_DEFAULTS.orgName}',
  ...
  return (
    <DemoPageShell title="Outcomes" description="Program completion rates, credential attainment, and employment outcomes." portal="admin">
      <section className="relative h-[60vh] min-h-[400px] max-h-[720px] mb-6">
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/demo-page-6.webp" alt="Platform demo" fill sizes="100vw" className="object-cover" priority />
      </section>
