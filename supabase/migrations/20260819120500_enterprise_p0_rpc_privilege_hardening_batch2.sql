...
-- Lock server/trigger-owned mutation RPCs to service_role.
...
BEGIN
  ...
  INSERT INTO public.onboarding_progress (
    user_id, role, agreements_completed, agreements_completed_at, updated_at
  ) VALUES (
    p_user_id, p_role, true, now(), now()
  )
