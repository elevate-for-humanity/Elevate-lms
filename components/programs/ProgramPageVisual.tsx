...
export function ProgramPageVisual({ program }: Props) {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[clamp(520px,72svh,860px)] flex items-end">
        {program.heroVideo ? (
          <UltraVideoPlayer
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white text-lg mb-6">
            {program.fundingType === 'funded'
              ? 'Workforce funding may apply only when the selected program and participant are eligible and the responsible agency authorizes payment.'
