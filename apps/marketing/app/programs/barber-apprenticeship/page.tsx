...
const FLOW = [
  {
    ...
    body: 'Complete verified Related Technical Instruction alongside your hands-on training.',
  },
  {
    icon: Scissors,
    title: 'Train in a host shop',
    body: 'Build real barbering skills under approved supervision in the workplace.',
  },
  {
    icon: Clock3,
    title: 'Track progress',
    body: 'Document OJL, RTI, skills, attendance, and required apprenticeship milestones.',
  },
  {
    icon: BadgeCheck,
    title: 'Prepare for licensing',
    body: 'Complete the pathway requirements tied to Indiana barber licensing preparation.',
  },
] as const;
...
export default async function BarberApprenticeshipPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="relative h-[clamp(280px,46vw,620px)] overflow-hidden bg-slate-100" aria-label="Barber apprenticeship training">
        <Image
          src={BARBER_HERO_IMAGE}
          alt="Barber apprentice receiving supervised hands-on training in a licensed barbershop"
          fill
          priority
          sizes="100vw"
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-4xl">
            ...
            <p className="mt-4 max-w-3xl text-base font-medium leading-7 text-slate-700 sm:text-lg sm:leading-8">
              A competency-based barber apprenticeship combining verified technical instruction,
              supervised host-shop training, digital progress records, and Indiana licensing
              preparation.
            </p>
            <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <Link
                href={program.cta.applyHref}
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-brand-red-600 px-7 py-3.5 text-sm font-black text-white hover:bg-brand-red-700"
              >
                Apply for Barber Apprenticeship <ArrowRight className="h-4 w-4" />
              </Link>
              <Link
                href="#host-shops"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-brand-blue-800 px-7 py-3.5 text-sm font-black text-white hover:bg-brand-blue-900"
              >
                Explore Host Shops <Building2 className="h-4 w-4" />
              </Link>
              <Link
                href="/partners/host-shops"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border-2 border-brand-blue-700 bg-white px-7 py-3.5 text-sm font-black text-brand-blue-900 hover:bg-sky-50"
              >
                Become a Host Shop
              </Link>
            </div>
      ...
      <section className="border-b border-slate-200 bg-slate-50 px-4 py-8">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-3 lg:grid-cols-4">
          ...
          <Fact
            ...
            value={program.selfPayCost || 'See program details'}
          />
        </div>
      </section>
      ...
      <section
        ...
        className="border-b border-slate-200 bg-sky-50 px-4 py-10 sm:py-14"
      >
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 max-w-3xl">
            ...
            <p className="mt-3 text-base leading-7 text-slate-700">
              Approved host shops provide the supervised work setting. Placement availability is
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">
                One pathway from training to documented progress.
              </h2>
      ...
      >
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h2
              id="barber-visual-story-heading"
              className="mt-3 text-3xl font-black tracking-tight sm:text-4xl"
            >
              Theory, practice, and workplace learning belong together.
            </h2>
            <p className="mt-4 text-base leading-7 text-slate-700 sm:text-lg">
              More views of classroom instruction, hands-on barbering, and the host-shop experience.
            </p>
          </div>
            ...
            {VISUAL_STORY.map((item) => (
              ...
              >
                ...
                <div className="p-5 sm:p-6">
                  <p className="text-[11px] font-black uppercase tracking-[0.16em] text-brand-red-700">
                    {item.label}
                  </p>
      ...
      <section
        ...
        className="border-y border-orange-200 bg-orange-50 px-4 py-14 sm:py-18"
          ...
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <Link
                ...
                className="inline-flex min-h-12 items-center justify-center rounded-xl bg-brand-red-600 px-7 py-3.5 font-black text-white hover:bg-brand-red-700"
              >
              ...
              <Link
                href={program.cta.applyHref}
                className="inline-flex min-h-12 items-center justify-center rounded-xl border-2 border-slate-400 bg-white px-7 py-3.5 font-black text-slate-950 hover:bg-slate-50"
              >
      ...
      <section className="border-y border-sky-200 bg-sky-50 px-4 py-14 text-slate-950">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-brand-red-700 sm:text-sm">
              Skills you build
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">
              Training that connects theory to the shop floor.
            </h2>
          </div>
      ...
      <section className="border-t border-sky-200 bg-white px-4 py-14 text-slate-950">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-black sm:text-4xl">
            Ready to start the barber apprenticeship?
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-base font-semibold leading-7 text-slate-700 sm:text-lg">
            Apply as an apprentice or start the host-shop process. Funding and placement are
            verified separately before enrollment is finalized.
          </p>
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Link
              href={program.cta.applyHref}
              className="rounded-xl bg-brand-red-600 px-8 py-4 font-black text-white hover:bg-brand-red-700"
            >
              Apply Now
            </Link>
            <Link
              href="/partners/host-shops"
              className="rounded-xl border-2 border-brand-blue-700 bg-white px-8 py-4 font-black text-brand-blue-900 hover:bg-sky-50"
            >
...
function Fact({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
      ...
      <div className="mt-3 text-[10px] font-black uppercase tracking-widest text-slate-500 sm:text-xs">
        {label}
      </div>
...
export async function generateMetadata() {
  return {
    ...
    openGraph: {
      ...
      description:
        'Competency-based registered barber apprenticeship with verified RTI, supervised host-shop training, digital progress records, and Indiana licensing preparation.',
