...
export const PROGRAM_IMAGES: Record<string, ProgramImageEntry> = {
  ...
  qma: { card: `${P}/funding-impact-1.webp`, hero: `${P}/healthcare-hero.webp`, alt: 'Qualified Medication Aide preparing for supervised medication administration' },
  ...
  'cosmetology-apprenticeship': { card: `${P}/cosmetology.webp`, hero: `${P}/cosmetology.webp`, alt: 'Cosmetology apprentice practicing professional hair services in a salon' },
  esthetician: { card: '/images/beauty/esthetics-hero.webp', hero: '/images/beauty/esthetics-hero.webp', alt: 'Esthetics learner practicing professional skincare and client services' },
  'esthetician-apprenticeship': { card: '/images/beauty/esthetician.webp', hero: '/images/beauty/esthetician.webp', alt: 'Esthetician apprentice providing a professional skincare treatment' },
  'nail-technician-apprenticeship': { card: `${P}/nail-technician.webp`, hero: `${P}/nail-technician.webp`, alt: 'Nail technician apprentice performing a manicure in a licensed salon' },
