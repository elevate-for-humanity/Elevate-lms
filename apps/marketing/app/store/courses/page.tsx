...
{/* Hero */}
      ...
      <section className="relative w-full">
        <div className="relative h-[clamp(190px,32vw,360px)] w-full overflow-hidden">
          <Image
            placeholder="blur"
            blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAFUlEQVR42mP8z8BQDwADhQGAWjR9awAAAABJRU5ErkJggg==" src="/images/pages/admin-courses-partners-hero.webp" alt="Certification courses" fill sizes="100vw" className="object-cover" priority quality={85} />
        </div>
