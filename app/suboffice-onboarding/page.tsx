  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-48 md:h-64 overflow-hidden">
        ...
        <Image
          src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/suboffice-onboarding-page-1.webp"
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How You Get Paid</h2>
            <p className="text-xl">Understanding Revenue Share & Payment Timing</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md border-2 border-white/20 rounded-lg p-8 mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <strong>40/60 Split:</strong> Main office gets 40%, you keep 60% of base tax prep
                  fee
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <strong>Add-On Fees:</strong> Main office keeps 100% of all add-on fees (refund
                  advances, prepaid cards, etc.)
                </div>
              </div>
              <div className="flex items-start">
                <span className="text-slate-400 flex-shrink-0">•</span>
                <div>
                  <strong>Software Included:</strong> Professional tax software, training, and
                  support included - NO extra costs to you
                </div>
              </div>
              <div className="flex items-start">
                <AlertCircle className="w-6 h-6 mr-3 flex-shrink-0 mt-1 text-yellow-300" />
                <div>
                  <strong>Payment Timing:</strong> You get paid ONLY after IRS releases client
                  refunds
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/20 border-2 border-brand-red-300 rounded-lg p-6">
            <p className="text-lg">
              <strong>
                If IRS delays or offsets a refund, your payout for that client is delayed.
              </strong>{' '}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-black mb-3 text-center">Step 5: Training</h3>
              <ul className="space-y-2 text-black">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-black mb-3 text-center">Step 6: Agreements</h3>
              <ul className="space-y-2 text-black">
          ...
          <div className="space-y-6">
            <div className="bg-white border-2 border-slate-300 rounded-lg p-6">
              <label className="flex items-start cursor-pointer">
                ...
                <span className="text-black">
                  <strong>I understand revenue is shared 40/60</strong> (main office 40%, suboffice
                  60%) and payments are only made after IRS releases the refund to main office.
                </span>
              </label>
            </div>
            ...
            <div className="bg-white border-2 border-slate-300 rounded-lg p-6">
              <label className="flex items-start cursor-pointer">
                <input type="checkbox" className="mt-1 mr-4 w-5 h-5" required />
                <span className="text-black">
                  <strong>I understand all add-on fees go to main office</strong> (refund advances,
                  prepaid cards, bank products, etc.).
                </span>
              </label>
            </div>
            ...
            <div className="bg-white border-2 border-slate-300 rounded-lg p-6">
              <label className="flex items-start cursor-pointer">
                <input type="checkbox" className="mt-1 mr-4 w-5 h-5" required />
                <span className="text-black">
                  <strong>I understand software, training, and support are included</strong> with no
            ...
            <div className="bg-white border-2 border-slate-300 rounded-lg p-6">
              <label className="flex items-start cursor-pointer">
                <input type="checkbox" className="mt-1 mr-4 w-5 h-5" required />
                <span className="text-black">
                  <strong>I understand payroll/commissions cannot be run</strong> until IRS has
                  processed and released each client's refund.
                </span>
              </label>
            </div>
            ...
            <div className="bg-white border-2 border-slate-300 rounded-lg p-6">
              <label className="flex items-start cursor-pointer">
                <input type="checkbox" className="mt-1 mr-4 w-5 h-5" required />
                <span className="text-black">
                  <strong>I have downloaded and reviewed</strong> the complete payout policy and
                  billing schedule.
                </span>
              </label>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold text-black mb-2">What is a PTIN?</h3>
              <p className="text-black">
                A Preparer Tax Identification Number (PTIN) is required by the IRS for anyone who
                prepares federal tax returns for compensation. Each preparer must have their own
                PTIN.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold text-black mb-2">What is an EFIN?</h3>
              <p className="text-black">
                An Electronic Filing Identification Number (EFIN) is issued by the IRS to tax
                professionals who want to file returns electronically. Your business needs one EFIN.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold text-black mb-2">How long until I get paid?</h3>
              <p className="text-black">
                Payment is released after the IRS processes and releases the client's refund. This
                typically takes 21 days for e-filed returns with direct deposit, but can vary.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-black">
                If the IRS delays or offsets a refund, your payout for that specific client is
                delayed. This protects both parties and is standard industry practice.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-bold text-black mb-2">Can I change the revenue split?</h3>
              <p className="text-black">
                The 70/30 split is standard for all suboffices. High-volume offices may qualify for
                better terms after the first year.
              </p>
            </div>
          </div>
        </div>
