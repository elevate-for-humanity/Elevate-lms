...
{/* Hero */}
      <section className="bg-white text-white py-20">
        <div className="mx-auto max-w-6xl px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-brand-red-100 mb-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact"
                className="inline-block px-8 py-4 bg-white text-brand-red-600 rounded-lg font-bold hover:bg-brand-red-50"
              >
                Call Contact Us
              </a>
              <Link
                href="/contact"
                className="inline-block px-8 py-4 bg-brand-red-700 text-white rounded-lg font-bold hover:bg-brand-red-600 border-2 border-white"
              >
                Request Information
              </Link>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {trainingCourses.collector.map((course: any) => (
              <div
                key={course.name}
                className={`bg-white border-2 rounded-lg p-6 ${course.popular ? 'border-brand-red-500' : course.new ? 'border-blue-500' : 'border-gray-200'}`}
              >
                <div className="flex gap-2 mb-3">
                  {course.popular && (
                    <div className="bg-brand-red-500 text-white text-xs font-bold px-3 py-2 rounded-full">
                      MOST POPULAR
                    </div>
                  )}
                  {course.new && (
                ...
                <a
                  href="/contact"
                  className="block w-full text-center px-6 py-3 bg-brand-red-600 text-white rounded-lg font-bold hover:bg-brand-red-700"
                >
                  Enroll Now
                </a>
              </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl">
            {trainingCourses.supervisor.map((course: any) => (
              <div
                key={course.name}
                className={`bg-white border-2 rounded-lg p-6 ${course.popular ? 'border-brand-red-500' : 'border-gray-200'}`}
              >
                {course.popular && (
                  <div className="bg-brand-red-500 text-white text-xs font-bold px-3 py-2 rounded-full inline-block mb-3">
                    MOST POPULAR
                  </div>
                )}
                <h3 className="text-xl font-bold mb-2">{course.name}</h3>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {trainingCourses.der.map((course: any) => (
              ...
              >
                ...
                <div className="text-2xl font-bold text-brand-red-600 mb-4">
                  ${course.price}
                </div>
                <a
                  href="/contact"
                  className="block w-full text-center px-4 py-2 bg-brand-red-600 text-white rounded-lg font-bold hover:bg-brand-red-700 text-sm"
                >
                  Enroll Now
                </a>
              </div>
      ...
      <section className="py-16 bg-brand-red-50">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="bg-white border-2 border-brand-red-200 rounded-lg p-6 max-w-2xl">
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              <div className="w-10 h-10 bg-brand-red-600 text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">
                1
              </div>
              <div>
                <h3 className="text-xl font-bold mb-2">Enroll in Course</h3>
                <p className="text-black">
                  Call Contact Us to enroll. We'll set up your account and
                  provide access.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-brand-red-600 text-white">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-brand-red-600 rounded-lg font-bold hover:bg-brand-red-50"
            >
          ...
          <p className="mt-8 text-brand-red-100">
