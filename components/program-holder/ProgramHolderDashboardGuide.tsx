...
const steps = [
  ...
  { title: 'Install and connect your new phone', href: '/program-holder/phone', purpose: 'Install the Program Holder PWA, connect your assigned extension, choose Ring, Vibrate, Silent, Do Not Disturb, or Off, and set the hours when live calls should reach you.', action: 'Open Phone, install the PWA, save your mode and hours, select Connect phone, and enable missed-call alerts.' },
  { title: 'Use your office email', href: '/program-holder/email', purpose: 'Your Elevate office email address is shown at the top of Email. Send and receive official program communication from that assigned mailbox instead of a personal account.', action: 'Open Email, confirm the From address shown is your assigned office mailbox, then send a test message.' },
  ...
  { title: 'Meet and share your screen', href: '/program-holder/meetings', purpose: 'Join an Elevate meeting from your dashboard and use the meeting controls for camera, microphone, chat, and screen sharing when the room permits it.', action: 'Open Meetings and verify that your meeting room shows the screen-share control before your first live meeting.' },
