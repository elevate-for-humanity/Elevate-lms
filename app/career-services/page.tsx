        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-white">
              ...
              <p className="text-brand-red-100 text-lg mb-6">
              ...
              <Link
                ...
                className="inline-flex items-center bg-white text-brand-red-600 px-8 py-4 rounded-lg font-bold hover:bg-brand-red-50 transition"
              >
                Browse Courses
