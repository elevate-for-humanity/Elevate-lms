    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-brand-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-base md:text-lg text-slate-300">Last Updated: December 8, 2024</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Training Programs</h2>
            <p className="text-black mb-6">
              Our training programs are Funded and funded by government grants (WIOA, WRG, and other
              workforce development programs). Since there is no tuition cost to students, refunds
              do not apply to our training programs.
            </p>
            ...
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              ...
              <li>
                Provide a full refund if we make an error that results in penalties or interest
              </li>
            </ul>
            ...
            <p className="text-black mb-4">To request a refund for tax preparation services:</p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
              <li>
                <strong>Before Filing:</strong> Full refund available if you are not satisfied
                before we submit your return
              </li>
              <li>
                <strong>After Filing:</strong> Refunds considered on a case-by-case basis for errors
                or service issues
              </li>
              <li>
            ...
            <p className="text-black mb-6">
              We guarantee you will receive the maximum refund you are entitled to under the law. If
              we make an error that results in you receiving less than the maximum refund, we will:
            </p>
            <ul className="list-disc pl-6 mb-6 text-black space-y-2">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-black mb-6 mt-12">Exceptions</h2>
            <p className="text-black mb-4">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-black mb-6 mt-12">Contact Us</h2>
            <p className="text-black mb-4">For refund requests or questions about this policy:</p>
            ...
            <p className="text-black mb-8">
              ...
              on this page with an updated revision date. Your continued use of our services after
