    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-brand-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl text-slate-600">Requirements for hybrid program participation</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-10">
          <p className="text-slate-900 text-lg">
            Regular attendance is essential for successful completion of your program. Elevate for
            Humanity programs use hybrid delivery, combining online coursework with in-person
            instruction. This policy outlines attendance requirements for both components.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-white rounded-lg p-6 mb-6">
            ...
            <p className="text-slate-900 mb-4">
              Students must maintain a minimum of <strong>80% attendance</strong> in both online and
            ...
            <div className="bg-white border border-slate-200 rounded p-4">
              <p className="text-slate-900">
                ...
                least 80% of assigned modules and activities.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <p className="text-slate-900">
              Programs that require specific clock hours for certification or licensing (such as
              Barber Apprenticeship with 2,000 hours) must complete <strong>100%</strong> of
              required hours. These hours are tracked separately and reported to relevant licensing
              boards.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-slate-900">In-person attendance is documented through:</p>
              <ul className="list-disc list-inside text-slate-900 mt-2 space-y-1">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-slate-900 mt-3">
                <strong>Note:</strong> Excused absences still count toward the attendance
                calculation but may be eligible for make-up work.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-slate-900">
                Absences without prior approval or documentation are considered unexcused. Three
                consecutive unexcused absences from in-person sessions will trigger an attendance
                warning.
              </p>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-6">
            ...
            <p className="text-slate-900 mb-4">
              Students who fall behind on online coursework may request an extension by contacting
              their instructor. Extensions are granted at the instructor's discretion and typically
            ...
            <p className="text-slate-900 mt-4">
              Make-up sessions must be completed within 14 days of the original session. Contact
              your program coordinator to arrange make-up work.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <p className="text-slate-900">
                Students whose attendance falls below 85% will receive a written warning. The
                warning will include:
              </p>
              <ul className="list-disc list-inside text-slate-900 mt-2 space-y-1">
            ...
            <div className="bg-brand-orange-50 border border-brand-orange-200 rounded-lg p-6">
              ...
              <p className="text-slate-900">
                ...
                During probation, students must meet with their program coordinator to develop an
            ...
            <div className="bg-brand-red-50 border border-brand-red-200 rounded-lg p-6">
              ...
              <p className="text-slate-900 mt-3">
                Students withdrawn for non-attendance may be eligible for re-enrollment in a future
                cohort. See the{' '}
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-900 mb-4">
            ...
            circumstances may appeal attendance-related decisions through the{' '}
          ...
          <p className="text-slate-900">
            Appeals must be submitted in writing within 5 business days of receiving an attendance
            warning, probation notice, or withdrawal notification.
          </p>
        </section>
