      ...
      <section className="relative h-[280px] sm:h-[360px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center px-6">
          <div className="max-w-6xl mx-auto w-full">
            <p className="text-brand-red-400 font-bold text-xs uppercase tracking-widest mb-2">
              Founder &amp; CEO
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            ...
            <div>
              ...
              <div className="text-slate-800 space-y-4 text-[16px] leading-relaxed">
                ...
                <p>
                  Elizabeth is a nationally authorized EPA Section 608 proctor through both the ESCO
                  Group (Proctor ID: 358010) and Mainstream Engineering — one of the few training
                  providers in Indiana authorized by both certifying bodies. She also operates a
                  Certiport Authorized Testing Center (CATC) for Microsoft Office Specialist, IC3,
                  and IT Specialist credentials.
                </p>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/programs"
                  className="inline-flex items-center bg-brand-red-600 text-white px-6 py-3 rounded-full font-bold hover:bg-brand-red-700 transition"
                >
                  Explore Programs <ArrowRight className="w-4 h-4 ml-2" />
                </Link>
                <Link
                  href="/contact"
                  className="inline-flex items-center border-2 border-slate-300 text-slate-700 px-6 py-3 rounded-full font-bold hover:border-slate-400 transition"
                >
                  Schedule a Meeting
                </Link>
              </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={org.name} className="border border-slate-200 rounded-xl p-6">
                <p className="text-xs font-semibold text-brand-red-600 uppercase tracking-wider">
                  {org.role}
                </p>
                ...
                {org.href && (
                  <Link
                    href={org.href}
                    className="inline-flex items-center gap-1 text-brand-red-600 text-sm font-semibold mt-3 hover:underline"
                  >
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-slate-600 text-lg mb-8">
            Explore funded training programs or apply today.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/programs"
              className="inline-flex items-center bg-white text-slate-900 px-8 py-4 rounded-full font-bold text-lg hover:bg-white transition"
            >
              Explore Programs
            </Link>
            <Link
