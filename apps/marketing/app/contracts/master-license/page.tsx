  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[{ label: 'Contracts', href: '/contracts' }, { label: 'Master License' }]}
        />
      </div>
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border">
          ...
          <div className="p-8 prose max-w-none">
            ...
            <ul>
              <li>
                <strong>Starter:</strong> $500/month up to 50 students
              </li>
              <li>
                <strong>Professional:</strong> $1,500/month up to 200 students
              </li>
              <li>
                <strong>Enterprise:</strong> Custom pricing for unlimited students
              </li>
            </ul>
            <h2>4. Intellectual Property</h2>
            <p>
              All curriculum, platform code, and materials remain the property of Elevate for
              Humanity. Licensee may not modify, redistribute, or create derivative works.
            </p>
            <h2>5. Support and Updates</h2>
            <p>
              License includes access to platform updates, bug fixes, and standard support during
              business hours.
            </p>
            <h2>6. Term and Termination</h2>
            <p>
              Initial term of 12 months with automatic annual renewal. Either party may terminate
