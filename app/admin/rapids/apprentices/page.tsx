...
const STATUS_COLORS: Record<string, string> = {
  ...
  completed: 'bg-brand-red-100 text-brand-red-800',
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={exporting}
                  className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-brand-red-600 text-white text-sm rounded-lg hover:bg-brand-red-700 disabled:opacity-50"
                >
                  <Download className="w-4 h-4" />
                  CSV
                </button>
