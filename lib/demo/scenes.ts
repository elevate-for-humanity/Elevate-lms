...
export const ADMIN_SCENES: DemoScene[] = [
    ...
    choices: [
      {
        ...
        description: 'See how students apply and get approved',
        nextScene: 'admin-applications',
        variant: 'primary',
      },
      {
        label: 'WIOA Compliance',
        description: 'Automated eligibility and PIRL reporting',
        nextScene: 'admin-compliance',
        variant: 'primary',
      },
      {
        label: 'Funding & Outcomes',
        description: 'Track funding utilization and placements',
        nextScene: 'admin-funding',
        variant: 'secondary',
      },
      {
        label: 'Analytics',
        description: 'Enrollment trends and at-risk alerts',
        nextScene: 'admin-analytics',
        variant: 'secondary',
      },
    ],
  ...
  },
  {
    ...
    choices: [
      {
        label: 'WIOA Compliance',
        description: 'See automated eligibility screening',
        nextScene: 'admin-compliance',
        variant: 'primary',
      },
      {
        label: 'Student Enrollment',
        description: 'What students see after approval',
        nextScene: 'admin-enrollment',
        variant: 'secondary',
      },
    ],
    exitCta: { label: 'Start your free trial', href: '/store/trial' },
    ...
    choices: [
      {
        ...
        description: 'ITA tracking and funding allocation',
        nextScene: 'admin-funding',
        variant: 'primary',
      },
      {
        label: 'Analytics',
        description: 'Outcomes and placement metrics',
        nextScene: 'admin-analytics',
        variant: 'secondary',
      },
    ],
    ...
    choices: [
      {
        ...
        description: 'Completion rates and placement data',
        nextScene: 'admin-analytics',
        variant: 'primary',
      },
      {
        label: 'Employer Portal',
        description: 'See what your hiring partners see',
        nextScene: 'admin-employers',
        variant: 'secondary',
      },
    ],
    exitCta: { label: 'Start your free trial', href: '/store/trial' },
  },
  {
    ...
    choices: [
      {
        label: 'Employer Portal',
        description: 'See the employer-facing view',
        nextScene: 'admin-employers',
        variant: 'primary',
      },
      {
        label: 'Student Portal',
        description: 'See what your students experience',
        nextScene: 'admin-enrollment',
        variant: 'secondary',
      },
    ],
  ...
  },
  {
    ...
    choices: [
      ...
      {
        label: 'Start Over',
        description: 'Back to the admin overview',
        nextScene: 'admin-overview',
        variant: 'secondary',
      },
    ],
    exitCta: { label: 'Start your free trial', href: '/store/trial' },
...
export const EMPLOYER_SCENES: DemoScene[] = [
    ...
    choices: [
      {
        ...
        description: 'Search verified graduates by credential',
        nextScene: 'employer-candidates',
        variant: 'primary',
      },
      {
        label: 'Apprenticeship Hours',
        description: 'Approve hours and track wage progression',
        nextScene: 'employer-apprenticeships',
        variant: 'primary',
      },
      {
        label: 'Hiring Incentives',
        description: 'WOTC credits and OJT reimbursement',
        nextScene: 'employer-incentives',
        variant: 'secondary',
      },
    ],
  ...
  },
  {
    ...
    choices: [
      {
        label: 'Apprenticeship Hours',
        description: 'Track and approve OJT hours',
        nextScene: 'employer-apprenticeships',
        variant: 'primary',
      },
      {
        label: 'Hiring Incentives',
        description: 'WOTC and OJT reimbursement details',
        nextScene: 'employer-incentives',
        variant: 'secondary',
      },
    ],
  ...
  },
  {
    ...
    choices: [
      {
        label: 'Hiring Incentives',
        description: 'WOTC credits and reimbursement',
        nextScene: 'employer-incentives',
        variant: 'primary',
      },
      {
        label: 'Start Over',
        description: 'Back to employer overview',
        nextScene: 'employer-overview',
        variant: 'secondary',
      },
    ],
    exitCta: { label: 'Become an employer partner', href: '/apply/employer' },
...
export const STUDENT_SCENES: DemoScene[] = [
  {
    ...
    choices: [
      {
        label: 'My Courses',
        description: 'Video lessons, quizzes, and progress',
        nextScene: 'student-courses',
        variant: 'primary',
      },
      {
        label: 'Log Hours',
        description: 'Submit apprenticeship hours for approval',
        nextScene: 'student-hours',
        variant: 'primary',
      },
      {
        label: 'My Credentials',
        description: 'Download and share your certificates',
        nextScene: 'student-credentials',
        variant: 'secondary',
      },
    ],
  ...
  },
  {
    ...
    choices: [
      {
        label: 'Log Hours',
        description: 'Submit OJT hours from your phone',
        nextScene: 'student-hours',
        variant: 'primary',
      },
      {
        label: 'My Credentials',
        description: 'Certificates earned so far',
        nextScene: 'student-credentials',
        variant: 'secondary',
      },
    ],
  ...
  },
  {
    ...
    choices: [
      {
        label: 'My Credentials',
        description: 'Download and share certificates',
        nextScene: 'student-credentials',
        variant: 'primary',
      },
      {
        label: 'Start Over',
        description: 'Back to student overview',
        nextScene: 'student-overview',
        variant: 'secondary',
      },
    ],
    exitCta: { label: 'Apply for training', href: '/apply/student' },
