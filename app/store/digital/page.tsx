...
{/* Hero */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight mb-6">
                Digital Resources
                <span className="block text-brand-red-300">For Training Providers</span>
              </h1>
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4">
              <div className="space-y-4">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  <Sparkles className="w-10 h-10 text-brand-red-400 mb-3" />
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-12">
            <Building2 className="w-8 h-8 text-brand-red-600" />
            ...
            {platformTools.map((product) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2 text-brand-red-600 font-semibold">
                    Learn More <ArrowRight className="w-4 h-4" />
                  </div>
                </div>
              </Link>
