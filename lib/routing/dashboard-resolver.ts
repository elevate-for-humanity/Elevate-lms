...
const ROLE_MAPPINGS: RoleMapping[] = [
  ...
  // Admin app pathnames do NOT include an /admin prefix on admin.elevateforhumanity.org.
  ...
  // Exact apprentice program portals are resolved by resolveStudentHomePath at login.
  ...
  { role: 'partner', label: 'Partner', dashboardUrl: `${LMS_HOST}/partner/dashboard`, portalKey: 'partner' },
