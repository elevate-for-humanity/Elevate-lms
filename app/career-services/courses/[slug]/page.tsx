        ...
        <div className="max-w-7xl mx-auto px-4 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-brand-red-200 mb-6">{course.subtitle}</p>
              ...
              <div className="flex flex-col gap-2">
                ...
                {Number(course.price) >= 35 && Number(course.price) <= 2500 && (
                  <div className="sezzle-hero-widget text-brand-red-200" />
                )}
              </div>
            </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                  <div className="w-20 h-20 bg-white/90 rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition">
                    <Play className="w-8 h-8 text-brand-red-600 ml-1" fill="currentColor" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-brand-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <MessageSquare className="w-8 h-8 text-brand-red-600" />
              </div>
        ...
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="inline-flex items-center justify-center bg-white text-brand-red-600 px-8 py-4 rounded-lg font-bold hover:bg-brand-red-50 transition"
            >
