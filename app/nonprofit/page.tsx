  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            <Link
              ...
              className="inline-block bg-brand-red-600 text-white px-10 py-4 rounded-lg text-lg font-bold hover:bg-brand-red-700 transition-colors shadow-lg"
            >
              Donate
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {displayServices.map((service: any, index: number) => {
              ...
              return (
                ...
                >
                  <IconComponent className="w-12 h-12 text-brand-red-600 mb-4 group-hover:scale-110 transition" />
      ...
      {workshops && workshops.length > 0 && (
        <section className="py-16 px-4 bg-brand-red-50">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {workshops.map((workshop: any) => (
                <div key={workshop.id} className="bg-white rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-2 text-brand-red-600 mb-3">
            ...
            <div className="text-center mt-8">
              <Link
                href="/nonprofit/workshops"
                className="inline-block bg-brand-red-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-brand-red-700 transition"
              >
                View All Workshops
              </Link>
            </div>
      ...
      <section className="py-16 px-4 bg-brand-red-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/nonprofit/donations"
              className="bg-white text-brand-red-600 px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition"
            >
              Donate Now
            </Link>
            <Link
              href="/nonprofit/sign-up"
              className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold hover:bg-brand-red-700 transition"
            >
              Sign Up for Updates
            </Link>
          </div>
