...
function DocumentUploadForm() {
  ...
  if (!requirement)
    return (
      <div
        role="alert"
        className="mx-auto max-w-xl rounded-2xl border border-red-300 bg-red-50 p-6"
      >
  ...
  return (
    <div className="mx-auto max-w-xl">
      ...
      <p className="mt-2 text-slate-700">
        PDF, JPG, PNG, or WebP · maximum 10 MB. Submitted documents remain pending until staff
        review.
      </p>
...
export default function DocumentUploadPage() {
  return (
    <Suspense
      fallback={<div className="mx-auto max-w-xl p-6 text-slate-700">Loading document upload…</div>}
    >
      <DocumentUploadForm />
    </Suspense>
  );
