      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 sm:space-y-12">
            ...
            <div className="bg-brand-red-50 border border-brand-red-200 rounded-xl p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-red-100 rounded-lg flex items-center justify-center">
                  <Building2 className="w-5 h-5 sm:w-6 sm:h-6 text-brand-red-600" />
                </div>
                <div>
                  <p className="text-xs sm:text-sm font-medium text-brand-red-600">Funding Pathway 2</p>
