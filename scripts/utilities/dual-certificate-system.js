...
class DualCertificateSystem {
  ...
  initializeTemplates() {
    return {
      elevate_for_humanity: {
        ...
        logo_url: 'https://www.elevateforhumanity.org/assets/logo-certificate.png',
        signature_image:
          'https://www.elevateforhumanity.org/assets/signature-ceo.png',
  ...
  async generateElevateCertificate(enrollmentData, completionData) {
    ...
    const certificateData = {
      ...
      // Verification
      verification: {
        url: `https://www.elevateforhumanity.org/verify/${certificateId}`,
        qr_code: `https://www.elevateforhumanity.org/qr/${certificateId}`,
  ...
  async renderCertificate(certificateData, templateType) {
    ...
    const files = {
      html: {
        content: htmlContent,
        url: `https://www.elevateforhumanity.org/certificates/${certificateData.id}/certificate.html`,
        filename: `${certificateData.id}_certificate.html`,
      },
      pdf: {
        buffer: pdfBuffer,
        url: `https://www.elevateforhumanity.org/certificates/${certificateData.id}/certificate.pdf`,
        filename: `${certificateData.id}_certificate.pdf`,
      },
      thumbnail: {
        url: `https://www.elevateforhumanity.org/certificates/${certificateData.id}/thumbnail.jpg`,
...
#ProfessionalDevelopment #Certification #CareerGrowth #ElevateForHumanity`;
  ...
  generateAppleWalletPass(certificate) {
    ...
    return {
      url: `https://www.elevateforhumanity.org/wallet/apple/${certificate.id}`,
    };
  }
  ...
  generateGoogleWalletPass(certificate) {
    ...
    return {
      url: `https://www.elevateforhumanity.org/wallet/google/${certificate.id}`,
    };
  }
}
