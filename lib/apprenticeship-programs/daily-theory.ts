import {
  ...
  type ApprenticeshipProgramSlug,
...
export function isApprenticeshipProgram(slug: string | null | undefined): slug is ApprenticeshipProgramSlug {
  return !!slug && isApprenticeshipProgramSlug(slug);
}
