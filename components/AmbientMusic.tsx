...
/**
 * Soft ambient background audio for pages that explicitly provide a valid source.
 * The component intentionally has no built-in media path so a missing asset can
 * never be requested implicitly in production.
 */
export default function AmbientMusic({
  ...
  useEffect(() => {
    ...
    const handleInteraction = () => {
      if (!hasInteracted && audioRef.current) startMusic();
    };
