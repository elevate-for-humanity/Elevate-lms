      ...
      <div className="p-8 max-w-7xl mx-auto">
        ...
        <div className="mt-8 border-t border-slate-100 pt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link href="/program-holders" className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 hover:shadow-md transition-shadow group">
              <div>
            ...
            <Link href="/program-holder-documents" className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 hover:shadow-md transition-shadow group">
              <div>
            ...
            <Link href="/studio" className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 hover:shadow-md transition-shadow group">
              <div>
            ...
            <Link href="/programs/catalog" className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 hover:shadow-md transition-shadow group">
              <div>
            ...
            <Link href="/enrollments" className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 hover:shadow-md transition-shadow group">
              <div>
