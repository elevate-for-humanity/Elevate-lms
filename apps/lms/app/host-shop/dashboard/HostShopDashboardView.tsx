...
export default async function HostShopDashboardView() {
  ...
  const summaryCards: PortalCard[] = [
    ...
    { href: '/host-shop/dashboard/competencies', title: 'Registered standards', value: competencyValue, detail: competencyDetail, image: '/images/pages/workforce-board-page-7.webp' },
  ...
  const toolCards: PortalCard[] = [
    { href: '/host-shop/orientation', title: 'Required orientation', detail: 'Review recruiting, payroll, WIOA, geofencing, work approval, competencies, transfer-credit rules, RAPIDS, and compliance.', image: '/images/pages/training-classroom.webp' },
