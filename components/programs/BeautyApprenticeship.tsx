...
const PROGRAM_DATA = {
  ...
  esthetics: {
    ...
    heroVideo: 'https://pub-23811be4d3844e45a8bc2d3dc5e7aaec.r2.dev/videos/esthetics-hero.mp4',
...
const SUCCESS_STORIES = [
  {
    ...
    transformation: '/images/beauty/barber-hero.webp',
  },
  {
    name: 'Marcus L.',
    program: 'Cosmetology',
    ...
    transformation: '/images/beauty/cosmetology-hero.webp',
  },
  {
    name: 'Sophia K.',
    program: 'Esthetics',
    ...
    transformation: '/images/beauty/esthetics-hero.webp',
  },
];
...
const ICONS = {
  ...
  salon: '/images/icons/salon.svg',
  scissors: '/images/icons/scissors.svg',
};
