...
// These legacy catalog entries do not yet have a verified protected download,
 // streaming, inventory, shipping, or post-purchase delivery contract. Keep
 // them visible for catalog review, but fail closed until fulfillment exists.
 // A product may be made purchasable only after its delivery path is tested.
