  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <section className="px-4 pt-6 md:px-8 md:pt-8">
        <div className="mx-auto max-w-5xl rounded-2xl bg-slate-900 p-6 text-white md:p-8">
          <div className="flex items-center gap-2 text-sm font-bold text-blue-200"><BriefcaseBusiness className="h-4 w-4" />Career Opportunities</div>
          <h1 className="mt-3 text-3xl font-black md:text-4xl">Move from training into employment.</h1>
          <p className="mt-3 max-w-3xl text-slate-300">Browse current employer opportunities connected to Elevate's workforce ecosystem. Your training, credentials, and career support remain in the same platform.</p>
