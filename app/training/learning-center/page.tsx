...
const RESOURCES = [
  {
    ...
    desc: 'Step-by-step video lessons covering key concepts in your program area.',
    icon: Video,
  },
  {
    title: 'Study Guides',
    desc: 'Downloadable study guides and reference sheets for certification exam preparation.',
    icon: FileText,
  },
  {
    title: 'Practice Exams',
    desc: 'Timed practice tests that simulate the format and difficulty of your certification exam.',
    icon: Monitor,
  },
  {
    title: 'Course Materials',
    desc: 'Textbook chapters, lecture notes, and supplemental readings organized by program.',
    icon: BookOpen,
  },
  {
    title: 'Audio Resources',
    desc: 'Podcast-style lessons and audio study aids for learning on the go.',
    icon: Headphones,
  },
  {
    title: 'Downloadable Forms',
    desc: 'Enrollment forms, funding applications, and program-specific documents.',
    icon: Download,
  },
];
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[{ label: 'Training', href: '/training' }, { label: 'Learning Center' }]}
        />
      </div>
      ...
      <section className="relative w-full">
        ...
        {/* IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback) */}
          <Image
            src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/training-page-2.webp"
        ...
        <div className="bg-white py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Study materials, practice exams, and resources to support your training.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-600 mb-6">
            Full access to learning center resources is available through your student portal after
            enrollment. Log in to access your program-specific materials.
          </p>
