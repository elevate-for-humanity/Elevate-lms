...
<div className="bg-gray-50 border-b">
      ...
      <section className="relative h-[350px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-brand-red-100">Build connections that advance your career</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-brand-red-50 rounded-xl p-6 text-center">
              <Briefcase className="w-12 h-12 text-brand-red-600 mx-auto mb-4" />
            ...
            <div className="bg-brand-red-50 rounded-xl p-6 text-center">
              <MessageSquare className="w-12 h-12 text-brand-red-600 mx-auto mb-4" />
            ...
            <div className="bg-brand-red-50 rounded-xl p-6 text-center">
              <Globe className="w-12 h-12 text-brand-red-600 mx-auto mb-4" />
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="bg-white rounded-lg p-4 flex items-center shadow-sm">
                <Circle className="w-5 h-5 text-brand-red-600 mr-3 flex-shrink-0" />
      ...
      <section className="py-16 bg-brand-red-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-brand-red-100 mb-8">Get guidance on building meaningful professional connections.</p>
          <Link href="/apply" className="bg-white hover:bg-gray-100 text-brand-red-700 px-8 py-4 rounded-lg text-lg font-bold transition inline-flex items-center">
