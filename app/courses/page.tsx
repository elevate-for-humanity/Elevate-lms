  ...
  return (
    <div className="bg-white">
      ...
      <section id="micro-classes" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-red-100 text-brand-red-800 rounded-full text-sm font-bold mb-4">
              <Clock className="w-4 h-4" />
            ...
            {microClasses.map((course) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-200">
                  ...
                  <Link
                    href="/apply"
                    className="text-brand-red-600 font-semibold text-sm hover:text-brand-red-700"
                  >
                    Enroll Now →
                  </Link>
                </div>
          ...
          <div className="text-center mt-10">
            <Link
              href="/apply"
              className="inline-flex items-center gap-2 bg-brand-red-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-brand-red-700 transition-all"
            >
