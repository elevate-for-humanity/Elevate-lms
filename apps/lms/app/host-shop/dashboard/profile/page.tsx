...
export default async function HostShopProfilePage() {
  ...
  return (
    <main className="mx-auto w-full min-w-0 max-w-6xl overflow-x-hidden px-4 py-8 sm:px-6">
