  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <h3 className="text-base sm:text-lg font-bold text-black mb-3 sm:mb-4 flex items-center gap-2">
            <Building2 className="h-4 w-4 sm:h-5 sm:w-5 text-brand-red-600" />
            Partner & Hybrid Enrollments
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            <div className="bg-brand-red-50 rounded-lg shadow-sm border border-brand-red-200 p-4 sm:p-6">
              <div className="text-2xl sm:text-3xl font-bold text-brand-red-900 mb-1 sm:mb-2">
                {partnerEnrollmentsTotal || 0}
              </div>
              <div className="text-xs sm:text-sm text-brand-red-900">Partner Total</div>
            </div>
            <div className="bg-brand-red-50 rounded-lg shadow-sm border border-brand-red-600 p-4 sm:p-6">
              <div className="text-2xl sm:text-3xl font-bold text-brand-red-900 mb-1 sm:mb-2">
                {partnerEnrollmentsActive || 0}
              </div>
              <div className="text-xs sm:text-sm text-brand-red-900">Partner Active</div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <div className="p-3">
              ...
              <span className="inline-flex items-center gap-1 text-brand-red-600 font-medium text-sm mt-1 group-hover:gap-2 transition-all">
                Open <ArrowRight className="w-4 h-4" />
              </span>
            </div>
          </Link>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
            <Link
              ...
              className="p-3 bg-brand-red-50 border border-brand-red-200 rounded-lg hover:border-brand-red-500 hover:shadow text-sm font-medium text-brand-red-900"
            >
              Promo Codes
            </Link>
            <Link
