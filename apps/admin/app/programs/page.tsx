      ...
      <div className="mx-auto max-w-7xl p-8">
        ...
        <div className="mt-8 border-t border-slate-100 pt-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Link href="/course-builder" className="group flex items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 transition-shadow hover:shadow-md"><div><p className="text-sm font-semibold text-slate-900">Program Builder</p><p className="mt-0.5 text-xs text-slate-500">Blueprint-driven course scaffolding</p></div><span className="text-slate-300 transition-colors group-hover:text-slate-600">→</span></Link>
            ...
            <Link href="/course-builder" className="group flex items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 transition-shadow hover:shadow-md"><div><p className="text-sm font-semibold text-slate-900">Curriculum</p><p className="mt-0.5 text-xs text-slate-500">Lessons, modules, assessments and media</p></div><span className="text-slate-300 transition-colors group-hover:text-slate-600">→</span></Link>
