-- Preserve standalone draft-course creation while keeping one atomic Course Factory writer.
-- program_id remains nullable on courses; program-linked builds still pass the canonical program id.
...
is 'Atomic canonical Course Factory persistence for program-linked or standalone draft courses.';
