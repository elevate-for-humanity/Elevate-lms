...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: 'Testing Center Operations', href: 'https://admin.elevateforhumanity.org/testing-center', isSectionLink: true, isAuth: true },
      { name: 'Creator Studio', href: 'https://app.elevateforhumanity.org/creator/products', isSectionLink: true, isAuth: true },
