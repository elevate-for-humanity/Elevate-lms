    ...
    <main className="min-h-screen">
      <section className="relative bg-brand-blue-900 text-white py-20">
        <div className="absolute inset-0 opacity-20">
          <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/programs-emergency-health-safety-hero.webp" alt="Health and Safety Institute testing" fill className="object-cover" sizes="100vw" />
        </div>
