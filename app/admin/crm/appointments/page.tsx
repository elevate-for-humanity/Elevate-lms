            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="px-4 py-2 bg-brand-red-100 text-brand-red-700 rounded-lg font-medium">
                    Today
                  </button>
                  <button className="p-2 hover:bg-gray-100 rounded-lg">
                  ...
                  return (
                    <div
                      ...
                      className={`aspect-square p-2 rounded-lg ${
                        isToday ? 'bg-brand-red-600 text-white' :
                    ...
                    >
                      ...
                      {hasAppointment && isCurrentMonth && !isToday && (
                        <div className="w-1.5 h-1.5 bg-brand-red-600 rounded-full mx-auto mt-1" />
                      )}
                    </div>
                  );
                })}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                {appointments.map((apt) => (
                  <div key={apt.id} className="p-4 border rounded-xl hover:border-brand-red-300 transition">
                    ...
                    <div className="mt-3 flex gap-2">
                      <button className="flex-1 px-3 py-2 bg-brand-red-600 text-white text-sm rounded-lg hover:bg-brand-red-700 transition">
