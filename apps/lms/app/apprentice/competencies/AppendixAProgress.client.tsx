...
type RecordRow = { competency_id: string; completed: boolean; date_completed: string | null; verified_by_name: string | null; notes: string | null };
type Standard = {
