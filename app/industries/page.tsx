  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ModernLandingHero
        ...
        imageSrc="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/workforce-training.webp"
            ...
            {industries.map((industry) => {
              ...
              return (
                <Link
                  key={industry.id}
                  href={industry.href}
                  className="group bg-white border-2 border-slate-200 rounded-2xl p-8 hover:border-brand-blue-500 hover:shadow-xl transition-all"
                >
