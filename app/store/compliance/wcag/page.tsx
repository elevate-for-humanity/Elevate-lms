...
{/* Avatar Guide */}
            ...
            {features.map((feature) => (
              <div key={feature.title} className="bg-white rounded-2xl overflow-hidden border-2 border-slate-200 hover:border-brand-blue-500 hover:shadow-xl transition-all group">
                <div className="relative h-48 overflow-hidden">
                  {feature.image && <Image src={feature.image} alt={feature.title} fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover group-hover:scale-105 transition-transform duration-300"   />}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={plan.name} className={`bg-white rounded-2xl p-8 border-2 ${plan.popular ? 'border-brand-blue-500 shadow-xl' : 'border-slate-200'}`}>
      ...
      <section className="py-16 bg-brand-blue-700 text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-8">See our accessibility tools in action with an on-demand product walkthrough.</p>
