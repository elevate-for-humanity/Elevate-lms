  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-48 md:h-64 overflow-hidden">
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/community-page-2.webp" alt="Join the Elevate Community" fill className="object-cover" priority sizes="100vw" />
      </section>
