    ...
    <div className="bg-white min-h-screen print:bg-white">
      ...
      <div className="print:hidden">
        <HeroVideo
          ...
          posterImage="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/apprenticeship-structure.webp"
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                entity: 'State-Approved / Licensed Training Institutions',
                icon: GraduationCap,
                scope:
              ...
              {
                level: 3,
                role: 'Program Holders (RTI Coordinators)',
                entity: 'Authorized Curriculum Managers',
                icon: FileCheck,
                scope:
              ...
              },
              {
                ...
                entity: 'Credentialed Industry Professionals',
                icon: Award,
                scope:
              ...
              {
                level: 5,
                role: 'Employer Partners (OJT Providers)',
                entity: 'Approved Employers',
                icon: Building2,
                scope:
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg p-6 border print:bg-white">
            <p className="text-sm text-slate-700 leading-relaxed mb-4">
              ...
              supplemental instruction, mentoring, and supervised module support. All RTI is tracked
              through the institutional LMS under centralized program oversight.
            </p>
            ...
            {[
              {
                ...
                desc: 'Documented hour breakdown by skill area, aligned to occupation, filed with apprenticeship registration.',
              },
              {
                title: 'Supervisor Designation',
                desc: 'Named workplace supervisor for each apprentice/trainee. Responsible for hour verification and skill sign-off.',
              },
              {
                title: 'Wage Progression',
                desc: 'Registered apprenticeship programs include wage increases tied to skill milestones. Documented in apprenticeship record.',
              },
              {
                title: 'Periodic Evaluations',
                desc: 'Monthly or quarterly evaluations covering attendance, skill development, workplace conduct, and advancement readiness.',
              },
            ].map((item, i) => (
      ...
      <section className="py-10 print: print:border-t">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              {
                label: 'RTI Attendance',
                desc: 'Automated tracking of classroom, online, and lab attendance hours',
              },
              {
                label: 'Module Completion',
                desc: 'Structured modules with completion thresholds and timestamps',
              },
              {
                label: 'Assessments',
                desc: 'Competency exams, quizzes, and skill evaluations with scored records',
              },
              {
                label: 'Instructor Verification',
                desc: 'Instructor sign-off on attendance, skill evaluations, and phase advancement',
              },
              {
                label: 'OJT Hour Logging',
                desc: 'Employer-submitted OJT hours with supervisor verification',
              },
              {
                label: 'Cohort Progress Reports',
                desc: 'Structured reports for workforce partners (WorkOne, community organizations, etc.)',
              },
            ].map((item, i) => (
