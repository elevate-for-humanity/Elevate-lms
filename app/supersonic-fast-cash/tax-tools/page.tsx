      ...
      <section id="tax-form" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-2xl font-black text-brand-red-600">
                  Form 1099
                </h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 p-4 bg-brand-red-50 rounded-xl">
                  <div className="flex-shrink-0 w-20 text-center">
                    <div className="text-3xl font-black text-brand-red-600">
                      APR
                    </div>
                    <div className="text-2xl font-black text-brand-red-600">
                      15
                    </div>
                  </div>
                  <div>
