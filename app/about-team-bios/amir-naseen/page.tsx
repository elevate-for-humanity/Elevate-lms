...
export const metadata: Metadata = {
  title: 'Amir Naseen | Our Team | {PLATFORM_DEFAULTS.orgName}',
  description: 'Amir Naseen — Credit Repair Specialist at {PLATFORM_DEFAULTS.orgName} Career & Technical Institute.',
};
