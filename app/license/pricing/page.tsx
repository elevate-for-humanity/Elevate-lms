...
export const metadata: Metadata = {
  ...
  description:
    'Platform licensing pricing for the Elevate LMS. Core Platform $4,999, School License $15,000, Enterprise $50,000. Monthly option available.',
  alternates: {
    ...
    <div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Self-operating workforce infrastructure. Choose the license that fits your
            ...
            {displayTiers.map((tier: any, index: number) => (
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <span className={tier.featured ? 'text-white' : 'text-slate-500'}>/year</span>
                </div>
                ...
                <ul className="space-y-3 mb-8">
                  {tier.features?.map((feature: string, i: number) => (
                    <li key={i} className="flex items-start gap-2">
                      <span
                        className={`flex-shrink-0 ${tier.featured ? 'text-white' : 'text-slate-400'}`}
                      >
                        •
                      </span>
      ...
      <section className="py-16 bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-300 mb-8">Schedule a demo to see the platform in action.</p>
