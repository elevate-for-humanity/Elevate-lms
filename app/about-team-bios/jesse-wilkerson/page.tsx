...
export const metadata: Metadata = {
  title: 'Jesse J. Wilkerson | Our Team | {PLATFORM_DEFAULTS.orgName}',
  description: 'Jesse J. Wilkerson — Principal — Architecture & Design-Build at {PLATFORM_DEFAULTS.orgName} Career & Technical Institute.',
};
          ...
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            <div className="lg:col-span-2">
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/team/jesse-wilkerson.jpg"
