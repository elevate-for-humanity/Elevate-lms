      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <p className="text-3xl font-bold text-brand-red-600">${totalGrantsAwarded.toLocaleString()}</p>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/admin/wotc" className="text-sm text-brand-red-600 hover:text-brand-red-700">
                View All
              </Link>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/admin/grants" className="text-sm text-brand-red-600 hover:text-brand-red-700">
                View All
              </Link>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/grants/new" className="text-sm text-brand-red-600 hover:text-brand-red-700">
              Add New
            </Link>
          </div>
