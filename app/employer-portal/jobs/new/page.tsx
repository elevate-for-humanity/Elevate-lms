...
<div className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link href="/employer-portal/jobs" className="flex items-center gap-2 text-gray-600 hover:text-brand-red-600 mb-4">
        ...
        <form className="space-y-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-brand-red-500 focus:border-transparent"
                />
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select className="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-brand-red-500 focus:border-transparent">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-brand-red-500 focus:border-transparent"
                    />
                  </div>
                </div>
                <div>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-3 gap-3">
                  {['Health Insurance', 'Dental Insurance', 'Vision Insurance', '401(k)', 'Paid Time Off', 'Training Provided', 'Tuition Assistance', 'Flexible Schedule', 'Career Growth'].map((benefit) => (
                    <label key={benefit} className="flex items-center gap-2 p-3 border rounded-lg cursor-pointer hover:border-brand-red-300">
                      <input type="checkbox" className="w-4 h-4 text-brand-red-600 rounded" />
          ...
          <div className="bg-brand-red-50 rounded-xl p-6 border border-brand-red-200">
            ...
            <div className="grid md:grid-cols-2 gap-3">
              {[
                ...
                <label key={group} className="flex items-center gap-2 p-3 bg-white border rounded-lg cursor-pointer hover:border-brand-red-300">
                  <input type="checkbox" defaultChecked className="w-4 h-4 text-brand-red-600 rounded" />
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-4">
              <button type="button" className="px-6 py-3 border border-brand-red-600 text-brand-red-600 rounded-lg hover:bg-brand-red-50 transition flex items-center gap-2">
                <Eye className="w-4 h-4" />
                Preview
              </button>
              <button type="submit" className="px-8 py-3 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700 transition font-semibold">
                Post Job
              </button>
            </div>
          </div>
