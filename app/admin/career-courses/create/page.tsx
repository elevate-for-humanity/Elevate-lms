  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Loader2 className="w-8 h-8 animate-spin text-brand-red-600" />
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className="flex items-center gap-1 text-sm text-brand-red-600">
                      ...
                      <button
                        ...
                        className={`w-full text-left p-3 rounded-lg transition ${
                          selectedCourse?.id === course.id
                            ? 'bg-brand-red-100 border-brand-red-300 border'
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 bg-brand-red-600 text-white rounded-full flex items-center justify-center font-bold">
                      1
                    </div>
                  ...
                  <div className="mb-4">
                    <button
                      ...
                      disabled={generating}
                      className="inline-flex items-center gap-2 bg-brand-red-600 text-white px-4 py-2 rounded-lg hover:bg-brand-red-700 disabled:bg-gray-400"
                    >
                      {generating ? (
                  ...
                  <textarea
                    ...
                    rows={12}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-500 focus:border-transparent font-mono text-sm"
                  />
                  ...
                  <div className="flex justify-between mt-4">
                    ...
                    <button
                      onClick={saveScript}
                      className="inline-flex items-center gap-2 text-brand-red-600 hover:text-brand-red-700 font-medium"
                    >
                ...
                <div className="bg-white rounded-xl shadow-sm border p-6">
                  ...
                  <button
                    ...
                    className="w-full bg-brand-red-600 text-white py-4 rounded-lg font-semibold hover:bg-brand-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {generating ? (
                      <>
