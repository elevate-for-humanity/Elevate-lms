      ...
      <div className="bg-white border-b border-slate-100 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-black text-base sm:text-lg max-w-2xl leading-relaxed mb-6">
            Hire and train workers with up to 50% wage reimbursement, WOTC tax credits, and
            Registered Apprenticeship sponsorship — all coordinated through Elevate.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-black text-sm leading-relaxed mb-6">
                Contact us to learn which incentives your business qualifies for and how to set up
                an OJT or apprenticeship agreement.
              </p>
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/testing/book?type=group-testing"
