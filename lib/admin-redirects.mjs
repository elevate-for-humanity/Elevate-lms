...
export const adminRedirects = [
  ...
  // ── PROGRAMS ────────────────────────────────────────────────────────────
  r('/admin/course-builder', '/studio/courses'),
  r('/admin/course-builder/assessments', '/studio/courses'),
  r('/admin/course-builder/media', '/studio/courses'),
  r('/admin/course-builder/templates', '/studio/courses'),
  r('/admin/courses/builder', '/studio/courses'),
  r('/admin/courses/manage', '/admin/courses'),
  r('/admin/course-generator', '/studio/courses'),
  r('/admin/course-templates', '/admin/courses'),
  r('/admin/curriculum', '/admin/courses'),
  r('/admin/curriculum/upload', '/admin/courses'),
  r('/admin/quiz-builder', '/studio/courses'),
  r('/admin/quizzes', '/studio/courses'),
