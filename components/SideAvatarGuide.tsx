...
export default function SideAvatarGuide({
  ...
  return (
    ...
    >
      ...
      {isExpanded && (
        <div
          className={`bg-white shadow-2xl border border-slate-200 h-[600px] flex flex-col overflow-hidden ${side === 'right' ? 'rounded-l-2xl' : 'rounded-r-2xl'}`}
        >
                ...
                <div
                  className={`max-w-5/6 px-4 py-2 rounded-2xl ${
                    msg.role === 'user'
                      ...
                      : 'bg-white text-slate-900 border border-slate-200 shadow-sm rounded-bl-md'
                  }`}
                >
                  {msg.content}
                </div>
          ...
          <div className="p-4 border-t border-slate-200 bg-white">
            ...
            >
              <input
                ...
                className="flex-1 px-4 py-3 border border-slate-300 rounded-xl text-base focus:outline-none focus:ring-2 focus:ring-brand-blue-500"
                disabled={isLoading}
              />
              <button
                type="submit"
