      ...
      <main className="px-4 py-6 space-y-6">
        ...
        {user && (
          <div className="bg-slate-800 rounded-xl p-4">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-brand-red-500/20 rounded-full flex items-center justify-center">
                <User className="w-7 h-7 text-brand-red-400" />
              </div>
              <div>
          ...
          <div className="bg-slate-800 rounded-xl overflow-hidden">
            {supported ? (
              ...
              >
                <div className="flex items-center gap-4">
                  {subscribed ? (
                    <Bell className="w-5 h-5 text-brand-red-400" />
                  ) : (
                ...
                {loading ? (
                  ...
                  <div className={`w-12 h-7 rounded-full p-1 transition-colors ${
                    subscribed ? 'bg-brand-red-600' : 'bg-slate-600'
                  }`}>
        ...
        <div>
          ...
          <div className="bg-slate-800 rounded-xl overflow-hidden">
            ...
            >
              <div className="flex items-center gap-4">
                {darkMode ? (
                  <Moon className="w-5 h-5 text-brand-red-400" />
                ) : (
              ...
              <div className={`w-12 h-7 rounded-full p-1 transition-colors ${
                darkMode ? 'bg-brand-red-600' : 'bg-slate-600'
              }`}>
                <div className={`w-5 h-5 bg-white rounded-full transition-transform ${
