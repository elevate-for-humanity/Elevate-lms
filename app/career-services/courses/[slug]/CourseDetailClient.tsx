        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <Tag className="w-6 h-6 text-brand-red-600" />
              ...
              <div className="flex gap-2">
                ...
                {promoApplied ? (
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700 disabled:bg-gray-300"
                  >
            ...
            <div className="flex flex-col items-end gap-2">
              <button
                ...
                disabled={purchasing}
                className="flex items-center gap-2 bg-brand-red-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-brand-red-700 disabled:bg-gray-400"
              >
                {purchasing ? (
          ...
          <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-2">
                {promoApplied ? (
                  <>
                    <span className="text-xl font-bold text-brand-red-600">${finalPrice.toFixed(0)}</span>
                  ...
                  <>
                    <span className="text-xl font-bold text-brand-red-600">${Number(course.price).toFixed(0)}</span>
