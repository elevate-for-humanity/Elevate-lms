        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <div className="space-y-3">
            <Link
              ...
              className="block w-full py-3 px-6 bg-brand-red-600 text-white rounded-lg font-medium hover:bg-brand-red-700 transition-colors"
            >
          ...
          <p className="mt-8 text-sm text-slate-500">
            ...
            <a href="/contact" className="text-brand-red-600 hover:underline">
              Contact Us
            </a>
          </p>
        </div>
