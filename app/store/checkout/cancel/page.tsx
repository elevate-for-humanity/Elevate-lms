  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px] overflow-hidden">
        ...
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/store-checkout-cancel-hero.webp" alt="Elevate store" fill sizes="100vw" className="object-cover" priority  />
      </section>
