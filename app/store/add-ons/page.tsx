      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 w-full">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-brand-red-200 font-medium">Elevate Store</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">
            Platform Add-Ons
          </h1>
          <p className="text-xl text-brand-red-100 max-w-2xl mb-6">
          ...
          <div className="flex flex-wrap gap-4">
            <Link 
              href="#add-ons"
              className="inline-flex items-center gap-2 bg-white text-brand-red-700 px-6 py-3 rounded-lg font-semibold hover:bg-brand-red-50 transition-colors"
            >
              Browse Add-Ons
                ...
                <div className="relative h-64 lg:h-auto min-h-[300px]">
                  ...
                  >
                    <div className="w-20 h-20 bg-white/90 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg">
                      <Play className="w-8 h-8 text-brand-red-600 ml-1" />
                    </div>
                  </button>
                  <div className="absolute bottom-4 left-4 right-4">
                    <span className="inline-block bg-brand-red-600 text-white px-4 py-2 rounded-full text-sm font-bold">
                      Most Popular
                    </span>
                  </div>
                </div>
                ...
                <div className="p-8 lg:p-10">
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-14 h-14 bg-brand-red-100 rounded-xl flex items-center justify-center">
                      <addon.icon className="w-7 h-7 text-brand-red-600" />
                    </div>
                    <div className="text-right">
                      <div className="text-3xl font-black text-brand-red-600">{addon.price}</div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-6 mb-8">
                    <div>
                      <h4 className="font-semibold text-slate-900 mb-3 flex items-center gap-2">
                        <Zap className="w-4 h-4 text-brand-red-500" />
                        Features Included
                      </h4>
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 border-2 border-brand-red-600 text-brand-red-600 px-6 py-3 rounded-lg font-semibold hover:bg-brand-red-50 transition-colors"
                    >
                      Purchase Now
                    </Link>
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {comingSoon.map((item) => (
              ...
              >
                <div className="w-12 h-12 bg-brand-red-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-brand-red-200 transition-colors">
                  <item.icon className="w-6 h-6 text-brand-red-600" />
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-brand-red-600 transition-colors">{item.title}</h3>
                <p className="text-slate-600 mb-4">{item.description}</p>
                <span className="inline-flex items-center gap-2 text-brand-red-600 font-semibold">
      ...
      <section className="py-16 bg-brand-red-600">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-white text-brand-red-600 px-8 py-4 rounded-lg font-semibold hover:bg-brand-red-50 transition-colors"
            >
              Contact Sales
            </Link>
            <Link
