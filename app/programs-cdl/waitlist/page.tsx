    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-16 overflow-hidden border-t">
        <div className="absolute inset-0">
          <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/programs-cdl-waitlist-hero.webp" alt="CDL truck training" fill className="object-cover" priority  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
        </div>
