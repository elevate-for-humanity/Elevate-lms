...
<div className="bg-gray-50 border-b">
      ...
      <section className="relative h-[350px] flex items-center justify-center text-white overflow-hidden">
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/about-supportive-services.webp" alt="Ongoing Support" fill className="object-cover" priority sizes="100vw" />
