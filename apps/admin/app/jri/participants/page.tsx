...
export default async function JRIParticipantsPage() {
  ...
  const { data: participants } = await supabase
    ...
    .select(
      'id, status, program, enrolled_at, employment_status, profiles(full_name, email, phone)',
    )
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              {participants && participants.length > 0 ? (
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="font-medium text-slate-900">
                            {p.profiles?.full_name || 'Participant'}
                          </p>
                ...
                <tr>
                  <td colSpan={5} className="px-4 py-12 text-center text-slate-700">
                    No participants yet
                  </td>
                </tr>
              )}
