      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-3xl shadow-lg border-2 border-brand-red-200 p-8">
              <div className="flex items-start gap-4 mb-6">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 bg-brand-red-600 hover:bg-brand-red-700 text-white px-6 py-3 rounded-xl font-bold transition w-full justify-center"
              >
                <Download className="w-5 h-5" />
                View Template
              </Link>
