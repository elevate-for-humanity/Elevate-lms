      ...
      <section className="py-10 bg-white border-b">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-3 gap-6 text-center">
            <div>
              <div className="text-3xl font-bold text-brand-red-600">{volunteerCount || 50}+</div>
              <div className="text-gray-600">Active Volunteers</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-brand-red-600">Growing</div>
              <div className="text-gray-600">Community</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-brand-red-600">10+</div>
