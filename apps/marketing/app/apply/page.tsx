...
export const metadata: Metadata = {
  ...
  description:
    'Check eligibility for WIOA and Workforce Ready Grant-funded training in healthcare, trades, technology, and business. Many programs are no cost to eligible Indiana residents.',
  alternates: {
