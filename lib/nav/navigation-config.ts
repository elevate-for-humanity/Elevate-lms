    ...
    subItems: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { label: 'Building Maintenance', href: '/programs/building-maintenance-wrg' },
      ...
      },
      {
        ...
        subItems: [
          ...
          { label: 'Direct Support Professional', href: '/programs/healthcare' },
      ...
      },
      {
        ...
        subItems: [
          ...
          { label: 'Phlebotomy Technician', href: '/programs/healthcare' },
          { label: 'CDL', href: '/programs/cdl-training' },
          { label: 'Workforce Readiness', href: '/jri' },
        ],
      },
    ],
  },
...
export const footerNavigation = {
  programs: {
    ...
    links: [
      ...
      { label: 'WIOA Programs', href: '/funding' },
...
export const contactInfo = {
  ...
  address: {
    street: '120 Market St Suite 930',
    city: 'Indianapolis',
    state: 'IN',
    zip: '46204',
    full: '120 Market St Suite 930, Indianapolis, IN 46204',
  },
  hours: {
