...
{/* Hero */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="#pricing"
                  className="inline-flex items-center justify-center gap-2 bg-white text-brand-red-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-brand-red-50 transition-colors shadow-lg"
                >
                  View Plans
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-brand-red-300 text-sm">AI Healthcare Instructor</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {plans.map((plan) => (
              <div
                ...
                className={`relative bg-white rounded-2xl p-8 ${
                  plan.popular
                    ? 'border-2 border-brand-red-600 shadow-2xl scale-105 z-10'
                    : 'border border-gray-200 hover:shadow-lg'
                } transition-all`}
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-brand-red-600 text-white text-sm font-bold rounded-full">
                    Most Popular
                  </div>
                )}
      ...
      <section className="py-20 bg-slate-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-brand-red-200 mb-10 max-w-2xl mx-auto">
            Start your free trial today. No credit card required.
          </p>
          <Link
            href="/store/ai-studio/checkout?plan=professional"
            className="inline-flex items-center gap-2 bg-white text-brand-red-900 px-10 py-5 rounded-lg font-bold text-lg hover:bg-brand-red-50 transition-colors shadow-lg"
          >
            Start Free Trial
            <ArrowRight className="w-5 h-5" />
          </Link>
