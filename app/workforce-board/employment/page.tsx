...
const SERVICES = [
  {
    ...
    desc: 'Our career services team connects program graduates with employer partners actively hiring in their field.',
    icon: Briefcase,
  },
  {
    title: 'Resume & Interview Prep',
    desc: 'One-on-one coaching for resume writing, interview skills, and professional presentation.',
    icon: FileCheck,
  },
  {
    title: 'Employer Partnerships',
    desc: 'Direct hiring pipelines with local and regional employers across healthcare, trades, technology, and business.',
    icon: Handshake,
  },
  {
    title: 'Labor Market Data',
    desc: 'Access current wage data, job demand forecasts, and industry trends for informed career decisions.',
    icon: TrendingUp,
  },
  {
    title: 'Job Fairs & Hiring Events',
    desc: 'Regular employer meet-and-greet events, career fairs, and on-site hiring opportunities.',
    icon: Users,
  },
  {
    title: 'Local Job Boards',
    desc: 'Curated job listings from verified employers in the Indianapolis metro area and across Indiana.',
    icon: MapPin,
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full">
        ...
        {/* IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback) */}
          <Image
            src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/workforce-board-page-1.webp"
            ...
            {[
              {
                ...
                desc: 'Finish your program and earn your certification.',
              },
              {
                step: '2',
                title: 'Career Coaching',
                desc: 'Work with an advisor on resume, interview prep, and job search strategy.',
              },
              {
                step: '3',
                title: 'Employer Match',
                desc: 'Get connected with employers hiring in your field.',
              },
              {
                step: '4',
                title: 'Get Hired',
                desc: 'Start your new career with ongoing support for the first 90 days.',
              },
            ].map((item) => (
      ...
      <section className="py-16 bg-brand-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white mb-8 text-lg">
            Enroll in a training program and get access to employment services at no cost to
