...
export default function AIStudioPage() {
  ...
  return (
    <div className="min-h-screen bg-brand-red-50">
...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <Sparkles className="w-8 h-8 text-brand-red-600" />
            <h1 className="text-4xl font-bold text-brand-red-600">
              AI Studio
            </h1>
          </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-bold text-black mb-6 flex items-center gap-2">
                <Wand2 className="w-6 h-6 text-brand-red-600" />
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-500 focus:border-transparent"
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-brand-red-600 text-white py-4 rounded-lg font-semibold hover:bg-brand-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
              ...
              {/* Feature Info */}
              <div className="mt-6 p-4 bg-brand-red-50 rounded-lg">
                  ...
                  {generatedAssets.map((asset) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        <span className="text-xs font-medium text-brand-red-600 uppercase">
                          {asset.type}
                        </span>
                        <button className="text-black hover:text-brand-red-600" aria-label="Download">
                      ...
                      {(asset.type === 'voiceover' ||
                        ...
                        <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg mb-2">
                          <button className="text-brand-red-600 hover:text-brand-red-700" aria-label="Action button">
                            <Play className="w-5 h-5" />
                          </button>
                          <div className="flex-1 h-1 bg-gray-200 rounded-full">
                            <div className="h-full w-0 bg-brand-red-600 rounded-full" />
                          </div>
                        </div>
                      )}
