...
export const BEAUTY_PROGRAMS: Record<string, BeautyProgramConfig> = {
  ...
  esthetician: {
    ...
    nextSteps: [
      {
        title: 'Complete orientation',
        desc: 'Sanitation, safety, and spa protocols — required before hands-on training',
      },
      {
        title: 'Apply for your Indiana Esthetician License',
        desc: 'We guide you through the IPLA application — 700 hours required for licensure',
      },
      {
        title: 'Log OJT hours weekly',
        desc: '700 hours required — track via your apprentice dashboard',
      },
    ],
  },
  'nail-technician-apprenticeship': {
    ...
    nextSteps: [
      ...
      {
        title: 'Apply for your Indiana Nail Technician License',
        desc: 'We guide you through the IPLA application after the 2,000-hour apprenticeship training plan',
      },
      {
        title: 'Log apprenticeship hours weekly',
        desc: '2,000 total hours — track them in your apprentice dashboard',
      },
    ],
  },
};
