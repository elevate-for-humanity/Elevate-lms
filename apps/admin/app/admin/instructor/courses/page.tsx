  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px] overflow-hidden">
        <Image
          src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/instructor-page-7.webp"
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {!user ? (
          <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-6">
            <p className="text-brand-blue-900 mb-4">Please log in to view your courses.</p>
            <a
              href="/login"
