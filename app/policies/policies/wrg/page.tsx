    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full">
        <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden">
          <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/hero-images/federal-funded-hero.webp" alt="Workforce Ready Grant" fill className="object-cover" priority sizes="100vw" />
        </div>
