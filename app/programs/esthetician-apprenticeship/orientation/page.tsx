        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 mt-4">
            <div className="bg-brand-red-50 p-4 rounded-lg">
              <h4 className="font-bold text-brand-red-900">On-the-Job Training (OJT)</h4>
              <p className="text-brand-red-800 text-sm">{config.ojtDescription}</p>
            </div>
      ...
      <div className="bg-white border-b sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-6 py-4">
          ...
          <div className="h-2 bg-slate-200 rounded-full overflow-hidden">
            <div className="h-full bg-brand-red-600 transition-all duration-300" style={{ width: `${progress}%` }} />
          </div>
        </div>
      </div>
            ...
            <div className="px-6 pb-6">
              <label className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg cursor-pointer hover:bg-slate-100 transition">
                <input
                  ...
                  className="w-5 h-5 mt-0.5 rounded border-slate-300 text-brand-red-600 focus:ring-brand-red-500"
                />
          ...
          <div className="px-6 pb-6 flex items-center justify-between">
            ...
            {isLastSection ? (
              <button
                ...
                className="px-8 py-3 bg-brand-red-600 text-white font-bold rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-brand-red-700 transition"
              >
                {submitting ? 'Processing...' : 'Continue to Program'}
              </button>
            ) : (
              <button onClick={handleNext} className="px-8 py-3 bg-brand-red-600 text-white font-bold rounded-lg hover:bg-brand-red-700 transition">
                Next
              </button>
            )}
          </div>
