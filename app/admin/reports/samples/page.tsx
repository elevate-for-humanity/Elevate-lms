...
{/* Header */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        {/* Sample Certificate */}
        <section className="bg-white rounded-xl border shadow-sm overflow-hidden">
          <div className="bg-brand-red-600 text-white px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
          ...
          <div className="p-6">
            {/* Certificate Preview */}
            <div className="border-2 border-brand-red-200 rounded-xl p-8 bg-brand-red-50 mb-6">
              <div className="text-center">
                <div className="text-brand-red-600 font-bold text-sm tracking-widest mb-2">CERTIFICATE OF COMPLETION</div>
                ...
                <h4 className="text-2xl font-bold text-brand-red-700 mb-2">{SAMPLE_CERTIFICATE.program.name}</h4>
        ...
        <section className="bg-white rounded-xl border shadow-sm overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="bg-brand-red-50 rounded-lg p-4 text-center">
                <div className="text-3xl font-bold text-brand-red-600">{SAMPLE_FUNDING_REPORT.summary.completions}</div>
                <div className="text-sm text-brand-red-700">Completions</div>
              </div>
