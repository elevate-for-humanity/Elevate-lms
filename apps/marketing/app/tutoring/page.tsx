...
export default function TutoringPage() {
  ...
  const subjects = [
    {
      ...
      description:
        'Anatomy review, medical terminology, patient care procedures, clinical skills practice, and state exam preparation for CNA certification.',
  ...
  const faqs = [
    {
      ...
      answer:
        'Tutors are program instructors, industry professionals, and trained peer tutors (advanced students who have completed the program and passed their certifications). All tutors are vetted by Elevate staff and matched to your specific program and learning needs.',
    },
    {
      question: 'How do I schedule a session?',
      answer:
        'Log in to the LMS and navigate to Help > Tutoring. Select your subject area, choose an available tutor, and pick a time slot. Sessions can be booked up to 2 weeks in advance. Same-day sessions are available when tutors have openings.',
    },
    {
      question: 'Is tutoring included in my tuition?',
      answer:
        'Yes. All enrolled students receive up to 3 tutoring sessions per week at no additional cost. Sessions are 30 or 60 minutes depending on the subject. Additional sessions beyond 3 per week may be available based on tutor availability.',
    },
    {
      question: 'Can I get tutoring for certification exam prep?',
      answer:
        'Absolutely. Exam prep is one of our most requested tutoring subjects. Tutors will review practice exams with you, identify weak areas, and create a targeted study plan. Many students schedule intensive tutoring in the 2 weeks before their certification exam.',
    },
    {
      question: 'Are virtual sessions available?',
      answer:
        'Yes. All tutoring sessions are available via Zoom. In-person sessions are also available at the Indianapolis training center during staffed hours. Virtual sessions use screen sharing for hands-on subjects like QuickBooks or coding.',
    },
    {
      question: 'What if I need help outside of scheduled sessions?',
      answer:
        'The LMS has a discussion forum where you can post questions anytime. Instructors and peer tutors monitor the forums and typically respond within 24 hours. For urgent questions, use the LMS chat feature during business hours.',
    },
  ];
  ...
  return (
    <>
      ...
      {/* Hero Image */}
      <section className="relative h-[clamp(520px,72svh,860px)] overflow-hidden">
        <Image
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-700 max-w-3xl mx-auto">
            One-on-one and small group tutoring for every program we offer. Work with instructors
            and trained peer tutors on coursework, skills practice, and certification exam
            preparation. Up to 3 sessions per week included with your enrollment.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                step: '4',
                title: 'Meet & Learn',
                desc: 'Join your session via Zoom or at the training center. Get focused help on exactly what you need.',
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  <Image
                    ...
                    sizes="100vw"
                  />
                  <div className="absolute top-3 left-3 w-8 h-8 bg-brand-blue-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
                    {item.step}
                  </div>
                </div>
                <div className="p-5">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-700">
              Tutoring is available for every program and certification we offer.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white mb-8">
            Log in to the LMS to book a tutoring session, or contact support if you need assistance.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/support"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-brand-blue-600 font-bold rounded-xl hover:bg-white transition text-lg shadow-lg"
            >
