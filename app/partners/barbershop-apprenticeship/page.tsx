      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border-2 border-brand-red-300 bg-brand-red-50">
              <div className="w-10 h-10 bg-brand-red-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <span className="text-xs text-brand-red-700 font-medium">Most flexible option</span>
            </div>
