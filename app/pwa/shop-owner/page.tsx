  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="px-6 py-8 space-y-4">
        ...
        <div className="flex items-start gap-4 bg-slate-800 rounded-xl p-4">
          <div className="w-10 h-10 bg-brand-red-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
            <FileText className="w-5 h-5 text-brand-red-400" />
          </div>
          <div>
        ...
        <div className="space-y-3">
          ...
          <Link href="/pwa/shop-owner/reports" className="flex items-center gap-4 bg-slate-800 rounded-xl p-4 active:bg-slate-700">
            <div className="w-12 h-12 bg-brand-red-500/20 rounded-xl flex items-center justify-center">
              <FileText className="w-6 h-6 text-brand-red-400" />
            </div>
            <div className="flex-1">
              ...
              {apprentices.slice(0, 3).map((apprentice) => (
                ...
                >
                  <div className="w-12 h-12 bg-brand-red-500/20 rounded-full flex items-center justify-center">
                    <span className="text-brand-red-400 font-bold text-lg">
