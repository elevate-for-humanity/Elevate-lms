      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="bg-brand-red-50 border border-brand-red-200 rounded-xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="/contact"
              className="inline-flex items-center justify-center gap-2 border border-brand-red-600 text-brand-red-600 px-6 py-3 rounded-lg font-semibold hover:bg-brand-red-50 transition"
            >
