          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
              {[
                ...
                { label: 'Completion', value: '78%', icon: Circle, color: 'text-brand-red-600' },
            ...
            <div className="bg-white rounded-xl p-4 border">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  { stage: 'Done', count: 214, color: 'bg-brand-red-500' },
                ].map((p, i) => (
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {programs.map((p, i) => (
                <div key={i} className="bg-white rounded-xl p-4 border hover:shadow-md transition">
                  <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${p.cat === 'Healthcare' ? 'bg-blue-100 text-blue-700' : p.cat === 'Trades' ? 'bg-orange-100 text-orange-700' : 'bg-brand-red-100 text-brand-red-700'}`}>{p.cat}</span>
