  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[{ label: 'Contracts', href: '/contracts' }, { label: 'Employer Agreement' }]}
        />
      </div>
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border">
          ...
          <div className="p-8 prose max-w-none">
            <h2>1. Purpose</h2>
            <p>
              This Agreement establishes a partnership for hiring program graduates and
              participating in On-the-Job Training (OJT) programs.
            </p>
            ...
            <h2>5. Term</h2>
            <p>
              This agreement is effective for one year and automatically renews unless terminated
              with 30 days notice.
            </p>
          </div>
        </div>
