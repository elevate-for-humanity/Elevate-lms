...
export const metadata: Metadata = {
  title: `Data Deletion Requests | Admin Compliance | ${process.env.NEXT_PUBLIC_ORG_NAME ?? PLATFORM_DEFAULTS.orgName}`,
  description:
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-48 md:h-64 overflow-hidden">
        <Image
          src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/admin-compliance-deletions-detail.webp"
          alt="Deletions"
          fill
      ...
      <section className="py-16 bg-brand-blue-700">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Data Deletion Requests</h2>
