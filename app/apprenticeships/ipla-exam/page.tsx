    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-white/90 max-w-2xl">
              Schedule your apprenticeship licensing exam. Required for barber, cosmetology, and
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <Breadcrumbs
            items={[{ label: 'Apprenticeships', href: '/apprenticeships' }, { label: 'IPLA Exam' }]}
          />
        </div>
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block font-semibold mb-2">Apprenticeship Program *</label>
                <select
                ...
                >
                  ...
                  <option value="nail-tech">Nail Technician Apprenticeship</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="block font-semibold mb-3">Available Dates</label>
              ...
              <div>
                <label className="block font-semibold mb-3">Available Times</label>
                <div className="space-y-2">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="bg-slate-50 rounded-lg p-6 mb-6">
              ...
              <p className="text-sm text-black">
                Secure payment processed by Stripe. You will receive a confirmation email after
                payment.
              </p>
            </div>
