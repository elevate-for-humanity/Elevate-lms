    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6">
      <div className="max-w-lg w-full">
        ...
        <Link
          ...
          className="block w-full bg-brand-red-600 hover:bg-brand-red-700 text-white text-center py-5 rounded-xl font-bold text-lg transition-all hover:scale-[1.02] shadow-lg"
        >
          Start Orientation
        </Link>
