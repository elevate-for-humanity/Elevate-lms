...
const PROGRAMS = [
  { value: 'barber-apprenticeship', label: 'Barber Apprenticeship (2,000 hrs)' },
...
export default function MesmerizedApplyForm() {
    ...
    return (
      <div className="bg-white rounded-2xl p-8 text-center border border-purple-200">
        ...
        <p className="text-slate-600">
          We'll review your application and reach out within 2 business days to discuss next steps
          and funding options.
        </p>
      </div>
    );
  ...
  return (
    <form
      ...
      className="bg-white rounded-2xl p-8 border border-purple-200 space-y-6"
    >
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700 mb-1">
          Prior Beauty Industry Experience
        </label>
        <textarea
      ...
      <button
        ...
        className="w-full bg-purple-700 hover:bg-purple-800 disabled:opacity-60 text-white font-bold py-3 px-6 rounded-xl transition"
      >
        {status === 'submitting' ? 'Submitting…' : 'Submit Application'}
      </button>

      <p className="text-xs text-slate-500 text-center">
        By submitting, you agree to be contacted by Mesmerized by Beauty and{' '}
        {PLATFORM_DEFAULTS.orgName} regarding your application.
      </p>
    </form>
  );
}
