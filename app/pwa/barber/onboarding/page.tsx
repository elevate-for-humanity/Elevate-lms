    ...
    <div className="min-h-screen bg-slate-900 pb-20">
      <header className="bg-brand-red-600 px-4 pt-12 pb-6 safe-area-inset-top">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-brand-red-200 text-sm">Complete your onboarding</p>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-brand-red-200 text-sm">Onboarding Progress</span>
      ...
      <main className="px-4 py-6 space-y-4">
              ...
              return (
                <div className="bg-brand-red-500/20 border border-brand-red-500/30 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-brand-red-300 text-sm font-medium">Next Step</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-brand-red-500 rounded-xl flex items-center justify-center">
                      <Icon className="w-6 h-6 text-white" />
                    </div>
                    <div className="flex-1">
                      <h3 className="text-white font-bold">{nextStep.title}</h3>
                      <p className="text-brand-red-200 text-sm">{nextStep.description}</p>
                    </div>
                  </div>
                  {nextStep.actionUrl && (
                    <Link 
                      href={nextStep.actionUrl}
                      className="mt-4 flex items-center justify-center gap-2 bg-brand-red-500 text-white font-medium py-3 rounded-xl"
                    >
        ...
        <div className="bg-slate-800 rounded-xl p-4 mt-6">
          ...
          <Link 
            href="/help"
            className="text-brand-red-400 text-sm font-medium"
          >
            Visit Help Center →
          </Link>
        </div>
