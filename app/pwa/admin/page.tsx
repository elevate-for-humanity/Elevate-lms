  ...
  return (
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-48 sm:h-56">
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/demo-page-1.webp" alt="Elevate admin portal" fill className="object-cover" priority  sizes="100vw" />
