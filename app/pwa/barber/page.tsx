...
function LandingPage() {
  return (
    <div className="min-h-screen bg-slate-900">
      {/* Hero */}
      <div className="bg-brand-red-700 px-6 pt-16 pb-12 text-center">
        <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
          <Scissors className="w-10 h-10 text-white" />
        </div>
        <h1 className="text-3xl font-black text-white mb-3">Barber Apprentice</h1>
        <p className="text-brand-red-200 text-lg max-w-xs mx-auto">
      ...
      <div className="px-6 pb-8 space-y-3">
        <Link
          ...
          className="w-full flex items-center justify-center gap-2 bg-brand-red-600 text-white font-bold py-4 rounded-xl hover:bg-brand-red-700"
        >
      ...
      <div className="px-6 pb-8 text-center">
        ...
        <Link href="/" className="text-brand-red-400 text-sm hover:underline">
...
function Dashboard({ apprentice, onLogout }: { apprentice: ApprenticeData; onLogout: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-slate-900 pb-20">
      {/* Header */}
      <header className="bg-brand-red-600 px-4 pt-12 pb-6 safe-area-inset-top">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-brand-red-200 text-sm">Welcome back,</p>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4">
          <div className="flex items-center justify-between mb-3">
            <span className="text-brand-red-200 text-sm">Progress to Licensure</span>
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="text-brand-red-200">{formatHours(TARGET_HOURS)} hrs goal</span>
          </div>
        </div>
      </header>
      ...
      <main className="px-4 py-6 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <Link href="/pwa/barber/progress" className="flex items-center gap-4 bg-slate-800 rounded-xl p-4 active:bg-slate-700">
            <div className="w-12 h-12 bg-brand-red-500/20 rounded-xl flex items-center justify-center">
              <TrendingUp className="w-6 h-6 text-brand-red-400" />
            </div>
            <div className="flex-1">
        ...
        <div className="bg-slate-800 rounded-xl p-4">
          <div className="flex items-center gap-3 mb-3">
            <Scissors className="w-5 h-5 text-brand-red-400" />
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-slate-800 border-t border-slate-700 px-6 py-3 safe-area-inset-bottom">
        <div className="flex justify-around">
          <Link href="/pwa/barber" className="flex flex-col items-center gap-1 text-brand-red-400">
    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-12 h-12 text-brand-red-500 mx-auto mb-4 animate-spin" />
      ...
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 bg-brand-red-600 text-white px-6 py-3 rounded-xl font-medium"
          >
            Enroll Now
