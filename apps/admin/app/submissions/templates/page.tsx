...
export const metadata: Metadata = {
  robots: { index: false }, title: 'Document Templates | Submissions OS | Admin' };
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm">
                Branded letterhead layouts with merge fields for every document type
              </p>
            </div>
          </div>
          <Link
        ...
        {!templates || templates.length === 0 ? (
          <div className="bg-white rounded-xl border border-slate-200 p-10 text-center">
            ...
            <p className="text-sm text-slate-500 mb-4">
              Create branded templates for cover letters, capability statements, budget narratives,
              and more. Use{' '}
