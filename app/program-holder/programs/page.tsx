    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/program-holder/programs/new" className="flex items-center gap-2 bg-brand-red-600 text-white px-4 py-2 rounded-lg hover:bg-brand-red-700">
                ...
                <tr key={program.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button className="p-2 text-gray-600 hover:text-brand-red-600 hover:bg-brand-red-50 rounded"><Edit className="w-4 h-4" /></button>
