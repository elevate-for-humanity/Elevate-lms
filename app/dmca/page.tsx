    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-brand-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-base md:text-lg text-slate-300">Copyright Infringement Notification</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl md:text-3xl font-bold text-black mb-6">Copyright Policy</h2>
            <p className="text-black mb-6">
              Elevate For Humanity respects the intellectual property rights of others and expects
              our users to do the same. We respond to notices of alleged copyright infringement that
            ...
            <p className="text-black mb-4">
              If you believe that content on our website infringes your copyright, please send a
            ...
            <ol className="list-decimal pl-6 mb-6 text-black space-y-3">
              ...
              <li>
                <strong>Identification of the copyrighted work:</strong> Description of the work you
                claim has been infringed
              </li>
              <li>
                <strong>Location of infringing material:</strong> URL or specific location on our
                website where the material is located
              </li>
              <li>
              ...
              <li>
                <strong>Accuracy statement:</strong> A statement that the information in your notice
                is accurate
              </li>
              <li>
                <strong>Authority statement:</strong> A statement, under penalty of perjury, that
                you are authorized to act on behalf of the copyright owner
              </li>
              <li>
                <strong>Physical or electronic signature:</strong> Your signature (physical or
                electronic)
              </li>
            </ol>
            ...
            <p className="text-black mb-4">Send DMCA notices to our designated Copyright Agent:</p>
            ...
            <p className="text-black mb-4">When we receive a valid DMCA notice:</p>
            ...
            <p className="text-black mb-6">
              We will terminate the accounts of users who are repeat copyright infringers in
              appropriate circumstances.
            </p>

            <h2 className="text-2xl md:text-3xl font-bold text-black mb-6 mt-12">False Claims</h2>
            <p className="text-black mb-6">
              Please note that under Section 512(f) of the DMCA, anyone who knowingly materially
              misrepresents that material is infringing may be subject to liability for damages. Do
            ...
            <p className="text-black mb-6">
              As an educational institution, some content on our website may be used under fair use
              provisions of copyright law. We use copyrighted materials for educational purposes,
              commentary, and criticism where appropriate.
            </p>

            <h2 className="text-2xl md:text-3xl font-bold text-black mb-6 mt-12">Questions</h2>
            <p className="text-black mb-4">
            ...
            <p className="text-black text-sm mb-8 italic">Last Updated: December 8, 2024</p>
