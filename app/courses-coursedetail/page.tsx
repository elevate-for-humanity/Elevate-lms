...
{/* Hero Section */}
      <section className="relative h-48 md:h-64 overflow-hidden">
        <Image
          src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/admin-apprenticeships-classroom.webp"
          alt="Coursedetail"
          fill
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="relative h-96 rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/programs/cdl-hero.webp"
                  alt="Course detail"
                  fill
                  className="object-cover"
                  quality={100}
