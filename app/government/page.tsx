        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200">
              ...
              <div className="p-8">
                <div className="w-14 h-14 bg-brand-red-100 rounded-xl flex items-center justify-center mb-6 -mt-14 relative z-10 border-4 border-white">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="font-bold text-brand-red-600">78%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div className="bg-brand-red-600 h-3 rounded-full" style={{ width: '78%' }} />
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-2">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200">
              ...
              <div className="p-6 text-center">
                <div className="w-14 h-14 bg-brand-red-100 rounded-full flex items-center justify-center mx-auto -mt-12 mb-3 border-4 border-white relative z-10">
                  <Handshake className="w-7 h-7 text-brand-red-600" />
                </div>
