...
export default async function ApprovalsPage() {
  ...
  const registeredPrograms = [
    getRegisteredProgramStandard('barber-apprenticeship'),
    getRegisteredProgramStandard('esthetician-apprenticeship'),
    getRegisteredProgramStandard('nail-technician-apprenticeship'),
  ].filter(Boolean) as NonNullable<ReturnType<typeof getRegisteredProgramStandard>>[];
  if (registeredPrograms.length !== 3) throw new Error('Canonical registered beauty standards are incomplete.');
