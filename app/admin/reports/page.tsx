...
export default async function ReportsPage() {
  ...
  const stats = [
    ...
    { label: 'Total Leads', value: totalLeads || 0, icon: TrendingUp, color: 'text-brand-red-600', bgColor: 'bg-brand-red-100' },
            ...
            <div key={index} className="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Link
                    href={report.href}
                    className="inline-flex items-center gap-1 px-3 py-1.5 text-sm bg-brand-red-600 text-white rounded hover:bg-brand-red-700 transition"
                  >
