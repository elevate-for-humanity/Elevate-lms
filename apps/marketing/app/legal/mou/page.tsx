  ...
  return (
    <div className="min-h-screen bg-white py-12">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link href="/" className="text-brand-blue-600 hover:text-brand-blue-800 mb-6 inline-block">
          ← Back to Home
        </Link>

        <h1 className="text-4xl font-bold text-black mb-8">Memorandum of Understanding</h1>

        <div className="prose prose-slate max-w-none">
          <p className="text-sm text-black mb-8">Last Updated: December 15, 2024</p>

          <section className="mb-8">
            <h2 className="text-2xl font-bold text-black mb-4">1. Purpose</h2>
            <p className="text-black mb-4">
              This Memorandum of Understanding ("MOU") establishes a collaborative partnership
              between {PLATFORM_DEFAULTS.orgName} ("EFH") and the partnering organization ("Partner") to
              provide apprenticeship training and workforce development services.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold text-black mb-4">2. Parties</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-black mb-4">3. Scope of Partnership</h2>
            <p className="text-black mb-4">The parties agree to collaborate on:</p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-black mb-4">4. EFH Responsibilities</h2>
            <p className="text-black mb-4">{PLATFORM_DEFAULTS.orgName} agrees to:</p>
            <ul className="list-disc pl-6 text-black space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-black mb-4">5. Partner Responsibilities</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-black mb-4">7. Compliance</h2>
            <p className="text-black mb-4">Both parties agree to comply with:</p>
            <ul className="list-disc pl-6 text-black space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-black mb-4">8. Term and Termination</h2>
            <p className="text-black mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-black mb-4">9. Amendments</h2>
            <p className="text-black mb-4">
