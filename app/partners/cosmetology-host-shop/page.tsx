...
export const metadata: Metadata = {
  title: `Cosmetology Host Shop Partnership | ${PLATFORM_DEFAULTS.orgName}`,
  description: 'Host a cosmetology apprenticeship. Partner with us to train the next generation of cosmetologists while growing your salon business.',
};

const BENEFITS = [
  { icon: DollarSign, title: 'Earn While Training', desc: 'Apprentices work in your salon from day one, bringing in revenue while they learn.' },
  { icon: Users, title: 'Build Your Team', desc: 'Recruit and train talent specifically for your salon culture and services.' },
...
const REQUIREMENTS = [
  'Licensed cosmetology salon in good standing with Indiana State Board of Cosmetology',
  'At least one licensed cosmetologist with 3+ years of experience to serve as mentor',
  'Physical space for apprentice to work on clients',
  'Willingness to commit to 12-24 month apprenticeship duration',
  'Background check clearance for salon owner and mentor',
...
const APPRENTICE_INFO = [
  ...
  'No prior cosmetology license required',
  'Committed to completing 1500+ hours of training',
  'Passion for beauty and customer service',
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative flex items-end overflow-hidden bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900" style={{ minHeight: 'clamp(260px, 45vw, 520px)' }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 pb-8 sm:pb-12 w-full text-white">
          <nav className="text-sm text-white/60 mb-4">
            ...
            <span className="text-white">Cosmetology Host Shop</span>
          </nav>
          ...
          <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold leading-tight mb-3">Host a Cosmetology Apprenticeship</h1>
          <p className="text-lg text-white/70 max-w-2xl">
            Partner with us to train the next generation of cosmetologists while building your team and growing your salon business.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">Why Become a Host Salon?</h2>
        ...
        <section className="mb-16">
          ...
          <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { step: '1', title: 'Apply', desc: 'Complete our host salon application. We review your salon and mentor qualifications.' },
                { step: '2', title: 'Match', desc: 'We match you with an apprentice who fits your salon\'s culture and services.' },
                { step: '3', title: 'Train', desc: 'Your apprentice works in your salon while attending our RTI classroom training.' },
              ].map((item) => (
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          {/* Host Salon Requirements */}
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="bg-slate-900 px-6 py-4">
              <div className="flex items-center gap-3">
                <Building2 className="w-6 h-6 text-white" />
                <h2 className="text-xl font-bold text-white">Host Salon Requirements</h2>
              </div>
            </div>
            <div className="p-6">
        ...
        <section className="mb-16">
          ...
          <div className="bg-gradient-to-br from-slate-900 to-pink-900 rounded-2xl p-8 text-white">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                <p className="text-4xl font-extrabold text-pink-400 mb-2">$0</p>
                <p className="text-slate-300 text-sm">Your cost to host an apprentice</p>
              </div>
              <div>
                <p className="text-4xl font-extrabold text-pink-400 mb-2">500+</p>
                <p className="text-slate-300 text-sm">Hours of productive work in 12 months</p>
              </div>
              <div>
                <p className="text-4xl font-extrabold text-pink-400 mb-2">$10K</p>
        ...
        <section className="bg-slate-50 rounded-2xl p-8 sm:p-12 border border-slate-200 text-center">
          ...
          <p className="text-slate-600 mb-8 max-w-xl mx-auto">
            Apply to become a host salon partner. We&apos;ll review your application and schedule a site visit within 2 weeks.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/partners/cosmetology-host-shop/apply" className="bg-pink-600 hover:bg-pink-700 text-white font-bold px-8 py-4 rounded-xl transition-colors text-lg">
              Apply to Host
            </Link>
