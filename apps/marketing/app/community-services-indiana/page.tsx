...
export const metadata: Metadata = {
  title: 'Community Services & Support in Indiana,
  description:
    'Trusted community services in Indiana. Job placement assistance, financial literacy, housing support, and family services. Building stronger communities together.',
  keywords: [
    'community services Indiana',
    'job placement Indiana',
    'family services Indianapolis',
    'housing assistance Indiana',
  ],
};
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {[
            {
              title: 'Job Placement',
              desc: 'Resume building, interview prep, employer connections',
            },
            { title: 'Financial Literacy', desc: 'Budgeting, credit repair, savings programs' },
            {
              title: 'Housing Assistance',
              desc: 'Rental support, homebuyer education, emergency aid',
            },
            {
              title: 'Family Services',
              desc: 'Childcare resources, parenting support, youth programs',
            },
            { title: 'Benefits Navigation', desc: 'SNAP, Medicaid, TANF application assistance' },
            {
              title: 'Transportation',
              desc: 'Bus passes, car repair assistance, rideshare programs',
            },
          ].map((service) => (
            <div
              key={service.title}
