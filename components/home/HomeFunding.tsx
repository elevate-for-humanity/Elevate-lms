...
export function HomeFunding() {
  return (
    <section
      className="border-t border-slate-100 bg-white px-4 py-16 sm:py-20"
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="relative min-h-[360px] overflow-hidden rounded-3xl sm:min-h-[460px]">
            ...
            <div className="absolute bottom-5 left-5 right-5 rounded-2xl bg-white/95 p-5 shadow-xl backdrop-blur-sm">
              ...
              <p className="mt-1 text-base leading-7 text-slate-700">
                Funding depends on the participant, program, region, authorization, and available
                funding.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-lg leading-8 text-slate-700">
              Elevate’s confirmed workforce-fundable pathways are CDL, HVAC, Business
              Administration, and Financial Literacy. WorkOne or the responsible agency determines
              participant eligibility, covered costs, and written authorization.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-red-600 px-7 py-4 text-base font-extrabold text-white hover:bg-brand-red-700"
              >
                Check Eligibility <ArrowRight className="h-5 w-5" />
              </Link>
              <Link
                href="/funding"
                className="inline-flex items-center justify-center rounded-xl border-2 border-slate-300 px-7 py-4 text-base font-extrabold text-slate-900 hover:bg-slate-50"
              >
