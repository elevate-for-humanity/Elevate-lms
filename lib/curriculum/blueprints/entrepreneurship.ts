  ...
  modules: [
    ...
    },
    {
      ...
      lessons: [
        ...
        { slug: 'esb-practice-exam-remediation', title: 'ESB Practice Exam Review, Remediation, and Readiness Plan', order: 5, domainKey: 'exam_prep' },
        { slug: 'esb-final-exam', title: 'Entrepreneurship & Small Business Final Exam', order: 6, domainKey: 'exam_prep' },
      ],
    },
  ],
};
