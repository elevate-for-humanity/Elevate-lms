...
export const STATIC_POSTS: BlogPost[] = [
  {
    ...
    image: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/funding-hero.webp',
    published: true,
...
[Check your eligibility](/wioa-eligibility) or [apply now](/apply/student) to get started.`,
  },
  {
    ...
    image: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/success-hero.webp',
    published: true,
