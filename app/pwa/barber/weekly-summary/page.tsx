    ...
    <div className="min-h-screen bg-slate-900 pb-20">
      <header className="bg-slate-700 px-4 pt-12 pb-6 safe-area-inset-top">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
          <p className="text-brand-red-200 text-sm mb-1">Hours This Week</p>
      ...
      <main className="px-4 py-6 space-y-6">
        ...
        <div className="bg-slate-800 rounded-xl p-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 rounded-full bg-brand-red-500" />
          ...
          <div className="mt-4 h-4 bg-slate-700 rounded-full overflow-hidden flex">
            ...
            />
            <div 
              className="bg-brand-red-500 h-full"
        ...
        <div className="bg-brand-red-500/20 border border-brand-red-500/30 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-3">
            <TrendingUp className="w-5 h-5 text-brand-red-400" />
            <span className="text-brand-red-300 font-medium">Overall Progress</span>
          </div>
          <div className="flex items-end justify-between mb-3">
            <div>
              <p className="text-3xl font-bold text-white">{summary.cumulativeHours}</p>
              <p className="text-brand-red-200 text-sm">of 2,000 hours</p>
            </div>
            <p className="text-2xl font-bold text-brand-red-300">{summary.progressPercent}%</p>
          </div>
