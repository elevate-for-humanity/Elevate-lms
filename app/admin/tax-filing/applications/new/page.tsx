...
<div className="max-w-3xl mx-auto">
        <Link href="/admin/tax-filing" className="flex items-center gap-2 text-gray-600 hover:text-brand-red-600 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              {['W-2 Employment', '1099 Self-Employment', 'Unemployment Benefits', 'Social Security', 'Other Income'].map((source) => (
                <label key={source} className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:border-brand-red-300">
