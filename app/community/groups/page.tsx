        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-brand-red-100">Find your tribe and grow together</p>
            </div>
            {user && (
              <Link
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-8">
          <div className="relative max-w-xl mx-auto">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-500 focus:border-brand-red-500"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
              ...
              {user ? (
                ...
                <div className="text-center py-4">
                  ...
                  <Link
                    ...
                    className="text-brand-red-600 font-medium hover:text-brand-red-700"
                  >
                    Sign In
                  </Link>
                </div>
            ...
            {/* Events CTA */}
            <div className="bg-brand-red-50 rounded-lg p-6 border border-brand-red-200">
              <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
                <Calendar className="w-5 h-5 mr-2 text-brand-red-600" />
                Community Events
              </h2>
              ...
              <Link
                ...
                className="block text-center text-brand-red-600 font-medium hover:text-brand-red-700"
              >
                View all events →
              </Link>
            </div>
