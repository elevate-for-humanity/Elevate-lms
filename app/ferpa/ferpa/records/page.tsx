  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px] overflow-hidden">
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/ferpa-page-6.webp" alt="FERPA compliance" fill sizes="100vw" className="object-cover" priority />
      </section>
      {/* Header */}
