        ...
        >
          <div>
            ...
            <input
              type="text"
              required
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-600 focus:border-transparent"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-brand-red-600 text-white py-4 rounded-lg text-lg font-bold hover:bg-brand-red-700 transition-colors"
          >
            Submit Registration
          </button>
        </form>
