      ...
      <section className="bg-gradient-to-br from-slate-900 via-brand-blue-900 to-slate-900 text-white py-20 relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 bg-brand-red-600/20 text-brand-red-400 px-4 py-2 rounded-full text-sm font-bold mb-6">
            <Clipboard className="w-4 h-4" /> WorkKeys
          </div>
          <h1 className="text-4xl sm:text-5xl font-black tracking-tight mb-6">WorkKeys Assessments</h1>
          <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-10">Prepare for WorkKeys assessments for employment and certifications.</p>
