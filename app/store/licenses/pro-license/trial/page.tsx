    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <span className="inline-block bg-brand-red-100 text-brand-red-700 px-4 py-1 rounded-full text-sm font-medium mb-4">
            14-Day Free Trial
          </span>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red-500 focus:border-transparent"
                ...
                <button
                  type="submit"
                  className="w-full bg-brand-red-600 text-white py-3 rounded-lg font-semibold hover:bg-brand-red-700 transition"
                >
                  Start Free Trial
                </button>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 text-center">
            <Clock className="w-10 h-10 text-brand-red-600 mx-auto mb-3" />
          ...
          <div className="bg-white rounded-xl p-6 text-center">
            <Zap className="w-10 h-10 text-brand-red-600 mx-auto mb-3" />
        ...
        <div className="text-center mt-8">
          <Link href="/store/licenses" className="text-brand-red-600 hover:text-brand-red-700 font-medium">
            ← Back to Licenses
          </Link>
        </div>
      </div>
