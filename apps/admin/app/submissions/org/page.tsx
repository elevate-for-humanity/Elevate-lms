...
export const metadata: Metadata = {
  robots: { index: false }, title: 'Org Profile | Submissions OS | Admin' };
...
export default async function OrgProfilePage() {
  ...
  const { data: orgProfile } = org
    ? await db
        .from('sos_organization_profiles')
        .select('*')
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm">
                Legal identity used in all submission packets
              </p>
            </div>
          </div>
          <Link
          ...
          <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-sm text-slate-900 font-medium">
                      {org.uei || <span className="text-amber-600">Not set</span>}
                    </p>
                    {org.uei && (
                      <a
                        href={`https://sam.gov/entity/${org.uei}`}
                        target="_blank"
                    ...
                    <span className="inline-flex items-center gap-1 text-sm text-green-700 font-semibold">
                      ...
                      {org.sam_expiration && (
                        <span className="text-slate-400 font-normal ml-1">
                          · expires {new Date(org.sam_expiration).toLocaleDateString()}
                        </span>
                      )}
                    </span>
                  ) : (
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                ...
                <Field
                  label="Address"
                  value={[org.address_line_1, org.address_line_2, org.city, org.state, org.zip]
                    .filter(Boolean)
                    .join(', ')}
                />
              </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div className="grid md:grid-cols-2 gap-5">
                  <Field
                    ...
                    value={orgProfile.years_in_operation?.toString()}
                  />
