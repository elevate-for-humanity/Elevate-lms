    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-brand-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl text-slate-600">Standards for maintaining good academic standing</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-900 mb-6">
            Students must meet <strong>all three</strong> of the following requirements to maintain
            SAP:
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-6">
              ...
              <p className="text-slate-900 mb-4">
                Students must maintain a minimum cumulative grade average of <strong>70%</strong> (C
                or equivalent) across all coursework, including:
              </p>
            ...
            <div className="bg-brand-green-50 border border-brand-green-200 rounded-lg p-6">
              ...
              <p className="text-slate-900">
                <strong>Example:</strong> A student who has attempted 10 modules must have
                successfully completed at least 7 modules (70%) to meet the pace requirement.
              </p>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <p className="text-slate-900 mb-4">
                Students must complete their program within <strong>150%</strong> of the published
                program length.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-white rounded-lg p-6">
            <p className="text-slate-900 mb-4">SAP is evaluated at the following points:</p>
            <ul className="list-disc list-inside text-slate-900 space-y-2">
              <li>
                <strong>Programs 12 weeks or less:</strong> At the midpoint and end of the program
              </li>
              <li>
                <strong>Programs longer than 12 weeks:</strong> At the end of each month or module,
                whichever is more frequent
              </li>
              <li>
                <strong>Clock hour programs:</strong> At each 450-hour increment or monthly,
                whichever is more frequent
              </li>
            </ul>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-brand-green-50 border border-brand-green-200 rounded-lg p-6">
              ...
              <p className="text-slate-900">
                Students meeting all SAP requirements are in good standing and may continue in their
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <p className="text-slate-900 mb-3">
                Students who fail to meet SAP requirements at an evaluation point will be placed on
                SAP Warning for the next evaluation period. During warning:
              </p>
              <ul className="list-disc list-inside text-slate-900 space-y-1">
            ...
            <div className="bg-brand-red-50 border border-brand-red-200 rounded-lg p-6">
              ...
              <p className="text-slate-900">
                ...
                or who fail to meet probation requirements will be academically dismissed from the
                program. Dismissed students may apply for re-enrollment after a minimum of one
                enrollment period.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-white rounded-lg p-6">
            <p className="text-slate-900 mb-4">
              Students who fail to meet SAP may appeal if extenuating circumstances affected their
              academic performance. Extenuating circumstances may include:
            </p>
            ...
            <p className="text-slate-900 mt-6">
              Appeals are reviewed by the Academic Standards Committee. Students will receive a
              written decision within 10 business days. The committee's decision is final.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-slate-900">
                ...
                Students have 14 days to complete outstanding work before the grade converts to a
                failing grade.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-slate-900">
                Students may repeat failed coursework once. Both attempts count toward attempted
                hours for pace calculation, but only the higher grade is used for the qualitative
                calculation.
              </p>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t">
          ...
          <p className="text-slate-700 text-sm mb-6">
            Questions about SAP? Contact Student Services at Visit Support Center or our contact
            form
          </p>
          <div className="flex flex-wrap gap-4 text-sm">
            ...
            <Link href="/grievance" className="text-brand-orange-600 hover:underline">
              Grievance Policy
            </Link>
          </div>
        </div>
