...
export const DEMO_ORGANIZATION = {
  ...
  branding: {
    logo_url: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/demos-hero.webp',
...
export const DEMO_STUDENTS = [
  {
    ...
    email: 'marcus.j@demo.elevateforhumanity.org',
    phone: '(317) 555-0201',
    ...
    name: 'Marcus Johnson',
    progress: 42,
    enrolledDate: 'Jun 2025',
  },
  {
    id: 'demo-student-002',
    full_name: 'Aaliyah Thompson',
    email: 'aaliyah.t@demo.elevateforhumanity.org',
    phone: '(317) 555-0202',
  ...
  },
  {
    ...
    email: 'deshawn.w@demo.elevateforhumanity.org',
    phone: '(317) 555-0203',
  ...
  },
  {
    ...
    email: 'jasmine.d@demo.elevateforhumanity.org',
    phone: '(317) 555-0204',
  ...
  },
  {
    ...
    email: 'tyler.r@demo.elevateforhumanity.org',
    phone: '(317) 555-0205',
    program: 'CDL Class A',
    status: 'active',
    hours_completed: 80,
  ...
  },
  {
    ...
    email: 'keisha.b@demo.elevateforhumanity.org',
    phone: '(317) 555-0206',
  ...
  {
    id: 'demo-student-007',
    full_name: 'Andre Mitchell',
    email: 'andre.m@demo.elevateforhumanity.org',
    phone: '(317) 555-0207',
    program: 'Welding',
    status: 'at_risk',
    hours_completed: 60,
  ...
  },
  {
    ...
    email: 'maria.g@demo.elevateforhumanity.org',
    phone: '(317) 555-0208',
    program: 'Phlebotomy',
    status: 'completed',
    hours_completed: 160,
    ...
    certification: 'CPT(ASCP)',
    funding: 'WIOA',
    attendance: 98,
    gpa: 3.6,
    name: 'Maria Gonzalez',
    progress: 100,
    enrolledDate: 'Aug 2025',
  },
  {
    id: 'demo-student-009',
    full_name: 'James Carter',
    email: 'james.c@demo.elevateforhumanity.org',
    phone: '(317) 555-0209',
    program: 'Electrical Apprenticeship',
    status: 'active',
    hours_completed: 3200,
    hours_required: 8000,
  ...
  {
    id: 'demo-student-010',
    full_name: 'Tanya Washington',
    email: 'tanya.w@demo.elevateforhumanity.org',
    phone: '(317) 555-0210',
    program: 'IT Support',
    status: 'pending',
    hours_completed: 0,
  ...
  },
  {
    ...
    email: 'robert.l@demo.elevateforhumanity.org',
    phone: '(317) 555-0211',
    program: 'CDL Class B',
    status: 'active',
    hours_completed: 40,
  ...
  {
    id: 'demo-student-012',
    full_name: 'Destiny Harris',
    email: 'destiny.h@demo.elevateforhumanity.org',
    phone: '(317) 555-0212',
    program: 'CNA Training',
    status: 'pending',
    hours_completed: 0,
...
export const DEMO_HOURS_LOG = [
  {
    date: 'Jan 14, 2026',
    hours: 8,
    activity: 'Floor work — haircuts & fades',
  ...
  },
  {
    date: 'Jan 13, 2026',
    hours: 8,
    activity: 'Floor work — shaves & trims',
    supervisor: 'James Williams',
    approved: true,
  },
  {
    date: 'Jan 10, 2026',
    hours: 8,
    activity: 'Observation & assisted cuts',
    supervisor: 'James Williams',
    approved: true,
  },
  {
...
export function isDemoMode(): boolean {
  ...
  return (
    window.location.pathname.startsWith('/store/demo') ||
