      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">
            {requestMode ? 'Reset your password' : 'Set New Password'}
          </h1>
          <p className="text-slate-600 text-sm mt-1">
            {PLATFORM_DEFAULTS.orgName}{' '}
            {programHolder ? 'Program Holder Portal' : 'Learning Portal'}
          </p>
        </div>
          ...
          {requestMode ? (
            recoverySent ? (
              <div className="text-center space-y-4" role="status">
                ...
                <Link
                  href="/login"
                  className="inline-block text-brand-blue-600 font-semibold hover:underline"
                >
                  Back to Login
                </Link>
              </div>
              ...
              <form onSubmit={handleRecoveryRequest} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    autoComplete="email"
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-300 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-brand-blue-500"
                  />
                </div>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 bg-brand-blue-600 hover:bg-brand-blue-700 disabled:opacity-50 text-white font-semibold rounded-lg"
                >
            ...
            <div className="text-center space-y-4">
              ...
              <Link
                href={destination}
                className="inline-block bg-brand-blue-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-brand-blue-700 transition-colors"
              >
                Go to Dashboard
              </Link>
            </div>
