...
export const VIDEO_REGISTRY: Record<string, VideoRecord> = {
  ...
  'barber-hero': {
    ...
    thumbnail_url: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/barber-gallery-1.webp',
    duration: 'PT1M',
    upload_date: '2025-01-01',
  ...
  'cdl-hero': {
    ...
    thumbnail_url: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/hvac-technician.webp',
    duration: 'PT50S',
    upload_date: '2025-01-01',
  ...
  'hvac-hero': {
    ...
    upload_date: '2025-01-01',
    category: 'Skilled Trades',
    page_slugs: ['/programs/hvac-technician', '/programs/skilled-trades'],
    language: 'en',
    version: 1,
    status: 'live',
    updated_at: '2025-01-01T00:00:00Z',
  ...
  'programs-overview': {
    ...
    thumbnail_url: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/workforce-training.webp',
    duration: 'PT30S',
    upload_date: '2025-01-01',
    category: 'Overview',
    page_slugs: ['/programs'],
  ...
  'training-providers': {
    ...
    thumbnail_url: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/training-classroom.webp',
    duration: 'PT1M10S',
    upload_date: '2025-01-01',
    category: 'About',
  ...
  'getting-started': {
    ...
    thumbnail_url: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/admin-dashboard-hero.webp',
    duration: 'PT35S',
    upload_date: '2025-01-01',
    category: 'How To',
  ...
  'demo-lms-overview': {
    ...
    thumbnail_url: 'https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/demos-hero.webp',
    duration: 'PT15M',
    upload_date: '2025-01-01',
    category: 'Demo',
    page_slugs: ['/demos'],
