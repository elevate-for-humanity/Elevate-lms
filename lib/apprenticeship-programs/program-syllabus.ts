...
export type ProgramSyllabusInfo = {
  slug: ApprenticeshipProgramSlug;
  title: string;
  syllabusPath: string;
  rtiLabel: string;
...
export const APPRENTICESHIP_PROGRAM_SYLLABI: Record<ApprenticeshipProgramSlug, ProgramSyllabusInfo> = {
  ...
  'cosmetology-apprenticeship': {
    ...
    syllabusPath: '/docs/syllabi/cosmetology-apprenticeship.md',
