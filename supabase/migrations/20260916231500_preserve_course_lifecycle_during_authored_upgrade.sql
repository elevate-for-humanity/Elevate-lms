-- Keep authored-content upgrades separate from media/build completion.
-- Existing course lifecycle, publication, review, learner progress, and video ownership are preserved.
