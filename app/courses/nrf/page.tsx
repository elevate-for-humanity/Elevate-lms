          ...
          <div className="grid md:grid-cols-2 gap-6">
            {courses.map((course: any) => (
              ...
              >
                  ...
                  <ul className="text-sm text-black space-y-1">
                    {course.topics.map((topic, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <span className="text-brand-red-600 mt-1">•</span>
                        <span>{topic}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 bg-brand-red-600 hover:bg-brand-red-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors w-full justify-center"
                >
                  Enroll Now
                </Link>
              </div>
