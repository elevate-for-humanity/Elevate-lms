...
export const metadata: Metadata = {
  ...
  description:
    'Organize SAM.gov entity records, documents, compliance reminders, and registration preparation from an Elevate workspace. Final registration and federal approval remain on SAM.gov.',
  ...
  openGraph: {
    title: 'SAM.gov Manager | Elevate Store',
    description: 'Organize entity records, supporting documents, and compliance reminders before working in the official SAM.gov system.',
...
const jsonLd = {
  ...
  offers: [
    { '@type': 'Offer', price: '49', priceCurrency: 'USD', category: 'Starter monthly subscription' },
    { '@type': 'Offer', price: '149', priceCurrency: 'USD', category: 'Professional monthly subscription' },
    { '@type': 'Offer', price: '399', priceCurrency: 'USD', category: 'Enterprise monthly subscription' },
  ],
};
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="border-b border-slate-200 bg-slate-950 px-4 py-20 text-white">
        <div className="mx-auto max-w-5xl">
          <p className="text-sm font-bold uppercase tracking-widest text-brand-red-400">Government contracting tools</p>
          <h1 className="mt-3 max-w-4xl text-4xl font-black md:text-6xl">SAM.gov Manager</h1>
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
            Organize entity information, supporting documents, and compliance reminders in Elevate while keeping the official federal submission process where it belongs: SAM.gov.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link href={catalog.appHref} className="rounded-xl border border-white/30 px-6 py-3 font-bold text-white hover:bg-white/10">Open SAM.gov Manager</Link>
      ...
      <section className="border-y border-blue-200 bg-blue-50 px-4 py-12">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-2xl font-black text-blue-950">Important distinction</h2>
          <p className="mt-4 leading-7 text-blue-900">
            Elevate's SAM.gov Manager is not SAM.gov and does not issue UEIs, CAGE codes, federal registrations, contract awards, or government approvals. Official submission and approval remain with the applicable federal systems and agencies.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-14 text-center">
        <Link href={catalog.trialHref} className="inline-flex items-center gap-2 font-bold text-brand-red-700 hover:underline">Start the SAM.gov Manager trial <ArrowRight className="h-4 w-4" /></Link>
      </section>
    </main>
  );
}
