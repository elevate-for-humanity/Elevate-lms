      ...
      >
        <DocumentSection heading="Parties and Purpose" number={1}>
          ...
          <p className="mt-3">
            ...
            delivery site within the {PLATFORM_DEFAULTS.orgName} Training Network solely under the terms of
            this Agreement.
          </p>
          <p className="mt-3">
        ...
        <DocumentSection heading="Program Authority — What Elevate Controls" number={3}>
          <p>
            The following remain under the sole and exclusive authority of the Program Authority and
            Operating Company, regardless of the Host Facility's tier or duration of participation:
          </p>
          <ul>
          ...
          <p className="mt-3">
            The Host Facility may not modify curriculum, alter tuition, issue credentials, apply for
            workforce funding on behalf of Elevate programs, or enter into agreements on behalf of
            the Operating Company or Program Authority.
          </p>
        </DocumentSection>
        ...
        <DocumentSection heading="Host Facility Authorization Tiers" number={4}>
          ...
          <p className="text-sm text-slate-600 mb-3">
            Provides a dedicated physical training facility and full on-site operational support for
            the complete cohort duration.
          </p>

          <p className="font-semibold text-sm">
            Facility Standards (required before first cohort):
          </p>
          <ul>
            <li>
              Dedicated classroom or training space for the enrolled cohort — not shared with
              unrelated activities during training hours
            </li>
            ...
            <li>
              Physical environment compliant with local building codes and fire safety requirements
            </li>
            <li>ADA-accessible facility with accessible restrooms and entry</li>
            <li>
              Adequate lighting, ventilation, and temperature control for extended training sessions
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              cancellations require 14 days notice except in emergencies
            </li>
            <li>
              Designated on-site coordinator assigned for each cohort, available during all training
              hours
            </li>
            <li>
              Attendance monitoring and daily attendance records submitted to the Operating Company
              within 24 hours of each session
            </li>
            <li>Student supervision during all in-person training hours</li>
            <li>
              Immediate notification to the Operating Company of any safety incident, student
              concern, or facility issue
            </li>
          ...
          <ul>
            <li>
              Commercial general liability insurance: minimum $1,000,000 per occurrence / $2,000,000
              aggregate
            </li>
            <li>Facility/property insurance covering the training space and its contents</li>
            <li>
              Workers' compensation insurance if any Host Facility staff are present during training
            </li>
            <li>Operating Company named as additional insured on the general liability policy</li>
            <li>
              Proof of insurance provided to Operating Company before first cohort and upon each
              annual renewal
            </li>
          </ul>
          ...
          <p className="text-sm">
            One-third (1/3) of net program revenue per cohort delivered at the facility. Net revenue
            = gross tuition collected minus operational costs defined in Section 6. Payment within
            30 days of cohort completion and written reconciliation.
          </p>
          ...
          <ul>
            ...
            <li>
              Attendance tracking and records submitted to Operating Company within 24 hours of each
              session
            </li>
          ...
          <p className="font-semibold text-sm mt-4">Compensation:</p>
          <p className="text-sm">
            Fifteen percent (15%) of net program revenue per cohort supported. Payment within 30
            days of cohort completion and written reconciliation.
          </p>
          ...
          <ul>
            ...
            <li>
              Accurate representation of Elevate programs — no misrepresentation of credentials,
              outcomes, or funding eligibility
            </li>
          </ul>

          <p className="font-semibold text-sm mt-4">Compensation:</p>
          <p className="text-sm">
            Flat referral fee of <strong>$250–$500 per enrolled student</strong> as specified in
            Schedule A. Paid upon confirmed enrollment and initial tuition payment. No revenue
            share.
          </p>
        </DocumentSection>
        ...
        <DocumentSection heading="Student Enrollment and Ownership" number={5}>
          ...
          <p className="mt-3">
            ...
            with the Host Facility is governed by FERPA and requires written student consent limited
            to the Host Facility's operational role.
          </p>
          <p className="mt-3">
            The Host Facility may not contact enrolled students for purposes outside its designated
            tier responsibilities without written authorization from the Operating Company.
          </p>
        </DocumentSection>
        ...
        <DocumentSection heading="Operational Costs and Net Revenue" number={6}>
          ...
          <p className="mt-3">
            The Operating Company provides a written cost reconciliation within 15 days of cohort
            completion. The Host Facility may request supporting documentation within 10 days of
            receipt.
          </p>
        </DocumentSection>
        ...
        <DocumentSection heading="Intellectual Property and Non-Replication" number={7}>
          ...
          <p className="mt-3">
            ...
            <strong>three (3) years following termination</strong>, the Host Facility agrees not to:
          </p>
          <ul>
            <li>
              Replicate, reproduce, or develop a substantially similar training program using
              materials, systems, or methods provided through this collaboration
            </li>
            <li>
              Solicit or redirect enrolled students, instructors, credential partners, or employers
              into a competing program derived from the Elevate training model
            </li>
            <li>
            ...
            <li>
              License, sublicense, or transfer any Elevate program materials to any third party
            </li>
          </ul>
        </DocumentSection>
        ...
        <DocumentSection heading="Compliance and Reporting" number={8}>
          ...
          <ul>
            ...
            <li>
              Cooperation with any program audit or quality review within 5 business days of request
            </li>
          </ul>
          <p className="mt-3">
        ...
        <DocumentSection heading="Site Approval and Quality Standards" number={9}>
          <p>
            Host Facility authorization is granted by the Operating Company following a site review.
            Authorization may be suspended or revoked if:
          </p>
          <ul>
            ...
            <li>
              The Host Facility operates outside its designated tier without written authorization
            </li>
            <li>
              The Host Facility misrepresents its relationship with Elevate to students, funders, or
              the public
            </li>
          </ul>
          <p className="mt-3">
            The Operating Company will provide written notice of any compliance concern and allow 10
            business days for a written response before suspending authorization, except in cases
            involving immediate safety risk or material misrepresentation.
          </p>
        </DocumentSection>
        ...
        <DocumentSection heading="Term and Termination" number={10}>
          ...
          <p className="mt-3">
            The Operating Company may terminate immediately upon written notice if the Host
            Facility:
          </p>
          <ul>
            ...
            <li>
              Engages in conduct that creates legal, reputational, or regulatory risk for the
              Training Network
            </li>
          </ul>
          <p className="mt-3">
        ...
        <DocumentSection heading="Governing Law and Dispute Resolution" number={11}>
          ...
          <p className="mt-3">
            ...
            governed by Indiana law. The Operating Company's foreign entity registration in the Host
            Facility's state does not change the governing law of this Agreement.
          </p>
        </DocumentSection>
