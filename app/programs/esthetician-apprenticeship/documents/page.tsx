    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="max-w-2xl mx-auto px-6 py-8">
            ...
            <div className="mb-4">
              ...
              {governmentId ? (
                <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                  ...
                  {governmentId.status === 'uploading' && <span className="text-sm text-brand-red-600">Uploading...</span>}
                ...
                <label className="flex items-center justify-center gap-2 p-4 border-2 border-dashed border-slate-300 rounded-lg cursor-pointer hover:border-brand-red-500 hover:bg-brand-red-50 transition">
        ...
        <button
          ...
          className="w-full py-4 bg-brand-red-600 text-white font-bold text-lg rounded-xl disabled:opacity-50 disabled:cursor-not-allowed hover:bg-brand-red-700 transition"
        >
