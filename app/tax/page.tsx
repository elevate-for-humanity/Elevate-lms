      ...
      <section className="py-4 bg-gray-100 border-b">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Link href="/tax" className="px-4 py-2 bg-brand-red-100 text-brand-red-800 rounded-full text-sm font-medium hover:bg-brand-red-200 transition-colors">
              What to Bring
            </Link>
            ...
            <div className="bg-white p-6 rounded-xl border-2 border-gray-200">
              ...
              <div className="space-y-2">
                <a
                  ...
                  className="block text-sm text-brand-red-600 hover:underline"
                >
                  IRS Free Tax Prep →
                </a>
                <a
      ...
      <section className="py-20 bg-blue-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="mt-8 text-blue-200">
            ...
            Questions? Call us at Contact Us
          </p>
        </div>
      </section>
      {/* CTA Section */}
