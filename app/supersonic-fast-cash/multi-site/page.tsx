        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6">
              Own Your Own
              <span className="block text-brand-red-300">Tax Preparation Office</span>
            </h1>
      ...
      <section className="py-12 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-black text-brand-red-400">15+</div>
              <div className="text-gray-400">Active Locations</div>
            </div>
            <div>
              <div className="text-4xl font-black text-brand-red-400">50K+</div>
              <div className="text-gray-400">Returns Filed</div>
            </div>
            <div>
              <div className="text-4xl font-black text-brand-red-400">98%</div>
              <div className="text-gray-400">Partner Retention</div>
            </div>
            <div>
              <div className="text-4xl font-black text-brand-red-400">$75K+</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, idx) => (
              <div key={idx} className="bg-gray-50 rounded-2xl p-6">
                <div className="w-14 h-14 bg-brand-red-100 rounded-xl flex items-center justify-center mb-4">
                  <benefit.icon className="w-7 h-7 text-brand-red-600" />
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="text-center mb-8">
                <Zap className="w-16 h-16 text-brand-red-600 mx-auto mb-4" />
              ...
              <Link
                href="/supersonic-fast-cash/multi-site/apply"
                className="block w-full bg-brand-red-600 text-white text-center py-4 rounded-xl font-bold hover:bg-brand-red-700 transition-colors"
              >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {steps.map((item) => (
              <div key={item.step} className="text-center">
                <div className="w-16 h-16 bg-brand-red-600 text-white rounded-full flex items-center justify-center font-black text-2xl mx-auto mb-4">
                  {item.step}
                </div>
      ...
      <section className="py-20 bg-slate-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/supersonic-fast-cash/contact"
              className="inline-flex items-center justify-center gap-2 bg-brand-red-500/30 text-white px-10 py-5 rounded-xl font-bold text-xl hover:bg-brand-red-500/40 transition-colors border border-white/30"
            >
