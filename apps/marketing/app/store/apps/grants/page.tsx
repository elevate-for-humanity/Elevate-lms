...
export default function GrantsStorePage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="border-b border-slate-200 bg-slate-950 px-4 py-20 text-white"><div className="mx-auto max-w-5xl"><p className="text-sm font-bold uppercase tracking-widest text-brand-red-400">Funding tools</p><h1 className="mt-3 max-w-4xl text-4xl font-black md:text-6xl">Grants Discovery & Management</h1><p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">Organize grant opportunities, saved records, deadlines, and application activity in one account-based workspace.</p><div className="mt-8 flex flex-wrap gap-3"><Link href={catalog.trialHref} className="rounded-xl bg-brand-red-600 px-6 py-3 font-bold text-white hover:bg-brand-red-700">Start {catalog.trialDays}-day trial</Link><Link href={catalog.appHref} className="rounded-xl border border-white/30 px-6 py-3 font-bold text-white hover:bg-white/10">Open Grants workspace</Link><Link href="/store/apps" className="rounded-xl border border-white/30 px-6 py-3 font-bold text-white hover:bg-white/10">Search all apps</Link></div></div></section>
