...
import { Scissors, DollarSign, Users, CheckCircle, Phone, Building2, Calendar } from 'lucide-react';
import { PLATFORM_DEFAULTS } from '@/lib/config/platform-config';

export const metadata: Metadata = {
  title: `Barber Host Shop Partnership | ${PLATFORM_DEFAULTS.orgName}`,
  description: 'Host a barber apprenticeship. Partner with us to train the next generation of barber professionals while growing your business.',
};

const BENEFITS = [
  { icon: DollarSign, title: 'Earn While Training', desc: 'Apprentices work in your barbershop from day one, bringing in revenue while they learn.' },
...
const APPRENTICE_INFO = [
  ...
  'Committed to completing 2,000+ hours of training',
  'Passion for the barber industry and customer service',
];
...
export default function BarberHostShopPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* HERO */}
      <section className="relative flex items-end overflow-hidden bg-gradient-to-br from-slate-900 via-brand-red-900 to-slate-900" style={{ minHeight: 'clamp(260px, 45vw, 520px)' }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 pb-8 sm:pb-12 w-full text-white">
          ...
          <span className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-4 bg-brand-red-500/20 text-brand-red-300 border border-brand-red-500/30">
            <Scissors className="w-4 h-4" /> Host a Site
          </span>
          <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold leading-tight mb-3">Host a Barber Apprenticeship</h1>
          <p className="text-lg text-white/70 max-w-2xl">
            Partner with us to train the next generation of barber professionals while building your team and growing your business.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">Why Become a Host Barbershop?</h2>
        ...
        <section className="mb-16">
          ...
          <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { step: '1', title: 'Apply', desc: 'Complete our host barbershop application. We review your barbershop and mentor qualifications.' },
                { step: '2', title: 'Match', desc: 'We match you with an apprentice who fits your business culture and services.' },
                { step: '3', title: 'Train', desc: 'Your apprentice works in your barbershop while attending our RTI classroom training.' },
              ].map((item) => (
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="bg-slate-900 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-white">Host Barbershop Requirements</h2>
              </div>
            </div>
            <div className="p-6">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">What Host Barbershops Can Expect</h2>
          <div className="bg-gradient-to-br from-slate-900 to-brand-red-900 rounded-2xl p-8 text-white">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-bold text-lg mb-4 text-brand-red-200">What You Provide</h3>
              ...
              <div>
                <h3 className="font-bold text-lg mb-4 text-brand-red-200">What Elevate Handles</h3>
                <ul className="space-y-2 text-slate-200 text-sm">
        ...
        <section className="bg-slate-50 rounded-2xl p-8 sm:p-12 border border-slate-200 text-center">
          ...
          <p className="text-slate-600 mb-8 max-w-xl mx-auto">
            Apply to become a host barbershop partner. We&apos;ll review your application and contact you within 2-3 business days.
          </p>
