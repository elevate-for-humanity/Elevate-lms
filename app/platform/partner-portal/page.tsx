    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-brand-red-600 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-brand-red-100 mb-8">Everything you need to manage your training programs</p>
          <Link href="/partners/login" className="inline-flex items-center gap-2 bg-white text-brand-red-600 px-8 py-4 rounded-full font-bold hover:bg-brand-red-50">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((f, i) => (
              <div key={i} className="bg-white rounded-xl p-6 shadow-sm border flex items-start gap-4">
                <f.icon className="w-10 h-10 text-brand-red-600 flex-shrink-0" />
                <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link href="/partners/join" className="inline-flex items-center gap-2 bg-brand-red-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-brand-red-700">
            Apply Now
          </Link>
        </div>
      </section>
