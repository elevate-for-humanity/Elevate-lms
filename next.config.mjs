    ...
    const securityHeaders = [
      ...
      },
      {
        ...
        value: [
          ...
          "connect-src 'self' https://*.supabase.co https://api.stripe.com wss://*.supabase.co https://education.intuit.com https://cdn.intuit4education.a.intuit.com",
          "frame-src 'self' https://www.youtube.com https://player.vimeo.com https://js.stripe.com https://intuit4education.app.intuit.com https://apps.irs.gov",
          "media-src * data: blob:",
