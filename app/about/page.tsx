      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex items-start gap-4">
              <div className="relative w-20 h-20 flex-shrink-0 bg-brand-red-100 rounded-lg flex items-center justify-center">
                <span className="text-brand-red-600 font-bold text-sm">ISBCE</span>
              </div>
              <div>
