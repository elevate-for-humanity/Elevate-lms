      ...
      <div className="bg-white border-b border-slate-200 py-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-600 mt-2">
            Indianapolis workforce initiative — funded career training for Marion County residents.
          </p>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                <strong>Job Ready Indy</strong> is an Indianapolis-based workforce initiative that
                connects Marion County residents to funded career training, industry credentials,
                and employer placement. The program is designed to remove financial and logistical
            ...
            <div>
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200">
                <p className="text-slate-700 leading-relaxed">
                  Job Ready Indy funding may cover tuition and training fees, certification and exam
                  fees, and supportive services for eligible Marion County residents. Coverage
                  depends on your eligibility and the program you enroll in. Contact our enrollment
                  team to confirm what applies to your situation.
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200">
                <p className="text-slate-700 leading-relaxed">
                  Job Ready Indy is primarily for Marion County residents who are unemployed,
                  underemployed, or seeking to advance their careers. You must be at least 18 years
                  of age and not currently enrolled in a conflicting funded program. Our enrollment
                  team will verify your eligibility at no cost.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                step: '3',
                title: 'Get Enrolled',
                desc: 'We handle the paperwork and coordinate with Job Ready Indy on your behalf. You focus on showing up and completing your training.',
              },
              {
                step: '4',
                title: 'Earn Your Credential',
                desc: 'Complete your program and earn a nationally recognized credential. Our career services team connects you with employer partners.',
              },
            ].map((s) => (
      ...
      <section className="py-16 sm:py-24 bg-brand-blue-700">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-10">
            Job Ready Indy funding may be available for your career training. Apply today and our
            team will confirm your eligibility.
          </p>
