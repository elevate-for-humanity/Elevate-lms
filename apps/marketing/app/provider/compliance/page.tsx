...
export default async function ProviderCompliancePage() {
  ...
  const expiring = categorized.filter(
    (a) => a.daysLeft != null && a.daysLeft > 0 && a.daysLeft <= 30,
  );
    ...
    <div className="p-6 max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm mt-0.5">
          Upload and manage required compliance documents. All documents are reviewed by Elevate
          staff.
        </p>
      </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-400 mt-0.5">
                    ...
                    {artifact.issued_at &&
                      ` · Issued ${new Date(artifact.issued_at).toLocaleDateString()}`}
                  </div>
                </div>
              </div>
