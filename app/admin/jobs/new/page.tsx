...
<div className="max-w-3xl mx-auto">
        <Link href="/admin/jobs" className="flex items-center gap-2 text-gray-600 hover:text-brand-red-600 mb-6">
        ...
        <form className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-3">
              {['Veterans', 'SNAP Recipients', 'Long-term Unemployed', 'Ex-Felons', 'TANF Recipients', 'SSI Recipients', 'Vocational Rehabilitation', 'Summer Youth'].map((group) => (
                <label key={group} className="flex items-center gap-2 p-3 border rounded-lg cursor-pointer hover:border-brand-red-300">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:border-brand-red-300">
                <input type="radio" name="status" defaultChecked className="w-4 h-4 text-brand-red-600" />
                <div>
              ...
              <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:border-brand-red-300">
                <input type="radio" name="status" className="w-4 h-4 text-brand-red-600" />
                <div>
