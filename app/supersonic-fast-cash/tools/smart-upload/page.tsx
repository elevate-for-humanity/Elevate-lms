...
<div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-brand-red-100 text-brand-red-700 px-4 py-2 rounded-full mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 my-12">
          <div className="bg-white rounded-xl shadow-sm p-6">
            <Sparkles className="w-10 h-10 text-brand-red-600 mb-4" />
