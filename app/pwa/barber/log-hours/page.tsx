    ...
    <div className="min-h-screen bg-slate-900">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-800 border border-slate-700 rounded-xl pl-12 pr-4 py-4 text-white focus:ring-2 focus:ring-brand-red-500 focus:border-transparent"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g., 8"
                  className="w-full bg-slate-800 border border-slate-700 rounded-xl pl-12 pr-4 py-4 text-white placeholder-slate-500 focus:ring-2 focus:ring-brand-red-500 focus:border-transparent"
                  required
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-4 text-white placeholder-slate-500 focus:ring-2 focus:ring-brand-red-500 focus:border-transparent resize-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-brand-red-600 text-white font-bold py-4 rounded-xl hover:bg-brand-red-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {submitting ? (
                <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-slate-800 border-t border-slate-700 px-6 py-3 safe-area-inset-bottom">
        <div className="flex justify-around">
          ...
          <Link href="/pwa/barber/log-hours" className="flex flex-col items-center gap-1 text-brand-red-400">
