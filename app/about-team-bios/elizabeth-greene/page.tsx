...
export const metadata: Metadata = {
  title: 'Elizabeth Greene | Our Team | {PLATFORM_DEFAULTS.orgName}',
          ...
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="text-slate-800 space-y-4 text-[16px] leading-relaxed">
                <p>Elizabeth Greene is a U.S. Army veteran who served as a Unit Supply Specialist, and the founder of {PLATFORM_DEFAULTS.orgName} Career & Technical Institute, a workforce development organization in Indianapolis serving justice-involved individuals, low-income families, veterans, and anyone facing barriers to employment.</p>
