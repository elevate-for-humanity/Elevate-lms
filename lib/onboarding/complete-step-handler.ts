...
/**
 * Canonical learner onboarding mutation used by both Marketing pre-LMS pages
 * and the LMS onboarding flow. The live onboarding_progress table is one row
 * per user with milestone booleans; it is not a per-step event table.
 */
