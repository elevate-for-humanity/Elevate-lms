...
export default async function GrantsStorePage({ searchParams }: { searchParams: Promise<{ reason?: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div id="guided-setup"><ZeroCodeSetup productName="Grants Discovery" intro="Describe your organization and funding goal in plain English. Elevate carries the context into the grant workspace so discovery starts with your actual mission and funding need." questions={setupQuestions} startHref={catalog.appHref} trialHref={catalog.trialHref} advancedNote="Professional and Enterprise can add broader search capacity, application tracking, budget tools, team access, API and compliance automation where included by plan." /></div>
