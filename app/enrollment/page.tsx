...
const STEPS = [
  {
    step: '1',
    title: 'Apply',
    desc: 'Complete the student application. Takes about 5 minutes.',
    href: '/apply/student',
  ...
  },
  {
    step: '2',
    title: 'Review',
    desc: 'Our team reviews your application and contacts you within 1–2 business days.',
    href: null,
    cta: null,
  },
  {
    step: '3',
    title: 'Enroll',
    desc: 'Sign the enrollment agreement, submit required documents, and confirm funding.',
    href: null,
    cta: null,
  },
  {
    ...
    desc: 'Complete orientation, access the LMS, and begin your program.',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <HeroVideo
        ...
        ctas={[heroBanners['enrollment'].primaryCta, heroBanners['enrollment'].secondaryCta].filter(
          Boolean,
        )}
        ...
        <div className="bg-white border-t py-10 text-center px-4">
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link
              ...
              className="bg-brand-green-600 hover:bg-brand-green-700 text-white font-bold px-8 py-4 rounded-xl transition-colors text-base"
            >
      ...
      <section className="bg-slate-900 py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-white text-center mb-12 max-w-xl mx-auto">
            From application to first day of class in as little as 5 business days.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {STEPS.map((s, i) => (
              <div key={s.step} className="relative text-center">
                <div className="w-14 h-14 rounded-full bg-brand-blue-600 text-white flex items-center justify-center text-xl font-black mx-auto mb-4">
                  {s.step}
                </div>
                {i < 3 && (
                  <div className="hidden md:block absolute top-7 left-[calc(50%+28px)] right-[calc(-50%+28px)] h-px bg-white/20" />
                )}
                ...
                {s.href && s.cta && (
                  <Link
                    href={s.href}
                    className="text-xs font-bold text-white underline underline-offset-2 hover:text-brand-blue-300 transition-colors"
                  >
                    {s.cta} →
                  </Link>
                )}
      ...
      <section className="py-16 px-4">
        ...
        {/* IMAGE-CONTRACT: placeholder-review required (blurDataURL or approved fallback) */}
                ...
                <div className="p-5 flex flex-col flex-1">
                  <span className="inline-block px-2.5 py-0.5 rounded-full text-xs font-bold bg-brand-blue-100 text-brand-blue-800 mb-2 self-start">
                    {p.tag}
                  </span>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <span className="text-[10px] px-2 py-0.5 rounded-full bg-brand-green-100 text-brand-green-800 font-bold">
                      WIOA Eligible
                    </span>
                    <span className="text-[10px] px-2 py-0.5 rounded-full bg-brand-blue-100 text-brand-blue-800 font-bold">
                      ETPL Listed
                    </span>
                  </div>
      ...
      <section className="bg-slate-50 py-16 px-4 border-t border-slate-200">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-black text-center mb-10 max-w-2xl mx-auto">
            Most eligible Indiana residents pay $0. Multiple funding sources available.
          </p>
            ...
            {FUNDING.map((f) => (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-brand-green-100 text-brand-green-800">
                    {f.badge}
                  </span>
                </div>
                ...
                <Link
                  href={f.href}
                  className="text-sm font-bold text-brand-blue-600 hover:text-brand-blue-700 flex items-center gap-1"
                >
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-white mb-4 leading-relaxed">
                  Out-of-state residents, those who have exhausted WIOA benefits, or those who don't
                  meet income requirements can still enroll through our self-pay and financing
                  options.
                </p>
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    href="/apply/student?funding=self-pay"
      ...
      <section className="bg-brand-blue-700 py-16 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-white text-lg mb-8">
            Applications are reviewed within 1–2 business days. No application fee.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/apply/student"
              className="bg-white text-black font-black px-10 py-4 rounded-xl hover:bg-slate-100 transition-colors text-lg"
            >
              Apply Now
            </Link>
            <a
