    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-brand-green-600 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-brand-green-100 mb-8">
            Receive your refunds and stipends faster with the Elevate prepaid card
          </p>
        </div>
      </section>
            ...
            {[
              {
                icon: DollarSign,
                title: 'Fast Deposits',
                desc: 'Get your money up to 2 days faster than traditional banks',
              },
              {
                icon: Shield,
                title: 'Secure',
                desc: 'Protected by bank-level security and fraud monitoring',
              },
              {
                icon: Smartphone,
                title: 'Mobile App',
                desc: 'Check your balance and transactions anytime',
              },
              {
                icon: Circle,
                title: 'No Fees',
                desc: 'No monthly fees or minimum balance requirements',
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-6 shadow-sm border flex items-start gap-4"
              >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <a
            href="/contact"
            className="inline-flex items-center gap-2 bg-brand-green-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-brand-green-700"
          >
            Contact Us
          </a>
        </div>
