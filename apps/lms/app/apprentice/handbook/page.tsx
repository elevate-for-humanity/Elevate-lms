  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-12">
      ...
      <div className="mx-auto max-w-5xl space-y-6 px-4 py-8 sm:px-6">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8"><h2 className="text-2xl font-black text-slate-950">Clocking in, clocking out, and weekly hour limits</h2><ul className="mt-4 space-y-3 font-medium leading-7 text-slate-700"><li>• Clock in only after arriving inside the approved Host Shop radius. Clock out before leaving that radius.</li><li>• If you try to clock in or out while outside the radius, the action is blocked, no time is recorded, and you must return to the approved radius and try again.</li><li>• OJL is supervised, hands-on work at the Host Shop. The weekly OJL limit is <strong>{APPRENTICE_TIME_POLICY.weeklyOjlMaxHours} hours</strong>.</li><li>• RTI/theory is assigned instruction and verified learning activity—not login time alone. The weekly target is <strong>{APPRENTICE_TIME_POLICY.weeklyTheoryTargetHours} hours</strong>, and the weekly maximum is <strong>{APPRENTICE_TIME_POLICY.weeklyTheoryMaxHours} hours</strong>.</li><li>• Combined verified OJL and RTI may not exceed <strong>{APPRENTICE_TIME_POLICY.weeklyCombinedMaxHours} hours per week</strong>.</li><li>• Submit truthful records; never backdate, duplicate, share credentials, spoof location, or claim time not worked.</li><li>• The Host Shop reviews work entries and may approve, reject, or require correction. Work hours do not replace competency verification or RTI completion.</li></ul><Link href={APPRENTICE_TIMECLOCK_URL} className="mt-5 inline-flex rounded-xl border border-slate-300 bg-white px-4 py-2.5 font-black text-slate-900">Open geofenced timeclock</Link></section>
  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-12">
      ...
      <div className="mx-auto max-w-5xl space-y-6 px-4 py-8 sm:px-6">
        ...
        <Policy title="Clocking in, clocking out, and weekly hour limits">
          Clock in only after arriving inside the approved Host Salon radius, and clock out before leaving that radius. An attempt made outside the radius is blocked and records no time; return to the approved radius and try again. OJL is supervised, hands-on work at the Host Salon and is limited to <strong>{APPRENTICE_TIME_POLICY.weeklyOjlMaxHours} hours per week</strong>. RTI/theory has a <strong>{APPRENTICE_TIME_POLICY.weeklyTheoryTargetHours}-hour weekly target</strong> and a <strong>{APPRENTICE_TIME_POLICY.weeklyTheoryMaxHours}-hour weekly maximum</strong>. Combined verified OJL and RTI may not exceed <strong>{APPRENTICE_TIME_POLICY.weeklyCombinedMaxHours} hours per week</strong>. Login time alone does not earn theory credit. Never share credentials, spoof location, backdate time, duplicate entries, or report hours not worked.
        </Policy>
        <Policy title="Payments and automatic billing">
          Self-pay learners must review the disclosed tuition schedule, submit the signed recurring-payment release, and approve the PayPal billing agreement. PayPal collects the scheduled tuition automatically, and QuickBooks records each confirmed payment. Learners do not pay a separate invoice every week. Receipts and payment progress appear in Billing. Any access action for nonpayment follows the signed enrollment agreement; completed and approved learner records are retained.
