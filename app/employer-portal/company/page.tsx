...
export default async function CompanyProfilePage() {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-sm p-8 text-center">
          <div className="w-16 h-16 bg-brand-red-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <Building className="w-8 h-8 text-brand-red-600" />
          </div>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700 transition"
          >
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Cover Image */}
      <div className="relative h-64 bg-brand-red-600">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex flex-col md:flex-row md:items-end gap-6">
              <div className="relative -mt-20 md:-mt-24">
                ...
                <Link 
                  href="/employer-portal/company/setup"
                  className="absolute bottom-0 right-0 p-2 bg-brand-red-600 text-white rounded-full hover:bg-brand-red-700 transition"
                >
                  <Camera className="w-4 h-4" />
                </Link>
              </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-xl shadow-sm p-6 text-center">
                <Briefcase className="w-8 h-8 text-brand-red-600 mx-auto mb-2" />
              ...
              <div className="space-y-4">
                {companyData.website && (
                  <div className="flex items-center gap-3">
                    ...
                    <a href={`https://${companyData.website}`} target="_blank" rel="noopener noreferrer" className="text-brand-red-600 hover:underline">
                      {companyData.website}
                    </a>
                  </div>
                )}
                {companyData.phone && (
                  <div className="flex items-center gap-3">
                    ...
                    <a href={`tel:${companyData.phone}`} className="text-gray-700 hover:text-brand-red-600">
                      {companyData.phone}
                    </a>
                  </div>
                )}
                {companyData.email && (
                  <div className="flex items-center gap-3">
                    ...
                    <a href={`mailto:${companyData.email}`} className="text-gray-700 hover:text-brand-red-600">
                      {companyData.email}
                    </a>
                  </div>
                )}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                <Link
                  ...
                  className="block w-full px-4 py-3 bg-brand-red-600 text-white text-center rounded-lg hover:bg-brand-red-700 transition"
                >
                  Post New Job
                </Link>
                <Link
                  href="/employer-portal/candidates"
                  className="block w-full px-4 py-3 border border-brand-red-600 text-brand-red-600 text-center rounded-lg hover:bg-brand-red-50 transition"
                >
                  Browse Candidates
                </Link>
                <Link
