          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <label className={`flex items-center justify-center p-4 border-2 rounded-lg cursor-pointer transition ${formData.type === 'rti' ? 'border-brand-red-600 bg-brand-red-50' : 'border-gray-300 hover:border-gray-400'}`}>
                  ...
                  <Award className={`w-6 h-6 mr-2 ${formData.type === 'rti' ? 'text-brand-red-600' : 'text-gray-400'}`} />
                  <div className="text-left">
