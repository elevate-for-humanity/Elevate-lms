  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px]">
          <Image
            placeholder="blur"
            blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAFUlEQVR42mP8z8BQDwADhQGAWjR9awAAAABJRU5ErkJggg==" src="/images/og-image.webp" alt="Elevate store" fill sizes="100vw" className="object-cover" priority />
      </section>
      {/* Header */}
