...
{/* Breadcrumb */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              <Circle className="w-10 h-10 text-brand-red-600 mx-auto mb-3" />
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              <Globe className="w-10 h-10 text-brand-red-600 mx-auto mb-3" />
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              <MapPin className="w-10 h-10 text-brand-red-600 mx-auto mb-3" />
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              <Shield className="w-10 h-10 text-brand-red-600 mx-auto mb-3" />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-brand-red-600 rounded-2xl p-8 text-white">
              <div className="flex justify-between items-start mb-12">
                <div>
                  <p className="text-brand-red-200 text-sm">Prepaid Visa</p>
                  <p className="text-2xl font-bold">EPS Financial</p>
                </div>
                <CreditCard className="w-12 h-12 text-brand-red-200" />
              </div>
              <div className="mb-8">
                <p className="text-brand-red-200 text-sm mb-1">Card Number</p>
                <p className="text-xl tracking-widest">**** **** **** 1234</p>
              </div>
              <div className="flex justify-between">
                <div>
                  <p className="text-brand-red-200 text-xs">VALID THRU</p>
                  <p>12/28</p>
                </div>
                <div className="text-right">
                  <p className="text-brand-red-200 text-xs">CVV</p>
                  <p>***</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-brand-red-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                1
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  <Smartphone className="w-6 h-6 text-brand-red-600 mr-3" />
                  <span className="text-gray-700">Real-time balance updates</span>
                </li>
                <li className="flex items-center">
                  <MapPin className="w-6 h-6 text-brand-red-600 mr-3" />
                  <span className="text-gray-700">Find fee-free ATMs nearby</span>
                </li>
                <li className="flex items-center">
                  <Shield className="w-6 h-6 text-brand-red-600 mr-3" />
                  <span className="text-gray-700">Lock/unlock your card instantly</span>
                </li>
                <li className="flex items-center">
                  <DollarSign className="w-6 h-6 text-brand-red-600 mr-3" />
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="text-center">
                <Smartphone className="w-24 h-24 text-brand-red-600 mx-auto mb-6" />
      ...
      <section className="py-16 bg-brand-red-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-brand-red-100">
            No bank account needed. Start using your refund right away.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/tax"
              className="bg-white hover:bg-gray-100 text-brand-red-700 px-8 py-4 rounded-lg text-lg font-bold transition-all inline-flex items-center justify-center"
            >
              File Your Taxes <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
            <Link
              href="/banking"
              className="bg-brand-red-600 hover:bg-brand-red-500 text-white px-8 py-4 rounded-lg text-lg font-bold transition-all border-2 border-white"
            >
