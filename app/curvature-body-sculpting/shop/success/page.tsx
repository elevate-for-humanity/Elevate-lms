    ...
    <div className="min-h-screen bg-pink-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
        ...
        <div className="bg-brand-red-50 rounded-lg p-4 mb-6">
          <div className="flex items-center justify-center gap-2 text-brand-red-700">
            <Package className="w-5 h-5" />
            <span className="font-medium">Shipping Confirmation</span>
          </div>
          <p className="text-brand-red-600 text-sm mt-2">
        ...
        <div className="space-y-3">
          <Link
            ...
            className="flex items-center justify-center gap-2 w-full py-3 bg-brand-red-600 text-white font-semibold rounded-lg hover:bg-brand-red-700 transition"
          >
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-sm text-gray-500">
            ...
            <a href="mailto:curvaturebodysculpting@gmail.com" className="text-brand-red-600 hover:underline">
