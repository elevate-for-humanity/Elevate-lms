        ...
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-3 sm:p-5">
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-2 sm:gap-3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-brand-red-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Video className="w-4 h-4 sm:w-5 sm:h-5 text-brand-red-600" />
                  </div>
                  <div className="text-center sm:text-left">
                  ...
                  {hours.slice(0, 5).map((entry: any) => (
                    <div key={entry.id} className="flex items-center justify-between p-3 sm:p-4 gap-2">
                      <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
                        <div className={`w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full flex-shrink-0 ${entry.hour_type === 'OJT' ? 'bg-green-500' : 'bg-brand-red-500'}`} />
                        <div className="min-w-0">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-5">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-1 gap-2">
                ...
                <Link href="/student/certifications" className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 text-left hover:bg-slate-50 rounded-lg transition">
                  <Award className="w-4 h-4 sm:w-5 sm:h-5 text-brand-red-600 flex-shrink-0" />
