  ...
  return (
    ...
    >
        <header className="flex items-center gap-2 bg-gradient-to-r from-cyan-50 via-white to-orange-50 p-3 sm:gap-3 sm:p-4">
          ...
          <button type="button" onClick={() => { stop(); setOpen(false); }} className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white text-slate-800 shadow-sm" aria-label="Minimize PARIS"><X className="h-5 w-5" /></button>
        </header>
