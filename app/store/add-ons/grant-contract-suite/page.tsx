...
export const dynamic = 'force-dynamic'; // deploy-trigger: 20260518174229
...
const PIPELINE = [
  ...
  { icon: ShieldCheck,  step: '4', label: 'Review',   desc: 'Admin approves every field — AI narrative flagged, exact facts never invented' },
