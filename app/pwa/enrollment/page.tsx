  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-48 sm:h-56 overflow-hidden">
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/demo-page-3.webp" alt="Student enrollment" fill className="object-cover" priority  sizes="100vw" />
