...
export default async function AdminsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero */}
      <section className="bg-brand-red-600 text-white py-16">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {adminTools.map((tool, index) => {
              ...
              return (
                ...
                >
                  <Icon className="w-10 h-10 text-brand-red-600 mx-auto mb-3" />
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {displayResources.map((resource: any, index: number) => (
                  <div key={index} className="bg-white rounded-xl p-6 border hover:shadow-md transition">
                    ...
                    <a
                      href={resource.url || '#'}
                      className="inline-flex items-center gap-2 text-brand-red-600 font-medium hover:underline"
                    >
          ...
          <div className="space-y-6">
            ...
            <section className="bg-white rounded-xl border p-6">
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/admin/dashboard" className="text-brand-red-600 hover:underline">
                    Admin Dashboard
                  </Link>
                </li>
                <li>
                  <Link href="/admin/users" className="text-brand-red-600 hover:underline">
                    User Management
                  </Link>
                </li>
                <li>
                  <Link href="/admin/reports" className="text-brand-red-600 hover:underline">
                    Reports & Analytics
                  </Link>
                </li>
                <li>
                  <Link href="/help/admin" className="text-brand-red-600 hover:underline">
                    Help Center
                  </Link>
                </li>
              </ul>
            ...
            {/* Support */}
            <section className="bg-brand-red-50 rounded-xl p-6">
              ...
              <Link
                ...
                className="inline-block bg-brand-red-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-brand-red-700 transition"
              >
                Contact Support
              </Link>
            </section>
