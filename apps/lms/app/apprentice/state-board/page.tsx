          ...
          <div className="bg-emerald-600 rounded-2xl p-6 text-white flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-emerald-100 text-sm mt-0.5">
                All requirements complete. Schedule your exam below.
              </p>
            </div>
          </div>
        ) : (
          ...
          <div className="px-5 py-4 border-b border-slate-100">
            <div className="flex items-center justify-between gap-4">
              ...
              {lmsComplete ? (
                ...
                <Link
                  href="/lms/dashboard"
                  className="text-xs font-semibold text-purple-700 bg-purple-50 border border-purple-200 px-2.5 py-1 rounded-full hover:bg-purple-100 transition-colors whitespace-nowrap"
                >
                  Open LMS →
                </Link>
              )}
          ...
          <div className="px-5 py-4 border-b border-slate-100">
            <div className="flex items-center justify-between gap-4">
              ...
              <Link
                ...
                className="text-xs font-semibold text-slate-600 bg-slate-100 border border-slate-200 px-2.5 py-1 rounded-full hover:bg-slate-200 transition-colors whitespace-nowrap"
              >
                View skills →
              </Link>
            </div>
            ...
            <div className="p-5 space-y-5">
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="text-sm text-slate-500 mb-3">
                    Register for written and practical exams via {examInfo.examProvider}.
                  </p>
              ...
              <div className="bg-slate-50 rounded-xl p-4 grid sm:grid-cols-2 gap-3 text-sm">
                <div>
                  ...
                  <span className="font-medium text-slate-900">100 questions, 90 min</span>
                </div>
                <div>
                  <span className="text-slate-500">Practical exam:</span>{' '}
                  <span className="font-medium text-slate-900">Live demonstration</span>
                </div>
                <div>
                  <span className="text-slate-500">Passing score:</span>{' '}
                  <span className="font-medium text-slate-900">75% on each section</span>
                </div>
                <div>
                  <span className="text-slate-500">Exam fee:</span>{' '}
                  <span className="font-semibold text-emerald-700">Included in tuition</span>
                </div>
              </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-amber-800 space-y-1.5">
                ...
                <li>
                  • Bring your own tools/kit for the practical exam — check IPLA requirements for
                  the approved list.
                </li>
