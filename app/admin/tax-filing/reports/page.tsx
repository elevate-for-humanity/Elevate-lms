    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="text-3xl font-bold text-brand-red-600">0</div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-4">
              ...
              <button className="w-full px-4 py-2 bg-brand-blue-600 text-white rounded-md hover:bg-green-700" aria-label="Action button">
                Export to PDF
              </button>
              <button className="w-full px-4 py-2 bg-brand-red-600 text-white rounded-md hover:bg-brand-red-700" aria-label="Action button">
                Export to Excel
              </button>
            </div>
          </div>
