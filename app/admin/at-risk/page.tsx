    ...
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center gap-3 mb-2">
              <TrendingDown className="w-8 h-8 text-brand-red-600" />
              <div>
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        {student?.phone && (
                          <a
                            ...
                            className="px-4 py-2 bg-brand-blue-600 text-white rounded-lg font-semibold hover:bg-green-700 text-center"
                          >
                            Call Student
                          </a>
                        )}
        ...
        {lowCompletionPrograms && lowCompletionPrograms.length > 0 && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-bold text-black mb-4 flex items-center gap-2">
              <TrendingDown className="w-6 h-6 text-brand-red-600" />
