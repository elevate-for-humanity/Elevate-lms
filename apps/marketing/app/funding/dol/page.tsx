          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              { step: '1', title: 'Apply Online', desc: 'Complete the student application form' },
              {
                ...
                desc: 'Discuss program options and funding eligibility',
              },
              { step: '3', title: 'Start Training', desc: 'Begin earning while you learn' },
            ].map((s) => (
              <div key={s.step}>
                <div className="w-12 h-12 rounded-full bg-brand-red-600 text-white text-xl font-bold flex items-center justify-center mx-auto mb-4">
                  {s.step}
                </div>
