        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <Image
            ...
            blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAFUlEQVR42mP8z8BQDwADhQGAWjR9awAAAABJRU5ErkJggg=="
                  src="/images/pages/store-checkout-cancel-hero.webp"
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-slate-600 text-sm mt-6">
            ...
            <Link href="/contact?subject=Security%20Documentation%20Request" className="text-red-600 hover:text-red-700 underline">Contact sales</Link>
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm mb-8">
            ...
            <ul className="text-slate-600 text-sm space-y-2">
              ...
              <li>• <a href={getAdminUrl("/governance/data")} className="text-red-600 hover:text-red-700 underline">Data Processing & Privacy</a></li>
