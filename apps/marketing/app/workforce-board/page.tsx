...
export default function WorkforceBoardPage() {
  ...
  const features = [
    ...
    {
      image: '/images/pages/workforce-board-page-10.webp',
    ...
    {
      image: '/images/pages/workforce-board-page-2.webp',
  ...
  const quickLinks = [
    ...
    {
      image: '/images/pages/workforce-board-page-3.webp',
      title: 'Supportive Services',
      description: 'Review supportive services provided',
      href: '/workforce-board/supportive-services',
    },
    {
      image: '/images/pages/workforce-board-page-6.webp',
      title: 'Follow-Ups',
