  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <section className="relative h-[160px] sm:h-[220px] md:h-[280px] overflow-hidden">
        ...
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/store-licenses-checkout-hero.webp" alt="Elevate store" fill sizes="100vw" className="object-cover" priority />
      </section>
      <PaymentElement />
