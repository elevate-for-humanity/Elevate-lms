...
import { Palette, DollarSign, Users, Calendar, CheckCircle, Phone, Building2, Award } from 'lucide-react';
...
const REQUIREMENTS = [
  ...
  'Physical space for apprentice to perform nail services on clients',
...
const APPRENTICE_INFO = [
  ...
  'Creative flair and customer service skills',
];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <section className="mb-16">
          ...
          <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { step: '1', title: 'Apply', desc: 'Complete our host shop application. We review your salon and mentor qualifications.' },
        ...
        <section className="bg-slate-50 rounded-2xl p-8 sm:p-12 border border-slate-200 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/partners/nail-host-shop/apply" className="bg-pink-600 hover:bg-pink-700 text-white font-bold px-8 py-4 rounded-xl transition-colors text-lg">
              Apply to Host
            </Link>
