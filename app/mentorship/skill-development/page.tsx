...
<div className="bg-gray-50 border-b">
      ...
      <section className="relative h-[350px] flex items-center justify-center text-white overflow-hidden">
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/hero/hero-hands-on-training.webp" alt="Skill Development" fill className="object-cover" priority sizes="100vw" />
