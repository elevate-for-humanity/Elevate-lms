...
export default function SamGovStorePage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <div id="guided-setup"><ZeroCodeSetup productName="SAM.gov Manager" intro="Answer a few plain-English questions and Elevate prepares the workspace context around your entity, registration stage and goal. You should not have to understand the internal data model to begin." questions={setupQuestions} startHref={catalog.appHref} trialHref={catalog.trialHref} advancedNote="Higher tiers can add more entities, team access, compliance dashboards, white-label controls and service-level support where included. Official registration and approval still occur through SAM.gov." /></div>
