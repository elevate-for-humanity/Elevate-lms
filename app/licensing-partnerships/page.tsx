...
{/* Hero Section */}
      <section className="relative bg-brand-red-600 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight">
              ...
              <br />
              <span className="text-brand-red-300">Grow Together</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 bg-white text-brand-red-600 hover:bg-gray-100 px-8 py-4 rounded-xl font-bold text-lg transition shadow-2xl hover:scale-105"
              >
                Become a Partner
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {partnershipTypes.map((type, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-brand-red-600 hover:shadow-xl transition-all"
                >
                  <div className="w-16 h-16 bg-brand-red-100 rounded-2xl flex items-center justify-center mb-6">
                    <Icon className="w-8 h-8 text-brand-red-600" />
                  </div>
                  ...
                  <Link
                    href={type.href}
                    className="block text-center bg-brand-red-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-brand-red-700 transition-colors"
                  >
                    Learn More →
                  </Link>
                </div>
            ...
            {benefits.map((benefit, idx) => {
              ...
              return (
                <div key={idx} className="text-center">
                  <div className="w-20 h-20 bg-brand-red-600 rounded-full flex items-center justify-center mx-auto mb-6">
      ...
      <section className="py-20 bg-brand-red-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 bg-white text-brand-red-600 hover:bg-gray-100 px-10 py-5 rounded-xl text-lg font-black shadow-2xl hover:scale-105 transition-all"
            >
              Apply to Partner
          ...
          <p className="text-white/80 mt-6">
            Questions? Contact us at Contact Us
          </p>
        </div>
      </section>
    </div>
