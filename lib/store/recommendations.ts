...
export const RECOMMENDATION_RULES: Record<
  string,
  {
    upsells: string[];
    crossSells: string[];
...
> = {
  ...
  'wioa-toolkit': {
    ...
    bundles: [
      {
        products: ['wioa-toolkit', 'ferpa-toolkit', 'grant-reporting'],
        savings: 'Save $400 - Complete Compliance Bundle',
      },
    ],
  },
...
function getUpgradeReason(from: string, to: string): string {
  const reasons: Record<string, string> = {
    'core-license:school-license':
      'Upgrade to School License for white-label branding, WIOA compliance, and partner dashboards - everything you need to run a training provider.',
    'school-license:enterprise-license':
      'Scale to multiple locations with Enterprise. Get unlimited sites, custom integrations, and dedicated support.',
  };
...
function getUpsellReason(viewing: string, suggesting: string): string {
  const reasons: Record<string, string> = {
    'wioa-toolkit:school-license':
      'The School License includes WIOA compliance built-in, plus LMS, enrollment, and white-label branding.',
    'ferpa-toolkit:school-license':
      'School License includes FERPA compliance plus the full platform - better value than standalone tools.',
    'grant-reporting:school-license':
      'Get grant reporting plus the complete workforce platform with School License.',
    'ai-tutor:school-license':
      'AI Tutor is included with School License, along with LMS and compliance tools.',
    'workbooks:core-license':
      'Want to create your own courses? Core License gives you a full LMS with course builder.',
    'workbooks:school-license':
      'Run your own training program with School License - includes LMS, compliance, and white-label branding.',
    'barber-program:school-license':
      'Want to run your own barber school? School License gives you everything you need.',
...
function getCrossSellReason(viewing: string, suggesting: string): string {
  const reasons: Record<string, string> = {
    'core-license:wioa-toolkit':
      'Add WIOA compliance to track participant outcomes and generate required reports.',
    'core-license:ai-tutor':
      'Add AI Tutor to provide 24/7 learner support and reduce instructor workload.',
    'school-license:ai-tutor':
      'Enhance your platform with AI-powered tutoring for better learner outcomes.',
    'school-license:grant-reporting':
      'Automate your grant reporting with one-click exports and outcome tracking.',
    ...
    'ferpa-toolkit:wioa-toolkit':
      'Add WIOA tracking to meet all workforce compliance requirements.',
    ...
    'ai-tutor:wioa-toolkit':
      'Track learner outcomes for WIOA reporting with the compliance toolkit.',
    ...
    'workbooks:barber-program':
      'Interested in barbering? Check out our full apprenticeship program.',
...
export const AVATAR_SALES_MESSAGES: Record<
  string,
  {
    intro: string;
...
> = {
  'core-license': {
    ...
    valueHighlight:
      'You get a full LMS with course builder, student enrollment, and basic compliance tracking - everything to launch your first program.',
    objectionHandler:
      'If you need white-label branding or WIOA compliance later, you can upgrade to School License anytime.',
  ...
  'school-license': {
    ...
    valueHighlight:
      'You get white-label branding so it looks like YOUR platform, plus WIOA and FERPA compliance built in. The partner dashboard lets employers track their sponsored students.',
    objectionHandler:
      'The $15,000 pays for itself fast - one WIOA-funded cohort of 10 students can bring in $50,000+ in training revenue.',
    callToAction: 'Want me to show you how other training providers are using this?',
  },
  'enterprise-license': {
    intro:
      'Enterprise is for organizations running multiple training sites or needing custom integrations.',
    valueHighlight:
      'Unlimited locations, API access for your existing systems, and a dedicated account manager who knows your business.',
    objectionHandler:
      "We'll do the integration work and train your team on-site. You focus on training, we handle the tech.",
  ...
  'wioa-toolkit': {
    ...
    valueHighlight:
      'Automated PIRL exports, performance tracking, and quarterly reports. What used to take 40 hours now takes 10 minutes.',
    objectionHandler:
      "It's $1,999 one-time - that's less than one week of a compliance officer's salary.",
  ...
  'ai-tutor': {
    ...
    valueHighlight:
      'It answers questions, explains concepts, and tracks where students are struggling. Your instructors can focus on hands-on training.',
    objectionHandler:
      "Students love it because they get help at 2am when they're studying. Instructors love it because they're not answering the same questions 50 times.",
