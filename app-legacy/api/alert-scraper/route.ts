...
View full details: ${process.env.NEXT_PUBLIC_SITE_URL || PLATFORM_DEFAULTS.siteUrl}/admin/security/scraping-attempts
            ...
            elements: [
              {
                ...
                url: `${process.env.NEXT_PUBLIC_SITE_URL || PLATFORM_DEFAULTS.siteUrl}/admin/security`,
              },
            ],
          },
        ],
