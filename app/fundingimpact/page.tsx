        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200">
              ...
              <div className="p-6 text-center">
                <div className="w-14 h-14 bg-brand-red-100 rounded-full flex items-center justify-center mx-auto -mt-12 mb-3 border-4 border-white relative z-10">
                  <Briefcase className="w-7 h-7 text-brand-red-600" />
                </div>
                <div className="text-4xl font-bold text-brand-red-600 mb-2">78%</div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200">
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 bg-brand-red-600 rounded-full flex items-center justify-center text-white font-bold">
                    ST
                  </div>
                  <div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-brand-red-50 rounded-xl overflow-hidden border border-brand-red-200">
              <div className="relative h-48">
                <Image
              ...
              <div className="p-8">
                <div className="w-14 h-14 bg-brand-red-600 rounded-xl flex items-center justify-center mb-6 -mt-14 relative z-10 border-4 border-brand-red-50">
