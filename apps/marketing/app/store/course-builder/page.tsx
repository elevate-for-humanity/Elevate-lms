            ...
            <div className="grid lg:grid-cols-2 gap-8 items-end">
              ...
              <div className="flex">
                ...
                <div className="w-48 bg-slate-50 p-3 border-r border-slate-200">
                  ...
                  {['Introduction', 'Core Concepts', 'Practical Exercises', 'Assessment'].map((m, i) => (
                    <div key={m} className={`flex items-center gap-2 px-2 py-2 rounded-lg text-sm mb-1 ${i === 1 ? 'bg-brand-blue-100 text-brand-blue-700' : 'text-slate-700'}`}>
                ...
                <div className="flex-1 p-4">
                  ...
                  <div className="space-y-3">
                    {[
                      { icon: Video, type: 'Video Lesson', time: '12:34', color: 'bg-red-100 text-red-600' },
                      { icon: FileText, type: 'Reading', time: '5 min', color: 'bg-blue-100 text-blue-600' },
                      { icon: FileQuestion, type: 'Quiz', time: '10 Q', color: 'bg-purple-100 text-purple-600' },
                    ].map((lesson, i) => (
                      <div key={i} className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
                        <GripVertical className="w-4 h-4 text-slate-400" />
                        <div className={`w-8 h-8 ${lesson.color} rounded-lg flex items-center justify-center`}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {blockTypes.map(block => (
              <div key={block.label} className="bg-white p-4 rounded-xl border border-slate-200 text-center hover:shadow-md transition-shadow cursor-pointer">
                <div className={`w-12 h-12 ${block.color} rounded-xl flex items-center justify-center mx-auto mb-3`}>
            ...
            <div>
              ...
              <div className="bg-white rounded-xl p-4 border border-slate-200">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-900 mb-1">What can I create for you?</p>
                    <p className="text-xs text-slate-500">Describe your course topic or upload content</p>
                  </div>
                </div>
                <textarea 
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200">
              ...
              <div className="mt-6 pt-4 border-t border-slate-200">
                <p className="text-xs text-slate-500">
                  AI generates content based on best practices. You can edit, add, or remove any content before publishing.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Built for Professional Training</h2>
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600">Pre-built courses you can customize or use as-is</p>
          </div>
              ...
              <div key={t.name} className="bg-white rounded-xl p-6 border border-slate-200 hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">{t.students.toLocaleString()} students enrolled</p>
                  </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-600 mb-8">
            Available with all Elevate Platform Professional and Enterprise plans.
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <div className="bg-white rounded-2xl p-8 border-2 border-slate-200">
              ...
              <ul className="text-left space-y-2 mb-6">
                {['Unlimited courses', 'AI content generation', 'Video hosting', 'Certificates'].map(f => (
              ...
              <Link href="/store/checkout/course-builder" className="block text-center bg-slate-900 text-white font-bold py-3 rounded-xl hover:bg-slate-800 transition-colors">
                Add to Plan
              </Link>
            </div>
            ...
            <div className="bg-brand-blue-900 rounded-2xl p-8 text-white">
              ...
              <p className="text-4xl font-bold mb-6">$99<span className="text-lg font-normal text-blue-300">/mo</span></p>
              <ul className="text-left space-y-2 mb-6">
                {['Everything in Add-on', 'Student management', 'Enrollment forms', 'Reporting dashboard', 'Priority support'].map(f => (
              ...
              <Link href="/store/plans" className="block text-center bg-white text-brand-blue-900 font-bold py-3 rounded-xl hover:bg-blue-50 transition-colors">
                View All Plans
              </Link>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-slate-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/contact?subject=Course+Builder+Demo" className="inline-flex items-center gap-2 border border-slate-600 text-white font-bold px-8 py-4 rounded-xl hover:bg-slate-800 transition-colors">
              Schedule Demo
            </Link>
          </div>
        </div>
