            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {displayWorkshops.map((workshop: any) => (
                <div key={workshop.id} className="bg-white border rounded-xl overflow-hidden hover:shadow-lg transition">
                  <div className="bg-brand-red-100 p-4">
                    <div className="text-brand-red-600 font-bold text-lg">
                      {new Date(workshop.date).toLocaleDateString('en-US', { 
                        month: 'short', 
                        day: 'numeric' 
                      })}
                    </div>
                    <div className="text-brand-red-500 text-sm">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center gap-1 text-brand-red-600 font-medium hover:underline"
                      >
          ...
          <section className="mb-16">
            ...
            <div className="flex flex-wrap gap-3">
              {categories.map((category: any) => (
                <span 
                  key={category.id}
                  className="bg-brand-red-100 text-brand-red-700 px-4 py-2 rounded-full text-sm font-medium"
                >
                  {category.name}
                </span>
              ))}
