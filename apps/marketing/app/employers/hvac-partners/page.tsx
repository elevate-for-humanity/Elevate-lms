    ...
    <main className="bg-white text-slate-950">
      ...
      <section className="overflow-hidden bg-slate-950 text-white">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1fr_.9fr] lg:py-20">
          ...
          <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-white/15 bg-slate-800"><Image src="/images/pages/hvac-unit.webp" alt="HVAC equipment prepared for employer-based field service training" fill priority sizes="(max-width:1024px) 100vw,45vw" className="object-cover" /></div>
        </div>
      </section>
