...
export const smartImageMappings: SmartImageMapping[] = [
  // Homepage Images
  {
    ...
    primaryImage: '/images/heroes/hero-homepage.webp',
    fallbackImages: [
  ...
  },
  {
    ...
    primaryImage: '/images/programs/cna-hero.webp',
    fallbackImages: ['/images/heroes/hero-federal-funding.webp', '/images/heroes/hero-homepage.webp'],
  ...
  },
  {
    ...
    primaryImage: '/images/heroes/training-provider-1.webp',
    fallbackImages: ['/images/heroes/hero-homepage.webp'],
  ...
  },
  {
    ...
    primaryImage: '/images/programs/barber-hero.webp',
    fallbackImages: [
  ...
  },
  {
    ...
    primaryImage: '/images/programs/cna-hero.webp',
    fallbackImages: ['/images/programs/cna-hero.webp', '/images/programs/cna-hero.webp'],
  ...
  },
  {
    ...
    primaryImage: '/images/programs/cdl-hero.webp',
    fallbackImages: ['/images/programs/cdl-hero.webp', '/images/programs/cdl-hero.webp'],
  ...
  },
  {
    ...
    primaryImage: '/images/programs/cna-hero.webp',
    fallbackImages: ['/images/programs/cna-hero.webp', '/images/pages/culinary.webp'],
  ...
  },
  {
    ...
    primaryImage: '/images/programs/cna-hero.webp',
    fallbackImages: ['/images/programs/cna-hero.webp'],
  ...
  },
  {
    ...
    primaryImage: '/images/programs/building-maintenance-hero.svg',
    fallbackImages: ['/images/pages/electrical.webp'],
  ...
  },
  {
    ...
    primaryImage: '/images/programs/cna-hero.webp',
    fallbackImages: ['/images/pages/about-hero.webp'],
