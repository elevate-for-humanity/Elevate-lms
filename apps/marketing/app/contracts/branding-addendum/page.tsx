  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumbs
          items={[{ label: 'Contracts', href: '/contracts' }, { label: 'Branding Addendum' }]}
        />
      </div>
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border">
          ...
          <div className="p-8 prose max-w-none">
            ...
            <ul>
              <li>
                Logo must maintain minimum clear space equal to the height of the "E" in Elevate
              </li>
            ...
            <p>
              All co-branded materials must be submitted for approval at least 10 business days
              prior to intended use. Materials include but are not limited to:
            </p>
            <ul>
            ...
            <p>
              Submit all materials to our contact form for review. Approval or revision requests
              will be provided within 5 business days.
            </p>
            <h2>5. Term</h2>
            <p>
              This addendum remains in effect for the duration of the master agreement unless
