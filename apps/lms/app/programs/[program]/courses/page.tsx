        ...
        {allCourses.length === 0 ? (
          <div className="text-center py-20 bg-slate-50 rounded-2xl border border-slate-100">
            ...
            <div className="flex gap-3 justify-center">
              <Link
                href="/start"
                className="bg-brand-blue-600 hover:bg-brand-blue-700 text-white px-6 py-3 rounded-xl font-bold transition"
              >
                Apply Now
              </Link>
              <Link
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="border-t pt-4 flex items-center justify-between gap-3">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-1.5 bg-brand-blue-600 hover:bg-brand-blue-700 text-white text-sm font-bold px-4 py-2 rounded-xl transition"
                    >
