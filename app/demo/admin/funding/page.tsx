  ...
  return (
    <DemoPageShell title="Funding" description="Track funding sources, allocations, and expenditures." portal="admin">
      <section className="relative h-[60vh] min-h-[400px] max-h-[720px] mb-6">
        <Image src="https://cuxzzpsyufcewtmicszk.supabase.co/storage/v1/object/public/images/images/pages/demo-page-5.webp" alt="Platform demo" fill sizes="100vw" className="object-cover" priority />
      </section>
