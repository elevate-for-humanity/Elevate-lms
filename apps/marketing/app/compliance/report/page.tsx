      ...
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <p className="text-slate-700 mb-6">
            Thank you for your report. Our compliance team will review it promptly.
          </p>
          <Link href="/" className="text-brand-blue-600 font-medium">
            Return to Home
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <Breadcrumbs
            items={[{ label: 'Compliance', href: '/compliance' }, { label: 'Report' }]}
          />
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-brand-red-600 hover:bg-brand-red-700 text-white py-4 rounded-lg font-bold transition flex items-center justify-center"
            >
