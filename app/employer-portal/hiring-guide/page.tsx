...
<div className="relative h-80 bg-brand-red-800">
        <Image
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="flex items-center gap-3 mb-4">
              <BookOpen className="w-10 h-10 text-brand-red-300" />
              <span className="px-3 py-1 bg-brand-red-500/30 text-brand-red-200 rounded-full text-sm">
                Employer Resource
              </span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Hiring Guide</h1>
            <p className="text-xl text-brand-red-200 max-w-2xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          {[
            ...
            { icon: Users, label: 'Candidates Available', value: '2,500+', color: 'brand-red' },
            ...
            <div key={step.number} className={`flex flex-col ${index % 2 === 1 ? 'md:flex-row-reverse' : 'md:flex-row'} gap-8 items-center`}>
              <div className="md:w-1/2">
                <div className="relative h-64 rounded-2xl overflow-hidden">
                  ...
                  />
                  <div className="absolute top-4 left-4 w-12 h-12 bg-brand-red-600 text-white rounded-full flex items-center justify-center text-xl font-bold">
                    {step.number}
                  </div>
                </div>
              </div>
              <div className="md:w-1/2">
                ...
                <div className="bg-brand-red-50 rounded-xl p-4">
                  <p className="font-semibold text-brand-red-900 mb-3">Pro Tips:</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {resources.map((resource, index) => (
              <div key={index} className="flex items-center justify-between p-4 border rounded-xl hover:border-brand-red-300 transition">
        ...
        <div className="bg-brand-red-600 rounded-2xl p-8 text-white text-center">
          <h3 className="text-2xl font-bold mb-4">Ready to Start Hiring?</h3>
          <p className="text-brand-red-200 mb-6 max-w-2xl mx-auto">
            Post your first job and connect with pre-screened, WOTC-eligible candidates today.
          </p>
          <div className="flex justify-center gap-4">
            <Link
              href="/employer-portal/jobs/new"
              className="px-6 py-3 bg-white text-brand-red-600 rounded-lg hover:bg-gray-100 transition font-semibold flex items-center gap-2"
            >
