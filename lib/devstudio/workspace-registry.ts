...
export const STUDIO_WORKSPACES: StudioWorkspaceDefinition[] = [
  {
    ...
    description: 'Canonical Course Factory inspection and authoring surface.',
  ...
  },
  {
    ...
    description: 'Manage the public team directory, training partners and website page copy.',
  ...
  },
  {
    ...
    route: '/studio?workspace=workflows',
    healthEndpoint: '/api/admin/dev-studio/workflows/health',
  },
  {
    id: 'intelligence',
    label: 'Intelligence',
    description: 'Turn risk, workflow, and operational findings into governed AI actions.',
    permission: 'studio.tasks.manage',
    route: '/studio?workspace=intelligence',
    healthEndpoint: '/api/admin/dev-studio/intelligence',
  },
  {
    id: 'repository',
    label: 'Repository Workspace',
    description:
      'Edit and preview source, commit to GitHub, and run code in an isolated browser runtime.',
    permission: 'studio.repository.view',
    route: '/studio/repository',
  ...
  },
  {
    ...
    label: 'Live Canvas',
    description:
      'Experimental project canvas; available only when a real project executor is configured.',
    permission: 'studio.content.manage',
    route: '/studio/canvas',
    healthEndpoint: '/api/admin/dev-studio/health',
    featureFlag: 'LIVE_CANVAS_ENABLED',
  },
  {
    id: 'tasks',
    label: 'AI Task Queue',
  ...
  },
  {
    id: 'agents',
    label: 'AI Agents',
    description: 'Inspect registered autonomous agents, capabilities and execution state.',
    permission: 'studio.tasks.manage',
    route: '/studio/agents',
    healthEndpoint: '/api/admin/dev-studio/agents',
  },
  {
    id: 'builds',
    label: 'Builds',
    description: 'Inspect durable build records and verification evidence.',
    permission: 'studio.deployments.manage',
    route: '/studio/builds',
    healthEndpoint: '/api/admin/dev-studio/builds',
  },
  {
    id: 'logs',
    label: 'Logs',
    description: 'Inspect governed runtime and AI error records.',
  ...
  },
  {
    id: 'containers',
    label: 'Containers',
    description: 'Manage isolated execution environments and canonical runtime configuration.',
    permission: 'studio.containers.manage',
    route: '/studio/containers',
  ...
  },
  {
    ...
    description:
      'Verify public product claims with code, benchmark, runtime and certification evidence.',
    permission: 'studio.settings.manage',
    route: '/studio/claims',
    healthEndpoint: '/api/admin/dev-studio/claims/health',
  },
  {
    id: 'collaboration',
    label: 'Collaboration',
    description: 'Comments and shared review context backed by Studio data.',
    permission: 'studio.collaboration.use',
    route: '/studio/collaboration',
  ...
  },
  {
    ...
    description:
      'Browse, connect and manage verified external services, OAuth identities, permissions and runtime status.',
    permission: 'studio.settings.manage',
