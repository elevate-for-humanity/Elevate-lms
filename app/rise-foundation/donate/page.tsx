    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-zinc-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-brand-red-100 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            {!campaigns || campaigns.length === 0 ? (
              <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-12 text-center">
                ...
                <button className="px-8 py-3 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700 transition-colors font-medium" aria-label="Action button">
                  Donate Now
                </button>
              </div>
            ) : (
                    ...
                    >
                      ...
                      <div className="mb-4">
                        ...
                        <div className="w-full bg-slate-200 rounded-full h-3">
                          <div
                            className="bg-brand-red-600 h-3 rounded-full transition-all duration-500"
                            style={{ width: `${Math.min(progress, 100)}%` }}
                          />
                        </div>
                      </div>

                      <button className="w-full px-6 py-3 bg-brand-red-600 text-white rounded-lg hover:bg-brand-red-700 transition-colors font-medium" aria-label="Action button">
          ...
          <div>
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                {[25, 50, 100, 250].map((amount) => (
                  <button
                    key={amount}
                    className="px-4 py-3 border-2 border-slate-300 rounded-lg hover:border-brand-red-600 hover:bg-brand-red-50 transition-colors font-medium"
                  >
                    ${amount}
                  </button>
                ))}
            ...
            <div className="bg-brand-red-50 border border-brand-red-200 rounded-lg p-6">
              <h3 className="font-bold text-brand-red-900 mb-2">Tax Deductible</h3>
