...
export default function WebsiteBuilderStorePage() {
  return <main className="min-h-screen bg-white">
    <section className="relative overflow-hidden bg-slate-950 px-4 py-24 text-white"><div className="absolute inset-0 bg-[radial-gradient(circle_at_75%_25%,rgba(220,38,38,.2),transparent_35%)]"/><div className="relative mx-auto max-w-6xl"><div className="max-w-4xl"><p className="text-sm font-black uppercase tracking-[.22em] text-brand-red-400">Elevate AI Website Builder</p><h1 className="mt-4 text-5xl font-black leading-[1.02] md:text-7xl">Build your business website at the snap of a finger.</h1><p className="mt-6 max-w-3xl text-xl leading-9 text-slate-300">Describe your business. Let AI create the starting point. Customize it without code, preview it, and publish from one workspace. You do not need to be a web developer to get started.</p><div className="mt-9 flex flex-wrap gap-3"><Link href={catalog.trialHref} className="rounded-xl bg-brand-red-600 px-7 py-4 font-black hover:bg-brand-red-700">Build my website</Link><a href="#demo" className="rounded-xl border border-white/30 px-7 py-4 font-black hover:bg-white/10">Watch the walkthrough</a></div><p className="mt-4 text-sm text-slate-400">Generation speed varies with the request and service load. Preview and approve your content before publishing.</p></div></div></section>
