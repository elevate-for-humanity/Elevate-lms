    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <Breadcrumbs
            items={[{ label: 'Training', href: '/programs' }, { label: 'Certifications' }]}
          />
        </div>
      </div>
      {/* Hero */}
      ...
      <section className="py-14 sm:py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-slate-600 text-center mb-10 max-w-2xl mx-auto">
            Each program leads to an industry-recognized credential accepted by employers statewide.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {certPrograms.map((prog) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="font-bold text-slate-900 text-sm mb-2 group-hover:text-brand-blue-600 transition-colors">
                    {prog.name}
                  </h3>
      ...
      <section className="py-10 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-sm text-slate-600 mb-4">
            Micro-classes are 4–8 hour focused sessions covering CPR, OSHA 10, food handler safety,
            and more. Available as standalone or add-ons to any program.
          </p>
          <Link
            href="/microclasses"
            className="inline-flex items-center text-brand-red-600 font-semibold text-sm hover:text-brand-red-700"
          >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8 bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
            <div className="flex-1">
              ...
              <p className="text-slate-600 text-sm leading-relaxed mb-0">
                Elevate operates an authorized testing center for EPA 608, NHA healthcare
                credentials, Certiport (Microsoft, CompTIA, Adobe), ACT WorkKeys, and NRF Rise Up
                exams. Book your seat once you complete training — no need to find a separate
                testing site.
              </p>
            </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-300 text-base leading-relaxed mb-10 max-w-xl mx-auto">
            Apply in minutes. Most students start training within 2–4 weeks.
          </p>
