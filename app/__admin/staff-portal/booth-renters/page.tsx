        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5">
              Manage booth and suite rentals across all disciplines
            </p>
          </div>
          <Link
          ...
          {allRenters.length === 0 ? (
            <div className="p-12 text-center text-slate-400">
              ...
              <p className="text-sm mt-1">
                <Link href="/booth-rental/apply" className="text-brand-blue-600 hover:underline">
                  Add the first renter →
                </Link>
              </p>
            </div>
          ) : (
                  ...
                  {allRenters.map((renter: any) => {
                    ...
                    return (
                      <tr key={renter.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-4 py-4">
                          <span
                            className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-bold ${status.bg} ${status.text}`}
                          >
