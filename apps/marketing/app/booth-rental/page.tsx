    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-slate-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-xs font-bold text-brand-blue-400 uppercase tracking-widest">
            Indianapolis, IN
          </span>
          <h1 className="text-4xl sm:text-5xl font-black mt-3 mb-5">Booth &amp; Suite Rentals</h1>
          <p className="text-slate-300 text-lg max-w-2xl mx-auto mb-8">
            Professional spaces for licensed barbers, cosmetologists, estheticians, and nail
            technicians. Weekly billing. No long-term lease. Card on file — automatic every Friday.
          </p>
          <Link
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-slate-500 mb-10">
            All spaces include utilities, Wi-Fi, and access to shared areas.
          </p>
            ...
            {DISCIPLINE_DISPLAY.map((d) => (
              <div key={d.key} className={`rounded-2xl border-2 ${d.border} p-6`}>
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className={`w-12 h-12 rounded-xl ${d.color} flex items-center justify-center`}
                  >
                    {d.icon}
                  </div>
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <span
                        className={`text-xs font-semibold ${d.deposit === 'No deposit' ? 'text-emerald-600' : 'text-slate-500'}`}
                      >
                        {d.deposit}
                      </span>
                    </div>
            ...
            {[
              {
                step: '1',
                title: 'Apply Online',
                desc: 'Fill out the application with your license number and select your space type.',
              },
              {
                step: '2',
                title: 'Pay & Sign',
                desc: 'Pay your deposit (if applicable) and sign the rental agreement digitally. Card saved for weekly billing.',
              },
              {
                step: '3',
                title: 'Move In',
                desc: 'Staff confirms your booth assignment within 1 business day. Weekly rent charged every Friday automatically.',
              },
            ].map((s) => (
              <div key={s.step} className="text-center">
                <div className="w-12 h-12 bg-brand-blue-600 text-white rounded-full flex items-center justify-center text-xl font-black mx-auto mb-4">
                  {s.step}
                </div>
      ...
      <section className="py-12 px-4 border-t">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-sm text-slate-500">
            ...
            $10/day for each additional day. Access is terminated at 5 days past due. Keep your card
            on file current to avoid interruption.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-brand-blue-700 text-white text-center">
        ...
        <p className="text-brand-blue-200 mb-8">
          A valid state license is required. Apply takes 5 minutes.
        </p>
        <Link
          href="/booth-rental/apply"
