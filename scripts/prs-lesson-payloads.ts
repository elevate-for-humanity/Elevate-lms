...
export const PRS_LESSONS: LessonPayload[] = [
  // ── MODULE 1 ──────────────────────────────────────────────────────────────────
  {
    ...
    summary_text:
      'Defines the PRS role, scope, and how lived experience functions as a professional tool.',
    reflection_prompt:
      'What aspect of your lived experience will be most useful to the people you support, and why?',
    key_terms: [
    ...
    job_application:
      'Practice a 60-second introduction that shares your role and what you can offer without oversharing personal detail.',
    watch_for: [
      'Do not present yourself as a counselor or therapist',
      'Your lived experience is an asset — do not minimize it',
      'Know scope of practice before your first client interaction',
    ],
...
The PRS role differs from clinical roles in three ways: you use shared experience rather than clinical assessment, you focus on hope and possibility rather than diagnosis, and you work alongside the person rather than directing their care.`,
  },
  {
    ...
    summary_text:
      'Introduces recovery-oriented principles including person-centered care, hope, self-determination, and strengths-based practice.',
    reflection_prompt:
      'Think of a time someone met you where you were instead of where they thought you should be. How did that affect your willingness to engage?',
    key_terms: [
      'ROSC',
    ...
    job_application:
      'When a client says they are not ready to stop using, a recovery-oriented response meets them where they are and keeps the door open rather than lecturing about abstinence.',
    watch_for: [
      'Do not project your own recovery path onto clients',
      'MAT is evidence-based treatment, not trading one addiction for another',
...
These principles shape every interaction — how you ask questions, how you respond to setbacks, and how you talk about options.`,
  },
  {
    ...
    summary_text:
      'Explains how peer support evolved from mutual aid and consumer-survivor movements into a credentialed profession.',
    reflection_prompt:
      'How does knowing the history of peer support change how you think about your role?',
    key_terms: [
    ...
    job_application:
      'When a colleague questions whether peer support is real work, explain the evidence base and policy history — peer support has been Medicaid-billable for nearly 20 years.',
    watch_for: [
      'Do not conflate peer support with 12-step sponsorship',
      'The history of forced psychiatric treatment is relevant context for clients who distrust the system',
      'Professionalization created standards but also tensions around authenticity',
    ],
...
Understanding this history matters because it explains why peer support is structured the way it is and why the boundaries between peer and clinical roles are drawn where they are.`,
  },
  {
    ...
    summary_text:
      'Defines professional boundaries, role clarity, and the difference between caring support and overinvolvement.',
    reflection_prompt:
      'Describe a situation where maintaining a professional boundary might feel uncomfortable. How would you handle it?',
    key_terms: [
    ...
    job_application:
      'A client asks for your personal cell number for crisis calls. Explain your agency contact policy, provide the crisis line, and document the conversation.',
    watch_for: [
      'Boundary violations often start small and escalate',
      'If you feel like you are the only person who can help a specific client, that is a warning sign of over-involvement',
      'Disclose dual relationships to your supervisor immediately',
    ],
...
Your agency will have a code of conduct that defines specific boundary expectations. Know it before your first client contact.`,
  },
  {
    ...
    summary_text:
      'Module 1 checkpoint covering PRS role, recovery-oriented principles, peer support history, and professional boundaries.',
    reflection_prompt:
      'What is the most important thing you learned in this module, and how will it change how you approach your work?',
    key_terms: [
      'module review',
      'role clarity',
      'recovery principles',
    ...
    job_application:
      'Employers test these fundamentals in interviews. Being able to articulate what a PRS does and does not do is a core competency.',
    watch_for: [
      'Know the difference between peer support and clinical treatment',
      'Be able to name the four SAMHSA dimensions of recovery',
      'Understand why professional boundaries exist',
    ],
...
Score 70% or higher to proceed.`,
  ...
  // ── MODULE 2 ──────────────────────────────────────────────────────────────────
  {
    ...
    summary_text:
      'Reviews the code of ethics for peer specialists including integrity, respect, competence, and mandatory reporting.',
    reflection_prompt:
      'Describe an ethical dilemma you might face as a PRS and how the code of ethics would guide your decision.',
    ...
    job_application:
      'A client offers you a gift card as a thank-you. Decline graciously, explain your agency policy on gifts, and document the interaction.',
    watch_for: [
      'Ethical violations are often rationalized as exceptions',
      'When in doubt, consult your supervisor before acting',
      'Mandatory reporting obligations override confidentiality',
    ],
...
Ethics are the foundation of trust. When clients trust that you will act ethically, they are more likely to engage honestly and take risks in their recovery. Ethical violations, even minor ones, can destroy that trust.`,
  },
  {
    ...
    summary_text:
      'Explains HIPAA, 42 CFR Part 2, confidentiality limits, and the exceptions peer specialists must know.',
    reflection_prompt:
      'A colleague asks about a mutual acquaintance who is a client at your agency. How do you respond?',
    key_terms: ['HIPAA', 'PHI', '42 CFR Part 2', 'covered entity', 'breach'],
    competency_keys: ['confidentiality_hipaa', 'prs_code_of_ethics'],
    job_application:
      "A client's mother calls asking how her son is doing. You cannot confirm or deny he is a client without written consent. Say: I'm not able to share information about our clients. If your son would like to include you in his care, he can sign a release.",
    watch_for: [
      'Talking about clients in hallways or public spaces is a HIPAA violation',
      '42 CFR Part 2 applies specifically to SUD records and is stricter than HIPAA',
      "Family members do not automatically have the right to a client's information",
    ],
...
Never promise a client that everything stays between you. That is inaccurate and dangerous.`,
  },
  {
    ...
    summary_text:
      'Examines dual relationships, role conflicts, and how personal overlap can undermine safe peer practice.',
    reflection_prompt:
      'How would you handle discovering that a client is someone you know from your personal life?',
    key_terms: [
      'dual relationship',
    ...
    job_application:
      'You discover a new client is someone you used to use drugs with. Before your next session, disclose this to your supervisor, document it, and decide together whether to continue or transfer.',
    watch_for: [
      'Romantic feelings toward a client must be disclosed to a supervisor immediately',
      'Lending money to a client creates a power dynamic that harms the relationship',
      'Attending the same recovery meeting as a client must be disclosed',
    ],
...
The test for any boundary decision: Who does this serve — the client or me?`,
  },
  {
    ...
    summary_text:
      'Applies ethical reasoning to realistic practice scenarios involving privacy, boundaries, role drift, and supervision.',
    reflection_prompt:
      'Walk through a real or hypothetical ethical dilemma using the five-step decision-making process.',
    key_terms: [
      'ethical dilemma',
      'duty of care',
    ...
    job_application:
      'The peer specialists who handle ethical dilemmas well are not the ones who always know the right answer — they are the ones who have a process, consult their supervisor, and document their reasoning.',
    watch_for: [
      'Never make a hard ethical call alone',
      'Document your reasoning, not just your action',
...
The goal is not to find the perfect answer but to develop a consistent, principled decision-making process.`,
  },
  {
    ...
    summary_text:
      'Module 2 checkpoint covering code of ethics, confidentiality, dual relationships, and ethical decision-making.',
    reflection_prompt:
      'Which ethics topic still feels most vulnerable to confusion in your own practice?',
    key_terms: [
      'ethics quiz',
      'confidentiality',
      'boundaries',
    ...
    job_application:
      'Ethics questions appear on the CPRS exam. Knowing the code of ethics and confidentiality rules is tested directly.',
    watch_for: [
...
Score 70% or higher to proceed.`,
  ...
  // ── MODULE 3 ──────────────────────────────────────────────────────────────────
  {
    ...
    summary_text:
      'Compares major recovery models including abstinence-based, harm reduction, MAT, and wellness frameworks.',
    reflection_prompt:
      'Which recovery model best describes your own experience, and how does that shape how you might work with someone whose path looks different?',
    ...
    job_application:
      'When a client on buprenorphine is told by a sponsor they are not really sober, help them understand that MAT is evidence-based treatment and their recovery is valid.',
    watch_for: [
      'Do not impose your own recovery model on clients',
      'MAT is not a moral failure — it is medicine',
      'Harm reduction and abstinence are not opposites',
    ],
...
As a PRS you support the client's chosen path. Your job is not to decide which model is correct.`,
  },
  {
    ...
    summary_text:
      'Explains the Stages of Change model and how peer specialists adapt their approach to each stage.',
    reflection_prompt:
      'Think about a change you made in your own life. Which stage took the longest, and what finally moved you forward?',
    key_terms: [
      'Stages of Change',
      'precontemplation',
      'contemplation',
    ...
    job_application:
      'A client says they do not think they have a problem. Rather than arguing, ask open questions that invite reflection — meet them in precontemplation without pushing toward action they are not ready for.',
    watch_for: [
      'Pushing someone in precontemplation toward action usually backfires',
      'Relapse is part of the model, not a failure of the model',
      'Your job is to reduce ambivalence, not eliminate it by force',
    ],
...
Pushing someone to act before they are ready increases resistance. Meeting people where they are is not giving up — it is effective practice.`,
  },
  {
    ...
    summary_text:
      'Covers wellness and self-care as professional obligations, including the eight dimensions of wellness and burnout prevention.',
    reflection_prompt:
      'Which dimension of your own wellness needs the most attention right now, and what is one concrete step you can take this week?',
    ...
    job_application:
      'Identify your personal warning signs of burnout and have a plan before you need it.',
    watch_for: [
      'Peer specialists are at elevated risk for vicarious trauma and relapse',
      'Self-care is not optional — it is a professional obligation',
      'Burnout looks like cynicism, exhaustion, and reduced empathy',
    ],
...
Your recovery is not a credential you earned once. It requires ongoing maintenance. If your own wellness is deteriorating, you cannot effectively support someone else's.',
  },
  {
    ...
    summary_text:
      'Teaches relapse prevention concepts including triggers, warning signs, coping strategies, and how peer specialists support clients through relapse.',
    reflection_prompt:
      'What were your personal early warning signs before a relapse or a difficult period, and how would you help a client identify theirs?',
    key_terms: [
      'relapse',
      'trigger',
      'warning signs',
    ...
    job_application:
      'Help a client identify three personal triggers, three early warning signs, and three coping strategies they can use before reaching out for help.',
    watch_for: [
      'Relapse is not the end of recovery — how you respond matters more than the relapse itself',
      'Shame after relapse is a major barrier to re-engagement',
      'Do not lecture — express concern and help the client reconnect to their plan',
    ],
...
When a client relapses, your job is to reduce shame, help them understand what happened, and reconnect them to their recovery plan. Shame is the enemy of re-engagement.`,
  },
  {
    ...
    summary_text:
      'Module 3 checkpoint covering recovery models, stages of change, wellness, and relapse prevention.',
    reflection_prompt:
      'Which recovery model or concept from this module will most change how you approach your work with clients?',
    key_terms: [
    ...
    job_application:
      'Recovery models and stages of change are tested on the CPRS exam and come up in every client interaction.',
    watch_for: [
      'Know the six stages of change and what peer support looks like at each',
      'Know the difference between abstinence-based and harm reduction approaches',
  ...
  // ── MODULE 4 ──────────────────────────────────────────────────────────────────
  {
    ...
    summary_text:
      'Teaches active listening skills including reflective listening, open questions, summarizing, and non-verbal communication.',
    reflection_prompt:
      'Think of someone who made you feel truly heard. What did they do, and how did it affect your willingness to open up?',
    key_terms: [
      'active listening',
    ...
    job_application:
      'In your next conversation, practice reflecting back what you hear before responding. Notice how the other person responds when they feel heard.',
    watch_for: [
      'Listening is not waiting for your turn to talk',
      'Advice before understanding shuts people down',
      'Non-verbal cues communicate as much as words',
    ],
...
The goal of active listening is not to gather information — it is to make the person feel understood. When people feel heard, they are more likely to engage honestly and take risks in their recovery.`,
  },
  {
    ...
    summary_text:
      'Introduces motivational interviewing principles — OARS, rolling with resistance, and eliciting change talk.',
    reflection_prompt:
      'Describe a time someone used a confrontational approach to try to change your behavior. How did it affect your motivation?',
    key_terms: [
    ...
    job_application:
      'When a client expresses ambivalence about treatment, use OARS to explore both sides without pushing — and listen for change talk to reflect back.',
    watch_for: [
      'Confrontation increases resistance — MI is collaborative not coercive',
      'Your job is to elicit change talk, not produce it',
      'Sustain talk is normal — do not panic when clients express reasons not to change',
    ],
...
Rolling with resistance means not arguing when a client pushes back. Instead, reflect their perspective and stay curious. Arguing increases resistance. Curiosity reduces it.`,
  },
  {
    ...
    summary_text:
      'Teaches strategic self-disclosure — how to share lived experience in ways that serve the client rather than the peer specialist.',
    reflection_prompt:
      'What part of your story is most likely to build hope for the people you will work with, and what part should stay private?',
    ...
    job_application:
      "Before sharing a piece of your story, ask: Does this serve the client's recovery right now, or does it serve my need to be understood?",
    watch_for: [
      'Over-disclosure shifts focus from client to peer specialist',
      'Sharing graphic details of past use can be triggering',
      'Your story is a tool — use it intentionally, not reflexively',
    ],
...
Your story is not the point of the conversation — the client's story is. Use your experience to open doors, not to fill the room.`,
  },
  {
    ...
    summary_text:
      "Covers rapport-building, trust development, and how trauma history affects a client's ability to engage with support.",
    reflection_prompt:
      'What made you trust or distrust the people who tried to help you during your own recovery?',
    ...
    job_application:
      'With a new client who has been let down by multiple systems, your first job is not to fix anything — it is to show up consistently and do what you say you will do.',
    watch_for: [
      'Trust is built through consistency, not intensity',
      'Trauma history often means clients test relationships before trusting them',
      'Breaking a small commitment can set back trust significantly',
    ],
...
Trust cannot be rushed. It is earned through repeated small acts of reliability.`,
  },
  {
    ...
    summary_text:
      'Module 4 practice session applying active listening, MI, self-disclosure, and rapport-building in simulated peer support scenarios.',
    reflection_prompt:
      'After practicing these skills, which one feels most natural and which one will require the most intentional effort?',
    ...
    job_application:
      'Peer support skills are not learned by reading about them — they are learned by practicing them, getting feedback, and practicing again.',
    watch_for: [
      'Discomfort during practice is normal and useful',
      'Ask for specific feedback, not just general impressions',
      'Record yourself if possible — you will notice things you cannot see in the moment',
    ],
...
After each scenario, reflect: What worked? What felt forced? What would you do differently?`,
  ...
  // ── MODULE 5 ──────────────────────────────────────────────────────────────────
  {
    ...
    summary_text:
      "Defines self-advocacy, explains the peer specialist's role in building client self-advocacy capacity, and distinguishes it from doing things for clients.",
    reflection_prompt:
      'What made it hard to advocate for yourself when you were in the middle of your own recovery, and what would have helped?',
    ...
    job_application:
      "Before a client's appointment with a housing authority, help them write down their three most important questions and practice saying them out loud.",
    watch_for: [
      'Doing things for clients instead of with them creates dependency',
      'Self-advocacy is a skill that must be practiced, not just explained',
      'Celebrate small wins — they build confidence for bigger ones',
    ],
...
The goal is that over time the client needs you less for these tasks — not more. Empowerment means increasing the client's power, not transferring your power to them.`,
  },
  {
    ...
    summary_text:
      'Covers systems advocacy — how peer specialists identify systemic barriers and work within their role to address them.',
    reflection_prompt:
      'What is one policy or practice in the systems you have encountered that consistently harms people in recovery?',
    key_terms: [
      'systems advocacy',
      'systemic barriers',
      'policy',
    ...
    job_application:
      'When you notice the same barrier affecting multiple clients, document it and bring it to your supervisor as a systemic issue — not just an individual problem.',
    watch_for: [
      'Systems advocacy is within PRS scope — political campaigning is not',
      'Document patterns, not just individual incidents',
      "Work through your agency's channels before going outside them",
    ],
...
The most powerful advocacy tool you have is documentation. When you can show that 15 clients in one month were denied housing because of a specific policy, that is data that can drive change.`,
  },
  {
    ...
    summary_text:
      'Reviews participant rights in behavioral health settings including informed consent, right to refuse treatment, and grievance procedures.',
    reflection_prompt:
      'Did you know your rights as a patient when you were receiving services? What difference would it have made?',
    key_terms: [
      'participant rights',
      'informed consent',
      'right to refuse',
    ...
    job_application:
      'A client says their provider changed their medication without explaining why. Help them understand their right to informed consent and how to request a conversation with their prescriber.',
    watch_for: [
      'Rights exist on paper — advocacy makes them real',
      'Grievance procedures are often buried — help clients find them',
      'Do not discourage clients from filing complaints when warranted',
    ],
...
Your role is to help clients understand their rights, prepare to exercise them, and navigate the process when they are denied. Rights without knowledge are not real rights.`,
  },
  {
    ...
    summary_text:
      'Applies advocacy skills through practice scenarios involving rights violations, systemic barriers, and empowerment conversations.',
    reflection_prompt:
      'Which advocacy scenario felt most challenging, and what would you do differently with more preparation?',
    ...
    job_application:
      'Advocacy skills are tested in the CPRS exam through scenario questions. Practice applying the principles, not just reciting them.',
    watch_for: [
      'Advocacy is not arguing — it is helping people navigate systems effectively',
      'Know when to escalate and when to work within existing channels',
      'Document every advocacy interaction',
    ],
...
After each scenario, identify: What advocacy skill did you use? What was the outcome? What would you do differently?`,
  },
  {
    ...
    summary_text:
      'Module 5 checkpoint covering self-advocacy, systems advocacy, participant rights, and advocacy practice.',
    reflection_prompt:
      'What is one advocacy skill you want to practice before you start working with clients?',
    key_terms: [
      'advocacy quiz',
      'participant rights',
      'self-advocacy',
    ...
    competency_keys: ['advocacy_empowerment', 'participant_rights'],
    job_application:
      'Advocacy content appears on the CPRS exam and in every client interaction involving systems navigation.',
    watch_for: [
      'Know the difference between self-advocacy and systems advocacy',
      'Know key participant rights in behavioral health',
      'Know how to document advocacy efforts',
    ],
  ...
  // ── MODULE 6 ──────────────────────────────────────────────────────────────────
  {
    ...
    summary_text:
      'Introduces community resource mapping and how peer specialists build and maintain a working knowledge of local services.',
    reflection_prompt:
      'What resources do you already know about in your community, and what gaps have you noticed?',
    ...
    job_application:
      'Build and maintain a personal resource directory organized by need category: housing, food, employment, treatment, legal, transportation.',
    watch_for: [
      'Resources change — verify before referring',
      'Know eligibility requirements before sending someone to a resource',
      'A referral without follow-up is often a referral that fails',
    ],
...
Your community knowledge is a professional asset. The more you know about what exists and how to access it, the more effective you will be.`,
  },
  {
    ...
    summary_text:
      'Covers the warm handoff process, how to make effective referrals, and how to follow up to ensure linkage was successful.',
    reflection_prompt:
      'Think of a time a referral failed. What broke down and what would a warm handoff have changed?',
    ...
    job_application:
      'When referring a client to a new provider, call ahead, introduce the client by name, explain the context, and schedule a follow-up to confirm the connection was made.',
    watch_for: [
      'Cold referrals fail at high rates — especially for people with trauma histories',
      'Follow-up is not optional',
      'Document referrals and outcomes in case notes',
    ],
...
Document every referral: who you referred to, when, what was communicated, and the outcome. If the referral failed, document why and what you did next.`,
  },
  {
    ...
    summary_text:
      'Addresses barriers to service access including transportation, documentation, eligibility, and systemic discrimination.',
    reflection_prompt:
      'What is the most common barrier to service access you have seen in your community, and what creative solutions have worked?',
    key_terms: [
      'access barriers',
      'transportation',
      'documentation',
    ...
    job_application:
      'A client cannot get to treatment because they have no transportation and no ID. Help them access transit assistance and connect them to an ID recovery program before the appointment.',
    watch_for: [
      'Barriers are often stacked — one problem creates another',
      'Do not assume the client is not motivated if they cannot navigate barriers alone',
      'Document barriers in case notes to support systemic advocacy',
    ],
...
Know your local resources for each common barrier: transit assistance programs, ID recovery services, insurance enrollment navigators, childcare subsidies, and language interpretation services.`,
  },
  {
    ...
    summary_text:
      'Module 6 checkpoint covering resource navigation, warm handoffs, referral follow-up, and barrier removal.',
    reflection_prompt:
      'What is one resource gap in your community that you want to address through advocacy?',
    ...
    job_application:
      'Resource navigation and linkage content appears on the CPRS exam and is central to daily peer specialist work.',
    watch_for: [
      'Know the difference between a warm handoff and a cold referral',
      'Know common barriers and strategies to address them',
      'Know how to document referrals and follow-up',
    ],
  ...
  // ── MODULE 7 ──────────────────────────────────────────────────────────────────
  {
    ...
    summary_text:
      "Defines crisis in behavioral health, explains the peer specialist's role in crisis support, and distinguishes it from clinical crisis intervention.",
    reflection_prompt:
      'What does it feel like to be in crisis, and what kind of support actually helped versus made things worse?',
    key_terms: [
      'crisis',
      'crisis support',
      'de-escalation',
    ...
    job_application:
      'When a participant appears to be in crisis, your first job is to stay calm, stay present, and assess safety — not to fix the crisis alone.',
    watch_for: [
      'Do not attempt clinical crisis intervention — that is outside PRS scope',
      'Your calm presence is itself a de-escalation tool',
      "Know your agency's crisis protocol before you need it",
    ],
...
Your calm presence is itself a de-escalation tool. If you are anxious or reactive, the participant will feel it. Practice regulating yourself so you can be steady when someone else cannot be.`,
  },
  {
    ...
    summary_text:
      'Covers suicide risk awareness and how peer specialists respond to disclosures of suicidal ideation within their scope of practice.',
    reflection_prompt:
      'What would make it easier or harder for you to ask a client directly about suicidal thoughts?',
    key_terms: [
      'suicidal ideation',
      'risk awareness',
      'direct questioning',
    ...
    job_application:
      'If a client hints at not wanting to be here anymore, ask directly: "Are you thinking about suicide?" Asking does not plant the idea — it opens the door.',
    watch_for: [
      'Do not conduct clinical suicide risk assessments — that is outside PRS scope',
      'Asking directly about suicide does not increase risk',
      'Every disclosure of suicidal ideation requires supervisor notification and documentation',
    ],
...
You are not responsible for preventing every suicide. You are responsible for responding appropriately, following your agency's protocol, and getting the person connected to the right level of care.`,
  },
  {
    ...
    summary_text:
      'Teaches de-escalation techniques for supporting participants in acute emotional distress.',
    reflection_prompt:
      'What de-escalation strategies have worked on you when you were in distress, and what made them effective?',
    key_terms: [
      'de-escalation',
    ...
    job_application:
      'When a participant is escalating, lower your voice, slow your pace, validate their feelings, and avoid power struggles.',
    watch_for: [
      'Matching escalation with escalation makes things worse',
      'Validation does not mean agreement',
      'Physical safety comes first — know when to step back and call for help',
    ],
...
Your own regulation is the first tool. If you are anxious, reactive, or triggered, you cannot de-escalate someone else. Practice self-regulation before you need it in the field.`,
  },
  {
    ...
    summary_text:
      'Explains mandatory reporting obligations and how peer specialists navigate confidentiality when safety is at risk.',
    reflection_prompt:
      "How do you balance a participant's right to confidentiality with your obligation to report when safety is at risk?",
    key_terms: [
      'mandatory reporting',
      'duty to warn',
    ...
    job_application:
      'Explain confidentiality limits to clients at the start of your relationship — not after a disclosure.',
    watch_for: [
      'Mandatory reporting is not optional — failure to report can result in liability and certification loss',
      'Explain confidentiality limits at intake not after a disclosure',
      'Document all safety-related disclosures and actions taken',
    ],
...
This conversation is not a threat — it is honesty. And it is far better to have it before a disclosure than after.`,
  },
  {
    ...
    summary_text:
      'Module 7 checkpoint covering crisis recognition, suicide response, de-escalation, and mandatory reporting.',
    reflection_prompt:
      'What is the most important thing you learned in this module about your role in a crisis situation?',
    key_terms: [
      'crisis quiz',
      'suicide response',
      'de-escalation',
    ...
    competency_keys: ['crisis_support_safety', 'mandatory_reporting'],
    job_application:
      'Crisis support content is heavily tested on the CPRS exam and is essential for safe practice.',
    watch_for: [
      'Know the limits of PRS scope in crisis situations',
      'Know how to respond to a suicide disclosure',
      'Know mandatory reporting triggers',
    ],
  ...
  // ── MODULE 8 ──────────────────────────────────────────────────────────────────
  {
    ...
    summary_text:
      'Prepares learners for the practicum experience including expectations, documentation of hours, and how to get the most from supervised field work.',
    reflection_prompt:
      'What do you most want to learn during your practicum, and how will you communicate that to your supervisor?',
    key_terms: [
      'practicum',
      'supervised hours',
      'field experience',
    ...
    job_application:
      'Before your first practicum day, write down three specific skills you want to practice and share them with your supervisor.',
    watch_for: [
      'Practicum hours must be documented accurately',
      'Use supervision time to debrief difficult interactions',
      'The practicum is a learning experience — mistakes are expected and should be discussed',
    ],
...
The practicum is not just a requirement to check off. It is the most important part of your preparation for independent practice. Treat every interaction as a learning opportunity.`,
  },
  {
    ...
    summary_text:
      'Covers documentation standards, case note writing, and professional communication in peer support settings.',
    reflection_prompt:
      'Why does documentation matter for a peer specialist, and what are the risks of poor documentation?',
    key_terms: [
      'documentation',
      'case notes',
      'DAP notes',
    ...
    job_application:
      'Write a case note that documents a participant interaction, the support provided, any referrals made, and the follow-up plan — without including clinical assessments or diagnoses.',
    watch_for: [
      'Case notes are legal documents',
      'Do not document opinions or judgments about the participant',
...
Case notes may be reviewed by supervisors, auditors, billing staff, and courts. Write as if anyone might read it.`,
  },
  {
    ...
    summary_text:
      'Reviews the CPRS exam structure, content domains, eligibility requirements, and test-taking strategies.',
    reflection_prompt:
      'Which content domain feels least solid for you right now, and what is your plan to strengthen it before the exam?',
    ...
    job_application:
      'Know the IC&RC exam domains, the eligibility requirements, and the application process before your practicum ends.',
    watch_for: [
      'The CPRS exam is competency-based not just knowledge-based',
      'Practice applying concepts to scenarios not just memorizing definitions',
      'Exam anxiety is real — build a preparation routine',
    ],
...
- Review flagged questions if time allows`,
  },
  {
    ...
    summary_text:
      'Practice exam covering all eight modules to assess readiness for the CPRS certification exam.',
    reflection_prompt:
      'After the practice exam, which domains need the most review before your actual exam?',
    key_terms: [
      'practice exam',
      'CPRS readiness',
      'domain review',
    ...
    job_application:
      'Use your practice exam results to build a targeted study plan for the two weeks before your CPRS exam.',
    watch_for: [
      'A low score on the practice exam is information, not failure — use it to guide your review',
      'Focus extra time on domains where you scored below 70%',
      'Scenario questions require applying principles, not just recalling facts',
    ],
...
Target score: 80% or higher before scheduling your actual CPRS exam.`,
  },
  {
    ...
    summary_text:
      'Final program assessment and certification readiness review covering all eight modules.',
    reflection_prompt:
      'Looking back at everything you have learned, what has changed most in how you see yourself as a peer recovery specialist?',
    key_terms: [
      'final assessment',
      'CPRS readiness',
      'program completion',
    ...
    job_application:
      'Complete the final assessment, review any domains where you scored below 80%, and submit your CPRS application within 30 days of completing your practicum hours.',
    watch_for: [
      'Review all eight modules before the final assessment',
      'Know the CPRS application process and deadlines',
      'Completing this training is the beginning, not the end',
    ],
