...
const features = [
  {
    ...
    description:
      'Track WIOA participants from intake through enrollment, training, and employment outcomes.',
  },
  {
    icon: BarChart,
    title: 'Performance Metrics',
    description:
      'Real-time dashboards for DOL primary indicators of performance and state reporting.',
  },
  {
    icon: FileText,
    title: 'Compliance Management',
    description: 'Automated documentation, eligibility verification, and audit-ready records.',
  },
  {
    icon: Building,
    title: 'Provider Network',
    description: 'Manage training providers, program approvals, and ETPL status in one place.',
  },
  {
    icon: Shield,
    title: 'Data Security',
    description: 'FERPA-compliant data handling with role-based access and encryption.',
  },
  {
    icon: Globe,
    title: 'Multi-Region Support',
    description: 'Manage multiple service areas, offices, and partner organizations.',
  },
];
...
const complianceAreas = [
  {
    title: 'WIOA Title I',
    items: ['Adult', 'Dislocated Worker', 'Youth', 'National Dislocated Worker Grants'],
  },
  {
    title: 'Performance Reporting',
    items: [
      'Employment Rate Q2 & Q4',
      'Median Earnings',
  ...
  },
  {
    ...
    items: ['ITA tracking', 'OJT contracts', 'Supportive services', 'Budget monitoring'],
  },
];
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <Breadcrumbs
            items={[{ label: 'Platform', href: '/platform' }, { label: 'Workforce Boards' }]}
          />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-wrap gap-4 justify-center">
            {[
              ...
              <span
                key={i}
                className="flex items-center gap-2 px-4 py-2 bg-white rounded-full text-brand-blue-700 text-sm font-medium shadow-sm"
              >
      ...
      <section className="py-20 bg-brand-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white text-lg mb-8">
            See how our platform can streamline your WIOA compliance and improve participant
            outcomes.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/contact"
              className="px-8 py-4 bg-white text-brand-blue-800 font-bold rounded-lg hover:bg-brand-blue-50 transition inline-flex items-center gap-2"
            >
