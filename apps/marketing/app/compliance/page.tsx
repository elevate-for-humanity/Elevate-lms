      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-12">
        <section>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 space-y-4 text-slate-900">
            ...
            <p>
              Where applicable, certification exams are administered through authorized testing
              centers or approved proctoring organizations. Elevate coordinates instruction through
              licensed credential partners, provides materials and exam preparation support; the
              credentialing authority makes the final determination.
            </p>
          </div>
        </section>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              <p className="text-sm text-slate-700 mt-1">
                Master compliance document: institutional hierarchy, RTI/OJT hour mapping,
            ...
            >
              ...
              <p className="text-sm text-slate-700 mt-1">
                Per-program credential partners, license status, MOU requirements
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-slate-700 mt-1">
                Ready-to-share packet for workforce boards and community partners
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-slate-700 mt-1">
                RTI governance, provider tiers, competency tracking, assessment authority
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-slate-700 mt-1">
                Per-program instructor qualifications, credential partner requirements, MOU
                framework
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-slate-700 mt-1">
                ETPL-ready partnership documentation for WorkOne regions
              </p>
            </Link>
          </div>
        </section>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 space-y-4 text-slate-900">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              <div className="bg-white rounded-lg p-4">
                ...
                <p className="text-sm">
                  All data is encrypted in transit (TLS 1.2+) and at rest. SSNs are hashed
                  immediately upon submission — plain-text SSNs are never stored or displayed.
                </p>
              </div>
              <div className="bg-white rounded-lg p-4">
                <h3 className="font-semibold text-slate-900 mb-2">Access Controls</h3>
                <p className="text-sm">
                  Documents are stored in private storage buckets with row-level security. Access is
                  restricted to authorized compliance staff through role-based permissions.
                </p>
              </div>
              <div className="bg-white rounded-lg p-4">
                <h3 className="font-semibold text-slate-900 mb-2">Audit Trail</h3>
                <p className="text-sm">
                  All document access and administrative actions are logged in an immutable audit
                  trail. Access events include timestamp, user identity, and action performed.
                </p>
              </div>
              <div className="bg-white rounded-lg p-4">
                <h3 className="font-semibold text-slate-900 mb-2">Short-Lived Access</h3>
                <p className="text-sm">
                  When staff review documents, temporary access URLs are generated on demand and
                  expire within 60 seconds. No permanent document links are stored in the system.
                </p>
              </div>
            </div>
            <div className="bg-brand-blue-50 border border-brand-blue-200 rounded-lg p-4 mt-4">
              <p className="text-sm text-brand-blue-900">
                <strong>Workforce Compliance Alignment:</strong> Our data handling practices align
                with WIOA participant data requirements, FERPA student record protections, and
                Indiana DWD data security standards. For questions about our security practices,
                contact us at{' '}
                <Link href="/contact" className="underline">
                  elevateforhumanity.org/contact
                </Link>
                .
              </p>
            </div>
        ...
        <section>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 space-y-4 text-slate-900">
            ...
            <p>
              OJT reimbursement rates, work experience stipends, and internship wage structures are
              governed by local board policy — not set by Elevate. All placements require approval
              from the assigned WorkOne career advisor or case manager before training begins.
            </p>
            <div className="grid sm:grid-cols-3 gap-4 mt-4">
              <Link
                href="/compliance/internship-agreement"
                className="bg-white rounded-lg p-4 border border-slate-200 hover:shadow-md transition block"
              >
                <h3 className="font-semibold text-slate-900 text-sm">Internship Agreement</h3>
                <p className="text-xs text-slate-700 mt-1">
                  Structured work-based learning placement template
                </p>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-xs text-slate-700 mt-1">
                  Skills schedule, evaluation timeline, compliance notes
                </p>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-xs text-slate-700 mt-1">
                  Supervisor competency assessment (midpoint + final)
                </p>
              </Link>
            </div>
          </div>
