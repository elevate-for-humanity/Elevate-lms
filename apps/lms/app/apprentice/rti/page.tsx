...
export default async function ApprenticeRtiPage() {
  ...
  const pct = Math.min(100, Math.round((verifiedHours / programContract.completion.requiredRtiHours) * 100));
