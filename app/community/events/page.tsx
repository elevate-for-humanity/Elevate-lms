...
export default async function EventsPage() {
  ...
  const getEventTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'webinar': return 'bg-brand-red-500';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero */}
      <section className="relative bg-brand-red-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-4">
              <Calendar className="w-6 h-6 text-brand-red-200" />
              <span className="text-brand-red-200 font-medium">Community Events</span>
            </div>
            <h1 className="text-4xl font-bold mb-4">
              Learn, Connect, and Grow Together
            </h1>
            <p className="text-xl text-brand-red-100 mb-6">
              Join live workshops, webinars, networking events, and Q&A sessions with industry experts and fellow community members.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link
                href="#upcoming"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-brand-red-700 font-semibold rounded-lg hover:bg-brand-red-50 transition"
              >
              ...
              {user && (
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-brand-red-600 text-white font-semibold rounded-lg hover:bg-brand-red-500 transition border border-brand-red-400"
                >
          ...
          {eventList.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-2xl border">
              ...
              {user && (
                <Link
                  href="/community/events/create"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-brand-red-600 text-white font-semibold rounded-lg hover:bg-brand-red-700"
                >
                  <Plus className="w-5 h-5" />
      ...
      <section className="py-12 bg-brand-red-600">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-white text-brand-red-600 font-semibold rounded-lg hover:bg-brand-red-50 transition"
          >
