...
const LEGAL_DOCS = [
  ...
  { icon: Scale, title: 'Marketplace Terms', desc: 'Terms and conditions for purchasing products and services through the Elevate store.', href: '/legal/marketplace-terms' },
  { icon: FileText, title: 'Participation Agreement', desc: 'Agreement for program participants covering expectations, obligations, and rights.', href: '/legal/participation-agreement' },
  { icon: Shield, title: 'Data Sharing Agreement', desc: 'Terms governing data sharing between Elevate and partner organizations.', href: '/legal/data-sharing' },
  { icon: FileText, title: 'Governance', desc: 'Platform governance documentation including onboarding UX, security, and compliance standards.', href: '/legal/governance' },
