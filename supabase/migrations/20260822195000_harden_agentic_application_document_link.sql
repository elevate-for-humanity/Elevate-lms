-- Forward hardening for the agentic application document handoff.
-- The original linker only trusted target_id. This version verifies that the
-- canonical applications row matches the interview email and program before
-- any pending document can be re-parented.
