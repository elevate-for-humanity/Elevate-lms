...
<div className="max-w-7xl mx-auto">
        <Link href="/admin/wioa" className="flex items-center gap-2 text-gray-600 hover:text-brand-red-600 mb-6">
                ...
                {allApps.map((app) => {
                  ...
                  return (
                    <tr key={app.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <span className="px-3 py-1 bg-brand-red-100 text-brand-red-700 text-sm rounded-full">
