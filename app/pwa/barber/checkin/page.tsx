            ...
            <div className="bg-slate-800/50 rounded-xl p-4">
              ...
              <ol className="text-slate-400 text-sm space-y-2">
                <li className="flex gap-2">
                  <span className="text-brand-red-400">1.</span>
                  Ask your supervisor to show the shop's QR code
                </li>
                <li className="flex gap-2">
                  <span className="text-brand-red-400">2.</span>
                  Scan the code or enter it manually
                </li>
                <li className="flex gap-2">
                  <span className="text-brand-red-400">3.</span>
                  Your training time starts automatically
                </li>
                <li className="flex gap-2">
                  <span className="text-brand-red-400">4.</span>
