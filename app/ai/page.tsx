    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-zinc-900  via-white  py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-red-100 text-brand-red-900 rounded-full text-sm font-bold mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link
              ...
              className="group bg-zinc-900   rounded-2xl p-8 border-2 border-brand-red-200 hover:border-brand-red-400 hover:shadow-xl transition-all"
            >
              <div className="w-16 h-16 bg-brand-red-600 rounded-xl flex items-center justify-center mb-6">
              ...
              <div className="flex items-center gap-2 text-brand-red-600 font-semibold group-hover:gap-4 transition-all">
                <span>Build Course</span>
                <span>→</span>
              </div>
              <div className="mt-6 pt-6 border-t border-brand-red-200">
                <div className="flex items-center gap-2 text-sm text-black">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-brand-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-brand-red-600">3</span>
              </div>
              <h3 className="text-xl font-bold text-black mb-2">
                Learn Faster
              </h3>
