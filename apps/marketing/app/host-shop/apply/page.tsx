...
const PARTNER_TYPES = [
  {
    ...
    desc: 'Host apprentices for hands-on barber or cosmetology training',
  },
  {
    value: 'healthcare',
    label: 'Healthcare Facility',
    desc: 'Clinical placement for CNA, phlebotomy, or medical assistant students',
  },
  {
    value: 'employer',
    label: 'Employer Partner',
    desc: 'Hire graduates or host on-the-job training',
  },
  {
    value: 'training_provider',
    label: 'Training Provider',
    desc: 'Deliver curriculum as a licensed training site',
  },
  {
    value: 'workforce_board',
    label: 'Workforce Board',
    desc: 'Coordinate WIOA, JRI, or other funded referrals',
  },
  {
    value: 'community_org',
    label: 'Community Organization',
    desc: 'Refer participants or provide wraparound services',
  },
];
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <div className="space-y-3">
            ...
            <Link
              href="/"
              className="block text-brand-blue-600 font-medium hover:text-brand-blue-700"
            >
              Return to Home
            </Link>
          </div>
