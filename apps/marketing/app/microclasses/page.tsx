...
const SECTIONS = [
  ...
  },
  {
    id: 'food',
    label: 'Food Service',
    partner: 'National Restaurant Foundation',
    courses: NRF_COURSES,
  },
];
      ...
      {isFree ? (
        ...
        <div className="space-y-2">
          ...
          <p className="text-center text-xs text-slate-400">
            Free with WIOA?{' '}
            <Link href="/apply/student" className="underline text-slate-600">
              Apply here
            </Link>
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1">
              DOL-registered apprenticeship programs that include micro-class certifications as part
              of the curriculum.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              {
                title: 'Barbershop Apprenticeship',
                href: '/programs/barber-apprenticeship',
                cert: 'Indiana Barber License',
                duration: '12–18 months',
              },
              {
                title: 'Cosmetology Apprenticeship',
                href: '/programs/cosmetology-apprenticeship',
                cert: 'Indiana Cosmetology License',
                duration: '12–18 months',
              },
              {
              ...
              },
              {
                ...
                cert: 'Journeyman Electrician',
                duration: '12–24 months',
              },
              {
                title: 'Plumbing Apprenticeship',
                href: '/programs/plumbing',
                cert: 'Journeyman Plumber',
                duration: '12–24 months',
              },
              {
                title: 'Welding',
                href: '/programs/welding',
                cert: 'AWS Welding Certification',
                duration: '6–12 months',
              },
              {
                title: 'CDL Training',
      ...
      <section className="py-14 text-center">
        <div className="max-w-xl mx-auto px-4">
          ...
          <p className="text-slate-500 text-sm mb-6">
            Our team will help you find the right certification and funding option for your goals.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link
              href="/apply/student"
              className="border border-slate-300 text-slate-700 px-6 py-3 rounded-xl font-semibold text-sm hover:bg-slate-50 transition-colors"
            >
