        ...
        {step === 'url' && (
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              ...
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-red-500/20 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Circle className="w-6 h-6 text-brand-red-400" />
                </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/5 backdrop-blur rounded-2xl p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white/5 rounded-lg p-4 text-center">
                  <Image className="w-6 h-6 text-brand-red-400 mx-auto mb-2" />
