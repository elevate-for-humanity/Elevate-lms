...
const programImages: Record<string, string> = {
  ...
  'barber-apprenticeship': '/images/beauty/program-barber-training.webp',
  'barber-apprenticeship-wrg': '/images/beauty/program-barber-training.webp',
  'barber-apprentice': '/images/beauty/program-barber-training.webp',
  barber: '/images/beauty/program-barber-training.webp',
            ...
            {programs.map((program) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <span className="text-orange-500 font-semibold text-sm inline-flex items-center gap-1 group-hover:gap-2 transition-all">See Details<span>→</span>
                  </span>
                </div>
              </Link>
            ))}
