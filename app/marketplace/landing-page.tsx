        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Link
              ...
              className="px-8 py-4 bg-white text-brand-red-600 rounded-lg font-bold hover:bg-gray-100 flex items-center gap-2"
            >
              Browse Marketplace
            ...
            <Link
              ...
              className="px-8 py-4 bg-brand-red-700 text-white rounded-lg font-bold hover:bg-brand-red-800 border-2 border-white"
            >
              Start Selling
            </Link>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <FeatureCard
              icon={<Store className="w-12 h-12 text-brand-red-600" />}
              title="Shop"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            />
            <BenefitCard
              icon={<Award className="w-8 h-8 text-brand-red-500" />}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Link
              href="/marketplace/browse"
              className="px-8 py-4 bg-brand-red-600 text-white rounded-lg font-bold hover:bg-brand-red-700"
            >
              Start Shopping
            </Link>
            <Link
