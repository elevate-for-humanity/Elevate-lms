    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="bg-white py-10">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
              <span className="px-4 py-2 bg-brand-green-500/20 border border-brand-green-400/30 rounded-full text-sm font-bold text-brand-green-300">
                Registered Apprenticeship Sponsor
              </span>
              <span className="px-4 py-2 bg-brand-blue-500/20 border border-brand-blue-400/30 rounded-full text-sm font-bold text-brand-blue-300">
                ETPL Approved
              </span>
              <span className="px-4 py-2 bg-brand-blue-500/20 border border-brand-blue-400/30 rounded-full text-sm font-bold text-brand-blue-300">
                WIOA | WRG Eligible
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto mb-6">
              Everything WorkOne regions need to refer participants to our ETPL-approved training
              programs and registered apprenticeships. We handle enrollment, training delivery, and
              outcome reporting with full transparency.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-teal-700 rounded-lg font-bold hover:bg-white transition-colors"
              >
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-slate-600 text-sm">
                    Approved Training Provider - All Indiana Regions
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="prose prose-lg max-w-none text-slate-700">
                ...
                <p className="mb-4">
                  We are <strong>not a staffing agency</strong> and{' '}
                  <strong>not a traditional school</strong>. We provide infrastructure, compliance,
                  and training coordination so employers can hire, train, and retain talent with
                  reduced cost and risk.
                </p>
                <p>
                  Our model connects workforce boards, employers, and job seekers in a structured
                  pathway that produces measurable outcomes and meets all federal reporting
                  requirements.
                </p>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-slate-600 text-sm">
                        Training aligned with actual job requirements
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-slate-600 text-sm">
                        WIOA, FERPA, ADA, EEO compliant from day one
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-slate-600 text-sm">
                        Employment and wage gains, not just completions
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-slate-600 text-sm">
                        Real-time data for case managers and funders
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
              ...
              <div className="p-6">
                <div className="w-12 h-12 bg-brand-blue-600 text-white rounded-full flex items-center justify-center text-xl font-bold mb-4 -mt-10 relative z-10 border-4 border-white">
                  1
                </div>
                <h3 className="text-lg font-bold text-slate-900 mb-3">Referral</h3>
                <p className="text-slate-600 text-sm">
                  WorkOne case manager identifies eligible participant and submits referral through
                  our online portal or via email.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm">
                  We complete intake, verify eligibility, and enroll participant in appropriate
                  training program within 48 hours.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm">
                  Participant completes training with progress updates sent to case manager weekly.
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm">
                  Upon completion, we provide job placement assistance and report employment
                  outcomes for WIOA performance measures.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              All programs are approved on Indiana&apos;s Eligible Training Provider List and lead
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-4">
                We accept all major workforce funding streams and provide transparent billing with
                no hidden fees.
              </p>
              <p className="text-slate-600 mb-8">
                ITA vouchers, direct contracts, and employer-sponsored arrangements are all
                supported. Our team handles all enrollment paperwork, progress reporting, and
                outcome documentation required for WIOA performance measures.
              </p>
            ...
            <div className="bg-teal-50 rounded-2xl p-8 border border-teal-200">
              ...
              <div className="space-y-6">
                {[
                  {
                    step: '1',
                    title: 'ITA/Voucher Submission',
                    desc: 'Case manager submits ITA or funding authorization',
                  },
                  {
                    step: '2',
                    title: 'Enrollment Confirmation',
                    desc: 'We confirm enrollment and send start date',
                  },
                  {
                    step: '3',
                    title: 'Progress Updates',
                    desc: 'Weekly progress reports sent to case manager',
                  },
                  {
                    step: '4',
                    title: 'Completion & Invoice',
                    desc: 'Invoice submitted upon successful completion with credential documentation',
                  },
                ].map((item) => (
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            Ready to Refer Participants?
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Contact our WorkOne liaison to set up your referral process or request additional
            information.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
            ...
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 bg-teal-700 text-white rounded-lg font-bold hover:bg-teal-800 transition-colors border-2 border-white/30"
            >
